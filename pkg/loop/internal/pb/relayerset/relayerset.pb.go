...
type GetForwarderForEOARequest struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	RelayerId     *RelayerId                     `protobuf:"bytes,1,opt,name=relayerId,proto3" json:"relayerId,omitempty"`
	Request       *evm.GetForwarderForEOARequest `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetForwarderForEOARequest) GetRelayerId() *RelayerId {
	if x != nil {
		return x.RelayerId
	}
	return nil
...
func (x *GetForwarderForEOARequest) GetRequest() *evm.GetForwarderForEOARequest {
	if x != nil {
		return x.Request
	}
	return nil
...
type GetForwarderForEOAOCR2FeedsRequest struct {
	state         protoimpl.MessageState                  `protogen:"open.v1"`
	RelayerId     *RelayerId                              `protobuf:"bytes,1,opt,name=relayerId,proto3" json:"relayerId,omitempty"`
	Request       *evm.GetForwarderForEOAOCR2FeedsRequest `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetForwarderForEOAOCR2FeedsRequest) GetRelayerId() *RelayerId {
	if x != nil {
		return x.RelayerId
	}
	return nil
...
func (x *GetForwarderForEOAOCR2FeedsRequest) GetRequest() *evm.GetForwarderForEOAOCR2FeedsRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
const file_loop_internal_pb_relayerset_relayerset_proto_rawDesc = "" +
	...
	"\trelayerId\x18\x01 \x01(\v2\x1a.loop.relayerset.RelayerIdR\trelayerId\x12?\n" +
	"\arequest\x18\x02 \x01(\v2%.loop.evm.GetTransactionStatusRequestR\arequest\"\x94\x01\n" +
	"\x19GetForwarderForEOARequest\x128\n" +
	"\trelayerId\x18\x01 \x01(\v2\x1a.loop.relayerset.RelayerIdR\trelayerId\x12=\n" +
	"\arequest\x18\x02 \x01(\v2#.loop.evm.GetForwarderForEOARequestR\arequest\"\xa6\x01\n" +
	"\"GetForwarderForEOAOCR2FeedsRequest\x128\n" +
	"\trelayerId\x18\x01 \x01(\v2\x1a.loop.relayerset.RelayerIdR\trelayerId\x12F\n" +
	"\arequest\x18\x02 \x01(\v2,.loop.evm.GetForwarderForEOAOCR2FeedsRequestR\arequest2\xaf\x0f\n" +
	"\n" +
	"RelayerSet\x12P\n" +
	...
	"\x13ContractReaderClose\x12+.loop.relayerset.ContractReaderCloseRequest\x1a\x16.google.protobuf.Empty\"\x002\xd6\n" +
	"\n" +
	"\rEVMRelayerSet\x12b\n" +
	...
	"\x14GetTransactionStatus\x12,.loop.relayerset.GetTransactionStatusRequest\x1a#.loop.evm.GetTransactionStatusReply\x12c\n" +
	"\x12GetForwarderForEOA\x12*.loop.relayerset.GetForwarderForEOARequest\x1a!.loop.evm.GetForwarderForEOAReply\x12~\n" +
	"\x1bGetForwarderForEOAOCR2Feeds\x123.loop.relayerset.GetForwarderForEOAOCR2FeedsRequest\x1a*.loop.evm.GetForwarderForEOAOCR2FeedsReplyBNZLgithub.com/smartcontractkit/chainlink-common/pkg/loop/internal/pb/relayersetb\x06proto3"
...
var file_loop_internal_pb_relayerset_relayerset_proto_goTypes = []any{
	...
	(*GetForwarderForEOARequest)(nil),                 // 37: loop.relayerset.GetForwarderForEOARequest
	(*GetForwarderForEOAOCR2FeedsRequest)(nil),        // 38: loop.relayerset.GetForwarderForEOAOCR2FeedsRequest
	...
	(*evm.GetForwarderForEOARequest)(nil),          // 57: loop.evm.GetForwarderForEOARequest
	(*evm.GetForwarderForEOAOCR2FeedsRequest)(nil), // 58: loop.evm.GetForwarderForEOAOCR2FeedsRequest
	...
	(*evm.GetForwarderForEOAReply)(nil),            // 75: loop.evm.GetForwarderForEOAReply
	(*evm.GetForwarderForEOAOCR2FeedsReply)(nil),   // 76: loop.evm.GetForwarderForEOAOCR2FeedsReply
}
var file_loop_internal_pb_relayerset_relayerset_proto_depIdxs = []int32{
	...
	0,  // 40: loop.relayerset.GetForwarderForEOARequest.relayerId:type_name -> loop.relayerset.RelayerId
	57, // 41: loop.relayerset.GetForwarderForEOARequest.request:type_name -> loop.evm.GetForwarderForEOARequest
	0,  // 42: loop.relayerset.GetForwarderForEOAOCR2FeedsRequest.relayerId:type_name -> loop.relayerset.RelayerId
	58, // 43: loop.relayerset.GetForwarderForEOAOCR2FeedsRequest.request:type_name -> loop.evm.GetForwarderForEOAOCR2FeedsRequest
	...
	37, // 76: loop.relayerset.EVMRelayerSet.GetForwarderForEOA:input_type -> loop.relayerset.GetForwarderForEOARequest
	38, // 77: loop.relayerset.EVMRelayerSet.GetForwarderForEOAOCR2Feeds:input_type -> loop.relayerset.GetForwarderForEOAOCR2FeedsRequest
	...
	75, // 110: loop.relayerset.EVMRelayerSet.GetForwarderForEOA:output_type -> loop.evm.GetForwarderForEOAReply
	76, // 111: loop.relayerset.EVMRelayerSet.GetForwarderForEOAOCR2Feeds:output_type -> loop.evm.GetForwarderForEOAOCR2FeedsReply
