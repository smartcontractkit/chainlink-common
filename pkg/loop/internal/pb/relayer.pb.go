...
func (x *GetLatestValueRequest) GetReturnValues() []byte {
	if x != nil {
...
type GetLatestValueReply struct {
	...
	RetValues []byte `protobuf:"bytes,1,opt,name=retValues,proto3" json:"retValues,omitempty"`
}
...
func (x *GetLatestValueReply) GetRetValues() []byte {
	if x != nil {
		return x.RetValues
	}
	return nil
...
var file_relayer_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x90, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74,
	...
	0x72, 0x61, 0x6d, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x72, 0x65, 0x74, 0x75,
	0x72, 0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x33, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4c,
	0x61, 0x74, 0x65, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	0x1c, 0x0a, 0x09, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x09, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x57, 0x0a,
...
var file_relayer_proto_goTypes = []interface{}{
	...
	(*GetLatestValueRequest)(nil),             // 46: loop.GetLatestValueRequest
	(*GetLatestValueReply)(nil),               // 47: loop.GetLatestValueReply
	(*BoundContract)(nil),                     // 48: loop.BoundContract
	(*NameReply)(nil),                         // 49: loop.NameReply
	(*HealthReportReply)(nil),                 // 50: loop.HealthReportReply
	(*BigInt)(nil),                            // 51: loop.BigInt
	(*StarknetSignature)(nil),                 // 52: loop.StarknetSignature
	(*StarknetMessageHash)(nil),               // 53: loop.StarknetMessageHash
...
var file_relayer_proto_depIdxs = []int32{
	...
	51, // 5: loop.TransactionRequest.amount:type_name -> loop.BigInt
	31, // 6: loop.ObserveRequest.reportTimestamp:type_name -> loop.ReportTimestamp
	51, // 7: loop.ObserveReply.value:type_name -> loop.BigInt
	...
	48, // 13: loop.GetLatestValueRequest.bc:type_name -> loop.BoundContract
	54, // 14: loop.HealthReportReply.healthReport:type_name -> loop.HealthReportReply.HealthReportEntry
	51, // 15: loop.StarknetSignature.x:type_name -> loop.BigInt
	51, // 16: loop.StarknetSignature.y:type_name -> loop.BigInt
	51, // 17: loop.StarknetMessageHash.hash:type_name -> loop.BigInt
	...
	11, // 23: loop.Relayer.GetChainStatus:input_type -> loop.GetChainStatusRequest
	14, // 24: loop.Relayer.ListNodeStatuses:input_type -> loop.ListNodeStatusesRequest
	17, // 25: loop.Relayer.Transact:input_type -> loop.TransactionRequest
	18, // 26: loop.DataSource.Observe:input_type -> loop.ObserveRequest
	21, // 27: loop.OffchainConfigDigester.ConfigDigest:input_type -> loop.ConfigDigestRequest
	23, // 28: loop.OffchainConfigDigester.ConfigDigestPrefix:input_type -> loop.ConfigDigestPrefixRequest
	25, // 29: loop.ContractConfigTracker.LatestConfigDetails:input_type -> loop.LatestConfigDetailsRequest
	27, // 30: loop.ContractConfigTracker.LatestConfig:input_type -> loop.LatestConfigRequest
	29, // 31: loop.ContractConfigTracker.LatestBlockHeight:input_type -> loop.LatestBlockHeightRequest
	34, // 32: loop.ContractTransmitter.Transmit:input_type -> loop.TransmitRequest
	36, // 33: loop.ContractTransmitter.LatestConfigDigestAndEpoch:input_type -> loop.LatestConfigDigestAndEpochRequest
	38, // 34: loop.ContractTransmitter.FromAccount:input_type -> loop.FromAccountRequest
	40, // 35: loop.ChainReader.RegisterEventFilter:input_type -> loop.RegisterEventFilterRequest
	42, // 36: loop.ChainReader.UnregisterEventFilter:input_type -> loop.UnregisterEventFilterRequest
	44, // 37: loop.ChainReader.QueryEvents:input_type -> loop.QueryEventsRequest
	46, // 38: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	...
	10, // 46: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	8,  // 47: loop.Relayer.NewPluginProvider:output_type -> loop.NewPluginProviderReply
	12, // 48: loop.Relayer.GetChainStatus:output_type -> loop.GetChainStatusReply
	15, // 49: loop.Relayer.ListNodeStatuses:output_type -> loop.ListNodeStatusesReply
	55, // 50: loop.Relayer.Transact:output_type -> google.protobuf.Empty
	19, // 51: loop.DataSource.Observe:output_type -> loop.ObserveReply
	22, // 52: loop.OffchainConfigDigester.ConfigDigest:output_type -> loop.ConfigDigestReply
	24, // 53: loop.OffchainConfigDigester.ConfigDigestPrefix:output_type -> loop.ConfigDigestPrefixReply
	26, // 54: loop.ContractConfigTracker.LatestConfigDetails:output_type -> loop.LatestConfigDetailsReply
	28, // 55: loop.ContractConfigTracker.LatestConfig:output_type -> loop.LatestConfigReply
	30, // 56: loop.ContractConfigTracker.LatestBlockHeight:output_type -> loop.LatestBlockHeightReply
	35, // 57: loop.ContractTransmitter.Transmit:output_type -> loop.TransmitReply
	37, // 58: loop.ContractTransmitter.LatestConfigDigestAndEpoch:output_type -> loop.LatestConfigDigestAndEpochReply
	39, // 59: loop.ContractTransmitter.FromAccount:output_type -> loop.FromAccountReply
	41, // 60: loop.ChainReader.RegisterEventFilter:output_type -> loop.RegisterEventFilterReply
	41, // 61: loop.ChainReader.UnregisterEventFilter:output_type -> loop.RegisterEventFilterReply
	45, // 62: loop.ChainReader.QueryEvents:output_type -> loop.QueryEventsReply
	47, // 63: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	49, // 64: loop.Service.Name:output_type -> loop.NameReply
