...
type ChainReader interface {
	...
	QueryKey(ctx context.Context, keys string, queryFilters []QueryFilter, limitAndSort LimitAndSort, sequenceDataType any) ([]Sequence, error)
	QueryKeys(ctx context.Context, keys []string, queryFilters []QueryFilter, limitAndSort LimitAndSort, sequenceDataTypes []any) ([][]Sequence, error)
	QueryKeyByValues(ctx context.Context, key string, values []string, queryFilters []QueryFilter, limitAndSort LimitAndSort, sequenceDataType any) ([]Sequence, error)
