...
const file_capabilities_blockchain_evm_v1alpha_client_proto_rawDesc = "" +
	...
	"\x11TX_STATUS_SUCCESS\x10\x022\xc1\x0f\n" +
	...
	"\vWriteReport\x127.capabilities.blockchain.evm.v1alpha.WriteReportRequest\x1a5.capabilities.blockchain.evm.v1alpha.WriteReportReply\x1a\xb7\x04\x82\xb5\x18\xb2\x04\b\x01\x12\tevm@1.0.0\x1a\xa2\x04\n" +
	"\rChainSelector\x12\x90\x04\x12\x8d\x04\n" +
	"\x1d\n" +
	"\x11avalanche-mainnet\x10\xd5\xe7\x8a\xc0\xe1\u0558\xa4Y\n" +
	"\"\n" +
	"\x15avalanche-testnet-fuj\x10\x9b\xf9\xfc\x90\xa2\xe3\xa8\xf8\xcc\x01\n" +
	"/\n" +
