...
type AndFilter struct {
	...
	Filters []*QueryKeysFilter `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *AndFilter) GetFilters() []*QueryKeysFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type QueryKeysFilter struct {
	...
	//
	//	*QueryKeysFilter_AndFilter
	//	*QueryKeysFilter_AddressFilter
	//	*QueryKeysFilter_KeysFilter
	//	*QueryKeysFilter_KeysByValueFilter
	//	*QueryKeysFilter_ConfirmationsFilter
	//	*QueryKeysFilter_BlockFilter
	//	*QueryKeysFilter_TimestampFilter
	//	*QueryKeysFilter_TxHashFilter
	Filter isQueryKeysFilter_Filter `protobuf_oneof:"filter"`
}

func (x *QueryKeysFilter) Reset() {
	*x = QueryKeysFilter{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryKeysFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryKeysFilter) ProtoMessage() {}

func (x *QueryKeysFilter) ProtoReflect() protoreflect.Message {
	mi := &file_chain_reader_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryKeysFilter.ProtoReflect.Descriptor instead.
func (*QueryKeysFilter) Descriptor() ([]byte, []int) {
	return file_chain_reader_proto_rawDescGZIP(), []int{17}
}

func (m *QueryKeysFilter) GetFilter() isQueryKeysFilter_Filter {
	if m != nil {
		return m.Filter
	}
	return nil
...
func (x *QueryKeysFilter) GetAndFilter() *AndFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_AndFilter); ok {
		return x.AndFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetAddressFilter() *AddressFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_AddressFilter); ok {
		return x.AddressFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetKeysFilter() *KeysFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_KeysFilter); ok {
		return x.KeysFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetKeysByValueFilter() *KeysByValueFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_KeysByValueFilter); ok {
		return x.KeysByValueFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetConfirmationsFilter() *ConfirmationsFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_ConfirmationsFilter); ok {
		return x.ConfirmationsFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetBlockFilter() *BlockFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_BlockFilter); ok {
		return x.BlockFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetTimestampFilter() *TimestampFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_TimestampFilter); ok {
		return x.TimestampFilter
	}
	return nil
}

func (x *QueryKeysFilter) GetTxHashFilter() *TxHashFilter {
	if x, ok := x.GetFilter().(*QueryKeysFilter_TxHashFilter); ok {
		return x.TxHashFilter
	}
	return nil
}

type isQueryKeysFilter_Filter interface {
	isQueryKeysFilter_Filter()
}

type QueryKeysFilter_AndFilter struct {
	AndFilter *AndFilter `protobuf:"bytes,1,opt,name=and_filter,json=andFilter,proto3,oneof"`
}

type QueryKeysFilter_AddressFilter struct {
	AddressFilter *AddressFilter `protobuf:"bytes,2,opt,name=address_filter,json=addressFilter,proto3,oneof"`
}

type QueryKeysFilter_KeysFilter struct {
	KeysFilter *KeysFilter `protobuf:"bytes,3,opt,name=keys_filter,json=keysFilter,proto3,oneof"`
}

type QueryKeysFilter_KeysByValueFilter struct {
	KeysByValueFilter *KeysByValueFilter `protobuf:"bytes,4,opt,name=keys_by_value_filter,json=keysByValueFilter,proto3,oneof"`
}

type QueryKeysFilter_ConfirmationsFilter struct {
...
type QueryKeysFilter_BlockFilter struct {
	BlockFilter *BlockFilter `protobuf:"bytes,6,opt,name=block_filter,json=blockFilter,proto3,oneof"`
}

type QueryKeysFilter_TimestampFilter struct {
	TimestampFilter *TimestampFilter `protobuf:"bytes,7,opt,name=timestamp_filter,json=timestampFilter,proto3,oneof"`
}

type QueryKeysFilter_TxHashFilter struct {
	TxHashFilter *TxHashFilter `protobuf:"bytes,8,opt,name=tx_hash_filter,json=txHashFilter,proto3,oneof"`
}

func (*QueryKeysFilter_AndFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_AddressFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_KeysFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_KeysByValueFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_ConfirmationsFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_BlockFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_TimestampFilter) isQueryKeysFilter_Filter() {}

func (*QueryKeysFilter_TxHashFilter) isQueryKeysFilter_Filter() {}
...
type QueryKeysRequest struct {
	...
	Filter       *QueryKeysFilter `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"`
...
func (x *QueryKeysRequest) GetFilter() *QueryKeysFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3c, 0x0a, 0x09, 0x41, 0x6e, 0x64, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x12, 0x2f, 0x0a, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4b,
	0x65, 0x79, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x73, 0x22, 0x2d, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x46, 0x69, 0x6c,
	...
	,
	...
	0x72, 0x22, 0x65, 0x0a, 0x0f, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x46, 0x69,
	0x6c, 0x74, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x43, 0x6f, 0x6d, 0x70,
	0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x08,
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x27, 0x0a, 0x0c, 0x54, 0x78, 0x48, 0x61,
	0x73, 0x68, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x68,
	0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73,
	0x68, 0x22, 0x4d, 0x0a, 0x0f, 0x53, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x73,
	...
	,
	...
	0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x42,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x07, 0x20,
	...
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x54, 0x78, 0x48,
	0x61, 0x73, 0x68, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0c, 0x74, 0x78, 0x48,
	0x61, 0x73, 0x68, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x22, 0x7b, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x06,
	...
	,
	...
	0x73, 0x52, 0x06, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x22, 0x3e, 0x0a, 0x0e, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x2c, 0x0a, 0x06, 0x72,
	0x65, 0x74, 0x56, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x6f,
	0x6f, 0x70, 0x2e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x64, 0x42, 0x79, 0x74, 0x65,
	0x73, 0x52, 0x06, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x22, 0x3e, 0x0a, 0x0b, 0x42, 0x69, 0x6e,
	...
	0x08, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x57, 0x0a, 0x0d, 0x42, 0x6f, 0x75,
	...
	0x6e, 0x67, 0x2a, 0x22, 0x0a, 0x0d, 0x53, 0x6f, 0x72, 0x74, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x73, 0x63, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04,
	0x44, 0x65, 0x73, 0x63, 0x10, 0x01, 0x32, 0xcb, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x69, 0x6e,
...
var file_chain_reader_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_chain_reader_proto_goTypes = []interface{}{
	...
	(*KeysFilter)(nil),            // 3: loop.KeysFilter
	(*KeysByValueFilter)(nil),     // 4: loop.KeysByValueFilter
	(*Keys)(nil),                  // 5: loop.Keys
	(*Values)(nil),                // 6: loop.Values
	(*Confirmations)(nil),         // 7: loop.Confirmations
	(*ConfirmationsFilter)(nil),   // 8: loop.ConfirmationsFilter
	(*ComparisonOperator)(nil),    // 9: loop.ComparisonOperator
	...
	(*QueryKeysFilter)(nil),       // 18: loop.QueryKeysFilter
	(*QueryKeysRequest)(nil),      // 19: loop.QueryKeysRequest
	(*GetLatestValueRequest)(nil), // 20: loop.GetLatestValueRequest
	(*GetLatestValueReply)(nil),   // 21: loop.GetLatestValueReply
	(*QueryKeysReply)(nil),        // 22: loop.QueryKeysReply
	(*BindRequest)(nil),           // 23: loop.BindRequest
	(*BoundContract)(nil),         // 24: loop.BoundContract
	(*VersionedBytes)(nil),        // 25: loop.VersionedBytes
	(*emptypb.Empty)(nil),         // 26: google.protobuf.Empty
}
var file_chain_reader_proto_depIdxs = []int32{
	18, // 0: loop.AndFilter.filters:type_name -> loop.QueryKeysFilter
	5,  // 1: loop.KeysByValueFilter.keys:type_name -> loop.Keys
	6,  // 2: loop.KeysByValueFilter.values:type_name -> loop.Values
	7,  // 3: loop.ConfirmationsFilter.confirmations:type_name -> loop.Confirmations
	9,  // 4: loop.BlockFilter.operator:type_name -> loop.ComparisonOperator
	9,  // 5: loop.TimestampFilter.operator:type_name -> loop.ComparisonOperator
	0,  // 6: loop.SortByTimestamp.sort_direction:type_name -> loop.SortDirection
	0,  // 7: loop.SortByBlock.sort_direction:type_name -> loop.SortDirection
	0,  // 8: loop.SortBySequence.sort_direction:type_name -> loop.SortDirection
	13, // 9: loop.SortBy.sort_by_timestamp:type_name -> loop.SortByTimestamp
	14, // 10: loop.SortBy.sort_by_block:type_name -> loop.SortByBlock
	15, // 11: loop.SortBy.sort_by_sequence:type_name -> loop.SortBySequence
	16, // 12: loop.LimitAndSort.sort_by:type_name -> loop.SortBy
	1,  // 13: loop.QueryKeysFilter.and_filter:type_name -> loop.AndFilter
	2,  // 14: loop.QueryKeysFilter.address_filter:type_name -> loop.AddressFilter
	3,  // 15: loop.QueryKeysFilter.keys_filter:type_name -> loop.KeysFilter
	4,  // 16: loop.QueryKeysFilter.keys_by_value_filter:type_name -> loop.KeysByValueFilter
	8,  // 17: loop.QueryKeysFilter.confirmations_filter:type_name -> loop.ConfirmationsFilter
	10, // 18: loop.QueryKeysFilter.block_filter:type_name -> loop.BlockFilter
	11, // 19: loop.QueryKeysFilter.timestamp_filter:type_name -> loop.TimestampFilter
	12, // 20: loop.QueryKeysFilter.tx_hash_filter:type_name -> loop.TxHashFilter
	18, // 21: loop.QueryKeysRequest.filter:type_name -> loop.QueryKeysFilter
	17, // 22: loop.QueryKeysRequest.limit_and_sort:type_name -> loop.LimitAndSort
	25, // 23: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	25, // 24: loop.GetLatestValueReply.retVal:type_name -> loop.VersionedBytes
	25, // 25: loop.QueryKeysReply.retVal:type_name -> loop.VersionedBytes
	24, // 26: loop.BindRequest.bindings:type_name -> loop.BoundContract
	20, // 27: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	19, // 28: loop.ChainReader.QueryKeys:input_type -> loop.QueryKeysRequest
	23, // 29: loop.ChainReader.Bind:input_type -> loop.BindRequest
	21, // 30: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	22, // 31: loop.ChainReader.QueryKeys:output_type -> loop.QueryKeysReply
	26, // 32: loop.ChainReader.Bind:output_type -> google.protobuf.Empty
...
func file_chain_reader_proto_init() {
	...
	file_chain_reader_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*QueryKeysFilter_AndFilter)(nil),
		(*QueryKeysFilter_AddressFilter)(nil),
		(*QueryKeysFilter_KeysFilter)(nil),
		(*QueryKeysFilter_KeysByValueFilter)(nil),
		(*QueryKeysFilter_ConfirmationsFilter)(nil),
		(*QueryKeysFilter_BlockFilter)(nil),
		(*QueryKeysFilter_TimestampFilter)(nil),
		(*QueryKeysFilter_TxHashFilter)(nil),
	}
	type x struct{}
