...
func (c *pluginRelayerClient) NewRelayer(ctx context.Context, in *NewRelayerRequest, opts ...grpc.CallOption) (*NewRelayerReply, error) {
	...
	err := c.cc.Invoke(ctx, PluginRelayer_NewRelayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPluginRelayerServer must be embedded to have
...
func (UnimplementedPluginRelayerServer) testEmbeddedByValue()                       {}
...
func RegisterPluginRelayerServer(s grpc.ServiceRegistrar, srv PluginRelayerServer) {
	// If the following call pancis, it indicates UnimplementedPluginRelayerServer was
...
const (
	Relayer_NewAptosChainService_FullMethodName = "/loop.Relayer/NewAptosChainService"
...
type RelayerClient interface {
	NewAptosChainService(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NewAptosChainServiceReply, error)
...
func (c *relayerClient) NewAptosChainService(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NewAptosChainServiceReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewAptosChainServiceReply)
	err := c.cc.Invoke(ctx, Relayer_NewAptosChainService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) NewContractWriter(ctx context.Context, in *NewContractWriterRequest, opts ...grpc.CallOption) (*NewContractWriterReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_NewContractWriter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) NewContractReader(ctx context.Context, in *NewContractReaderRequest, opts ...grpc.CallOption) (*NewContractReaderReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_NewContractReader_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) NewConfigProvider(ctx context.Context, in *NewConfigProviderRequest, opts ...grpc.CallOption) (*NewConfigProviderReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_NewConfigProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) LatestHead(ctx context.Context, in *LatestHeadRequest, opts ...grpc.CallOption) (*LatestHeadReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_LatestHead_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) GetChainStatus(ctx context.Context, in *GetChainStatusRequest, opts ...grpc.CallOption) (*GetChainStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_GetChainStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) ListNodeStatuses(ctx context.Context, in *ListNodeStatusesRequest, opts ...grpc.CallOption) (*ListNodeStatusesReply, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_ListNodeStatuses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayerClient) Transact(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Relayer_Transact_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelayerServer interface {
	NewAptosChainService(context.Context, *emptypb.Empty) (*NewAptosChainServiceReply, error)
...
func (UnimplementedRelayerServer) NewAptosChainService(context.Context, *emptypb.Empty) (*NewAptosChainServiceReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewAptosChainService not implemented")
}
...
func RegisterRelayerServer(s grpc.ServiceRegistrar, srv RelayerServer) {
	// If the following call pancis, it indicates UnimplementedRelayerServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _Relayer_NewAptosChainService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayerServer).NewAptosChainService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Relayer_NewAptosChainService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayerServer).NewAptosChainService(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Relayer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewAptosChainService",
			Handler:    _Relayer_NewAptosChainService_Handler,
		},
		{
...
func (c *offchainConfigDigesterClient) ConfigDigest(ctx context.Context, in *ConfigDigestRequest, opts ...grpc.CallOption) (*ConfigDigestReply, error) {
	...
	err := c.cc.Invoke(ctx, OffchainConfigDigester_ConfigDigest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *offchainConfigDigesterClient) ConfigDigestPrefix(ctx context.Context, in *ConfigDigestPrefixRequest, opts ...grpc.CallOption) (*ConfigDigestPrefixReply, error) {
	...
	err := c.cc.Invoke(ctx, OffchainConfigDigester_ConfigDigestPrefix_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOffchainConfigDigesterServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedOffchainConfigDigesterServer) testEmbeddedByValue() {}
...
func RegisterOffchainConfigDigesterServer(s grpc.ServiceRegistrar, srv OffchainConfigDigesterServer) {
	// If the following call pancis, it indicates UnimplementedOffchainConfigDigesterServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (c *contractConfigTrackerClient) LatestConfigDetails(ctx context.Context, in *LatestConfigDetailsRequest, opts ...grpc.CallOption) (*LatestConfigDetailsReply, error) {
	...
	err := c.cc.Invoke(ctx, ContractConfigTracker_LatestConfigDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contractConfigTrackerClient) LatestConfig(ctx context.Context, in *LatestConfigRequest, opts ...grpc.CallOption) (*LatestConfigReply, error) {
	...
	err := c.cc.Invoke(ctx, ContractConfigTracker_LatestConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contractConfigTrackerClient) LatestBlockHeight(ctx context.Context, in *LatestBlockHeightRequest, opts ...grpc.CallOption) (*LatestBlockHeightReply, error) {
	...
	err := c.cc.Invoke(ctx, ContractConfigTracker_LatestBlockHeight_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedContractConfigTrackerServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedContractConfigTrackerServer) testEmbeddedByValue()                               {}
...
func RegisterContractConfigTrackerServer(s grpc.ServiceRegistrar, srv ContractConfigTrackerServer) {
	// If the following call pancis, it indicates UnimplementedContractConfigTrackerServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (c *contractTransmitterClient) LatestConfigDigestAndEpoch(ctx context.Context, in *LatestConfigDigestAndEpochRequest, opts ...grpc.CallOption) (*LatestConfigDigestAndEpochReply, error) {
	...
	err := c.cc.Invoke(ctx, ContractTransmitter_LatestConfigDigestAndEpoch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) Close(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Service_Close_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) Ready(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Service_Ready_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) HealthReport(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthReportReply, error) {
	...
	err := c.cc.Invoke(ctx, Service_HealthReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
