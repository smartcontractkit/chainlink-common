...
func (cap *ClientCapability) Invoke(ctx context.Context, request *sdkpb.CapabilityRequest) *sdkpb.CapabilityResponse {
	...
	case "GetTxResult":
		...
		if cap.GetTxResult == nil {
			capResp.Response = &sdkpb.CapabilityResponse_Error{Error: "no stub provided for GetTxResult"}
			break
		}
	...
	case "ReadMethod":
		...
		if cap.ReadMethod == nil {
			capResp.Response = &sdkpb.CapabilityResponse_Error{Error: "no stub provided for ReadMethod"}
			break
		}
	...
	case "QueryLogs":
		...
		if cap.QueryLogs == nil {
			capResp.Response = &sdkpb.CapabilityResponse_Error{Error: "no stub provided for QueryLogs"}
			break
		}
	...
	case "SubmitTransaction":
		...
		if cap.SubmitTransaction == nil {
			capResp.Response = &sdkpb.CapabilityResponse_Error{Error: "no stub provided for SubmitTransaction"}
			break
		}
...
func (cap *ClientCapability) InvokeTrigger(ctx context.Context, request *sdkpb.TriggerSubscription) (*sdkpb.Trigger, error) {
	...
	case "OnFinalityViolation":
		...
		if cap.OnFinalityViolation == nil {
			return nil, registry.ErrNoTriggerStub("OnFinalityViolation")
		}
