...
const file_reportcodec_v3_proto_rawDesc = "" +
	"\n" +
	"\x14reportcodec_v3.proto\x12\x1bloop.internal.pb.mercury.v3\x1a\rrelayer.proto\"\xc4\x02\n" +
	"\fReportFields\x12.\n" +
...
var (
	...
	file_reportcodec_v3_proto_rawDescData []byte
)

func file_reportcodec_v3_proto_rawDescGZIP() []byte {
	file_reportcodec_v3_proto_rawDescOnce.Do(func() {
		file_reportcodec_v3_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_reportcodec_v3_proto_rawDesc), len(file_reportcodec_v3_proto_rawDesc)))
	})
	return file_reportcodec_v3_proto_rawDescData
}

var file_reportcodec_v3_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_reportcodec_v3_proto_goTypes = []any{
...
func file_reportcodec_v3_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_reportcodec_v3_proto_rawDesc), len(file_reportcodec_v3_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
