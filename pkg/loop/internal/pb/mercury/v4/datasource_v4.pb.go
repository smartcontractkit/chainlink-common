...
func (x *ObserveRequest) Reset() {
	*x = ObserveRequest{}
	mi := &file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes[0]
...
func (*ObserveRequest) Descriptor() ([]byte, []int) {
	return file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescGZIP(), []int{0}
}
...
func (x *Block) Reset() {
	*x = Block{}
	mi := &file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescGZIP(), []int{1}
}
...
type Observation struct {
	...
	// Deprecated: Marked as deprecated in loop/internal/pb/mercury/v4/datasource_v4.proto.
...
func (x *Observation) Reset() {
	*x = Observation{}
	mi := &file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Observation) Descriptor() ([]byte, []int) {
	return file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescGZIP(), []int{2}
}
...
func (x *ObserveResponse) Reset() {
	*x = ObserveResponse{}
	mi := &file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ObserveResponse) Descriptor() ([]byte, []int) {
	return file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescGZIP(), []int{3}
}
...
var File_loop_internal_pb_mercury_v4_datasource_v4_proto protoreflect.FileDescriptor

const file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDesc = "" +
	"\n" +
	"/loop/internal/pb/mercury/v4/datasource_v4.proto\x12\x1bloop.internal.pb.mercury.v4\x1a\x1eloop/internal/pb/relayer.proto\"\x90\x01\n" +
...
var (
	file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescOnce sync.Once
	file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescData []byte
)

func file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescGZIP() []byte {
	file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescOnce.Do(func() {
		file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDesc), len(file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDesc)))
	})
	return file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDescData
}

var file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_loop_internal_pb_mercury_v4_datasource_v4_proto_goTypes = []any{
...
var file_loop_internal_pb_mercury_v4_datasource_v4_proto_depIdxs = []int32{
...
func init() { file_loop_internal_pb_mercury_v4_datasource_v4_proto_init() }
func file_loop_internal_pb_mercury_v4_datasource_v4_proto_init() {
	if File_loop_internal_pb_mercury_v4_datasource_v4_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDesc), len(file_loop_internal_pb_mercury_v4_datasource_v4_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_loop_internal_pb_mercury_v4_datasource_v4_proto_goTypes,
		DependencyIndexes: file_loop_internal_pb_mercury_v4_datasource_v4_proto_depIdxs,
		MessageInfos:      file_loop_internal_pb_mercury_v4_datasource_v4_proto_msgTypes,
	}.Build()
	File_loop_internal_pb_mercury_v4_datasource_v4_proto = out.File
	file_loop_internal_pb_mercury_v4_datasource_v4_proto_goTypes = nil
	file_loop_internal_pb_mercury_v4_datasource_v4_proto_depIdxs = nil
}
