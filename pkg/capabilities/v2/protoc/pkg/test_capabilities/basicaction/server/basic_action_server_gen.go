...
func (c *BasicActionServer) Initialise(ctx context.Context, dependencies core.StandardCapabilitiesDependencies) error {
	...
	initAttrs := []attribute.KeyValue{attribute.String("capability", "basic-test-action@1.0.0")}
...
func (c *basicActionCapability) Execute(ctx context.Context, request capabilities.CapabilityRequest) (capabilities.CapabilityResponse, error) {
	...
	case "PerformAction":
		...
		wrapped := func(ctx context.Context, metadata capabilities.RequestMetadata, input *basicaction.Inputs, _ *emptypb.Empty) (*basicaction.Outputs, capabilities.ResponseMetadata, *capabilities.OCRAttestation, error) {
