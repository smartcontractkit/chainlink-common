...
type OCR3StaticReportingPluginWithMedianProvider struct {
}

func (s OCR3StaticReportingPluginWithMedianProvider) ConnToProvider(conn grpc.ClientConnInterface, broker internal.Broker, brokerConfig internal.BrokerConfig) types.MedianProvider {
...
type OCR3StaticReportingPluginWithPluginProvider struct {
}

func (s OCR3StaticReportingPluginWithPluginProvider) ConnToProvider(conn grpc.ClientConnInterface, broker internal.Broker, brokerConfig internal.BrokerConfig) types.PluginProvider {
