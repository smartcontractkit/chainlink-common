...
func file_capabilities_pb_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_capabilities_pb_registry_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_capabilities_pb_registry_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_capabilities_pb_registry_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_capabilities_pb_registry_proto_msgTypes[2].OneofWrappers = []any{
