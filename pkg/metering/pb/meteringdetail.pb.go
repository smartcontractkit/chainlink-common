...
type MeteringReportNodeDetail struct {
	...
	SpendValueInGasUnits string                 `protobuf:"bytes,4,opt,name=spend_value_in_gas_units,json=spendValueInGasUnits,proto3" json:"spend_value_in_gas_units,omitempty"` // native fixed-point integer (wei, lamports, etc.). Empty = legacy, fall back to spend_value + Shift(18).
...
const file_metering_pb_meteringdetail_proto_rawDesc = "" +
	"\n" +
	" metering/pb/meteringdetail.proto\x12\bmetering\"\xb7\x01\n" +
	...
	"spendValue\x126\n" +
	"\x18spend_value_in_gas_units\x18\x04 \x01(\tR\x14spendValueInGasUnitsB>Z<github.com/smartcontractkit/chainlink-common/pkg/metering/pbb\x06proto3"
