...
type GasConfig struct {
	...
	MaxGasPrice   *pb.BigInt `protobuf:"bytes,2,opt,name=max_gas_price,json=maxGasPrice,proto3,oneof" json:"max_gas_price,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GasConfig) GetMaxGasPrice() *pb.BigInt {
	if x != nil {
...
var file_evm_proto_depIdxs = []int32{
	...
	51, // 44: loop.evm.GasConfig.max_gas_price:type_name -> values.v1.BigInt
	...
	51, // 47: loop.evm.CalculateTransactionFeeReply.transaction_fee:type_name -> values.v1.BigInt
	40, // 48: loop.evm.SubmitTransactionRequest.gas_config:type_name -> loop.evm.GasConfig
	0,  // 49: loop.evm.SubmitTransactionReply.txStatus:type_name -> loop.evm.TxStatus
	1,  // 50: loop.evm.GetTransactionStatusReply.transaction_status:type_name -> loop.evm.TransactionStatus
	23, // 51: loop.evm.EVM.GetTransactionFee:input_type -> loop.evm.GetTransactionFeeRequest
	21, // 52: loop.evm.EVM.CallContract:input_type -> loop.evm.CallContractRequest
	25, // 53: loop.evm.EVM.FilterLogs:input_type -> loop.evm.FilterLogsRequest
	27, // 54: loop.evm.EVM.BalanceAt:input_type -> loop.evm.BalanceAtRequest
	29, // 55: loop.evm.EVM.EstimateGas:input_type -> loop.evm.EstimateGasRequest
	31, // 56: loop.evm.EVM.GetTransactionByHash:input_type -> loop.evm.GetTransactionByHashRequest
	33, // 57: loop.evm.EVM.GetTransactionReceipt:input_type -> loop.evm.GetTransactionReceiptRequest
	19, // 58: loop.evm.EVM.HeaderByNumber:input_type -> loop.evm.HeaderByNumberRequest
	37, // 59: loop.evm.EVM.QueryTrackedLogs:input_type -> loop.evm.QueryTrackedLogsRequest
	57, // 60: loop.evm.EVM.GetFiltersNames:input_type -> google.protobuf.Empty
	35, // 61: loop.evm.EVM.RegisterLogTracking:input_type -> loop.evm.RegisterLogTrackingRequest
	36, // 62: loop.evm.EVM.UnregisterLogTracking:input_type -> loop.evm.UnregisterLogTrackingRequest
	46, // 63: loop.evm.EVM.GetTransactionStatus:input_type -> loop.evm.GetTransactionStatusRequest
	44, // 64: loop.evm.EVM.SubmitTransaction:input_type -> loop.evm.SubmitTransactionRequest
	41, // 65: loop.evm.EVM.CalculateTransactionFee:input_type -> loop.evm.CalculateTransactionFeeRequest
	48, // 66: loop.evm.EVM.GetForwarderForEOA:input_type -> loop.evm.GetForwarderForEOARequest
	57, // 67: loop.evm.EVM.GetLatestLPBlock:input_type -> google.protobuf.Empty
	24, // 68: loop.evm.EVM.GetTransactionFee:output_type -> loop.evm.GetTransactionFeeReply
	22, // 69: loop.evm.EVM.CallContract:output_type -> loop.evm.CallContractReply
	26, // 70: loop.evm.EVM.FilterLogs:output_type -> loop.evm.FilterLogsReply
	28, // 71: loop.evm.EVM.BalanceAt:output_type -> loop.evm.BalanceAtReply
	30, // 72: loop.evm.EVM.EstimateGas:output_type -> loop.evm.EstimateGasReply
	32, // 73: loop.evm.EVM.GetTransactionByHash:output_type -> loop.evm.GetTransactionByHashReply
	34, // 74: loop.evm.EVM.GetTransactionReceipt:output_type -> loop.evm.GetTransactionReceiptReply
	20, // 75: loop.evm.EVM.HeaderByNumber:output_type -> loop.evm.HeaderByNumberReply
	38, // 76: loop.evm.EVM.QueryTrackedLogs:output_type -> loop.evm.QueryTrackedLogsReply
	50, // 77: loop.evm.EVM.GetFiltersNames:output_type -> loop.evm.GetFiltersNamesReply
	57, // 78: loop.evm.EVM.RegisterLogTracking:output_type -> google.protobuf.Empty
	57, // 79: loop.evm.EVM.UnregisterLogTracking:output_type -> google.protobuf.Empty
	47, // 80: loop.evm.EVM.GetTransactionStatus:output_type -> loop.evm.GetTransactionStatusReply
	45, // 81: loop.evm.EVM.SubmitTransaction:output_type -> loop.evm.SubmitTransactionReply
	43, // 82: loop.evm.EVM.CalculateTransactionFee:output_type -> loop.evm.CalculateTransactionFeeReply
	49, // 83: loop.evm.EVM.GetForwarderForEOA:output_type -> loop.evm.GetForwarderForEOAReply
	39, // 84: loop.evm.EVM.GetLatestLPBlock:output_type -> loop.evm.GetLatestLPBlockReply
...
func file_evm_proto_init() {
	...
	file_evm_proto_msgTypes[38].OneofWrappers = []any{}
