...
func (c DataStorage) ReadData(
	...
	if options == nil {
		options = &ReadOptions{BlockNumber: nil}
	}
...
func (c *DataStorage) RegisterLogTrackingAccessLogged(runtime sdk.DonRuntime, options *LogTrackingOptions) {
...
func (c *DataStorage) FilterLogsAccessLogged(runtime sdk.DonRuntime, options *FilterOptions) ([]bindings.ParsedLog[AccessLogged], error) {
	if options == nil {
...
func (c *DataStorage) RegisterLogTrackingDataStored(runtime sdk.DonRuntime, options *LogTrackingOptions) {
	//TODO use log tracking options if set
	c.evmClient.RegisterLogTracking(runtime, &evm.RegisterLogTrackingRequest{
		Filter: &evm.LPFilter{
...
func (c *DataStorage) FilterLogsDataStored(runtime sdk.DonRuntime, options *FilterOptions) ([]bindings.ParsedLog[DataStored], error) {
	if options == nil {
		options = &FilterOptions{
			ToBlock: "finalized", //TODO we need a enum / constant
		}
