...
func (x *Confidence) GetConfidence() float64 {
	if x != nil {
		return x.Confidence
	}
	return 0
...
type Primitive_Confidence struct {
	Confidence *Confidence `protobuf:"bytes,3,opt,name=confidence,proto3,oneof"`
}
...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x2c, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x64,
	0x65, 0x6e, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x5f, 0x0a, 0x09, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74,
	...
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x41, 0x4e, 0x44, 0x10, 0x00, 0x12, 0x06, 0x0a, 0x02, 0x4f, 0x52, 0x10, 0x01, 0x2a, 0x2f, 0x0a,
...
var file_chain_reader_proto_goTypes = []interface{}{
	...
	(CursorDirection)(0),          // 2: loop.CursorDirection
	(SortDirection)(0),            // 3: loop.SortDirection
	(SortType)(0),                 // 4: loop.SortType
	...
	(*Confidence)(nil),            // 21: loop.Confidence
...
var file_chain_reader_proto_depIdxs = []int32{
	...
	19, // 19: loop.Primitive.comparator:type_name -> loop.Comparator
	20, // 20: loop.Primitive.block:type_name -> loop.Block
	21, // 21: loop.Primitive.confidence:type_name -> loop.Confidence
	22, // 22: loop.Primitive.timestamp:type_name -> loop.Timestamp
	23, // 23: loop.Primitive.tx_hash:type_name -> loop.TxHash
	2,  // 24: loop.Limit.direction:type_name -> loop.CursorDirection
	4,  // 25: loop.SortBy.sort_type:type_name -> loop.SortType
	3,  // 26: loop.SortBy.direction:type_name -> loop.SortDirection
	26, // 27: loop.LimitAndSort.sort_by:type_name -> loop.SortBy
	25, // 28: loop.LimitAndSort.limit:type_name -> loop.Limit
	5,  // 29: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	6,  // 30: loop.ChainReader.QueryKey:input_type -> loop.QueryKeyRequest
	7,  // 31: loop.ChainReader.Bind:input_type -> loop.BindRequest
	8,  // 32: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	9,  // 33: loop.ChainReader.QueryKey:output_type -> loop.QueryKeyReply
