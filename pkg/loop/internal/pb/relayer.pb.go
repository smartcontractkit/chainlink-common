...
const file_relayer_proto_rawDesc = "" +
	...
	"\x04Sign\x12\x11.loop.SignRequest\x1a\x0f.loop.SignReply\"\x002\xf4\x05\n" +
	"\aRelayer\x12S\n" +
...
var file_relayer_proto_goTypes = []any{
	...
	(Confidence)(0),                           // 54: loop.Confidence
...
var file_relayer_proto_depIdxs = []int32{
	...
	54, // 3: loop.GetBalanceRequest.confidence:type_name -> loop.Confidence
	...
	56, // 8: loop.ReplayRequest.args:type_name -> google.protobuf.Struct
	...
	57, // 20: loop.Keystore.Accounts:input_type -> google.protobuf.Empty
	...
	15, // 26: loop.Relayer.GetBalance:input_type -> loop.GetBalanceRequest
	...
	2,  // 45: loop.Keystore.Accounts:output_type -> loop.AccountsReply
	4,  // 46: loop.Keystore.Sign:output_type -> loop.SignReply
	8,  // 47: loop.Relayer.NewContractWriter:output_type -> loop.NewContractWriterReply
	10, // 48: loop.Relayer.NewContractReader:output_type -> loop.NewContractReaderReply
	14, // 49: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	12, // 50: loop.Relayer.NewPluginProvider:output_type -> loop.NewPluginProviderReply
	16, // 51: loop.Relayer.GetBalance:output_type -> loop.GetBalanceReply
	19, // 52: loop.Relayer.LatestHead:output_type -> loop.LatestHeadReply
	21, // 53: loop.Relayer.GetChainStatus:output_type -> loop.GetChainStatusReply
	24, // 54: loop.Relayer.ListNodeStatuses:output_type -> loop.ListNodeStatusesReply
	57, // 55: loop.Relayer.Transact:output_type -> google.protobuf.Empty
	57, // 56: loop.Relayer.Replay:output_type -> google.protobuf.Empty
	30, // 57: loop.OffchainConfigDigester.ConfigDigest:output_type -> loop.ConfigDigestReply
	32, // 58: loop.OffchainConfigDigester.ConfigDigestPrefix:output_type -> loop.ConfigDigestPrefixReply
	34, // 59: loop.ContractConfigTracker.LatestConfigDetails:output_type -> loop.LatestConfigDetailsReply
	36, // 60: loop.ContractConfigTracker.LatestConfig:output_type -> loop.LatestConfigReply
	38, // 61: loop.ContractConfigTracker.LatestBlockHeight:output_type -> loop.LatestBlockHeightReply
	43, // 62: loop.ContractTransmitter.Transmit:output_type -> loop.TransmitReply
	45, // 63: loop.ContractTransmitter.LatestConfigDigestAndEpoch:output_type -> loop.LatestConfigDigestAndEpochReply
	47, // 64: loop.ContractTransmitter.FromAccount:output_type -> loop.FromAccountReply
	48, // 65: loop.Service.Name:output_type -> loop.NameReply
	57, // 66: loop.Service.Close:output_type -> google.protobuf.Empty
	57, // 67: loop.Service.Ready:output_type -> google.protobuf.Empty
	49, // 68: loop.Service.HealthReport:output_type -> loop.HealthReportReply
