...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4c,
...
var file_chain_reader_proto_depIdxs = []int32{
	...
	3, // 1: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	3, // 2: loop.GetLatestValueReply.retVal:type_name -> loop.VersionedBytes
	0, // 3: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	1, // 4: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
