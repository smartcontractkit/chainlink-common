...
const (
	...
	RelayerSet_NewChainCapabilities_FullMethodName = "/loop.relayerset.RelayerSet/NewChainCapabilities"
...
type RelayerSetClient interface {
	...
	NewChainCapabilities(ctx context.Context, in *NewChainCapabilitiesRequest, opts ...grpc.CallOption) (*NewChainCapabilitiesResponse, error)
...
func (c *relayerSetClient) NewChainCapabilities(ctx context.Context, in *NewChainCapabilitiesRequest, opts ...grpc.CallOption) (*NewChainCapabilitiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewChainCapabilitiesResponse)
	err := c.cc.Invoke(ctx, RelayerSet_NewChainCapabilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelayerSetServer interface {
	...
	NewChainCapabilities(context.Context, *NewChainCapabilitiesRequest) (*NewChainCapabilitiesResponse, error)
...
func (UnimplementedRelayerSetServer) NewChainCapabilities(context.Context, *NewChainCapabilitiesRequest) (*NewChainCapabilitiesResponse, error) {
...
func _RelayerSet_NewChainCapabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewChainCapabilitiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayerSetServer).NewChainCapabilities(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RelayerSet_NewChainCapabilities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayerSetServer).NewChainCapabilities(ctx, req.(*NewChainCapabilitiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RelayerSet_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RelayerSet_NewChainCapabilities_Handler,
		},
		{
