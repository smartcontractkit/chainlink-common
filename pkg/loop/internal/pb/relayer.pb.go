...
var file_relayer_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_relayer_proto_goTypes = []any{
	...
	(*NewEVMChainReply)(nil),                  // 9: loop.NewEVMChainReply
	(*NewContractWriterRequest)(nil),          // 10: loop.NewContractWriterRequest
	(*NewContractWriterReply)(nil),            // 11: loop.NewContractWriterReply
	(*NewContractReaderRequest)(nil),          // 12: loop.NewContractReaderRequest
	(*NewContractReaderReply)(nil),            // 13: loop.NewContractReaderReply
	(*NewPluginProviderRequest)(nil),          // 14: loop.NewPluginProviderRequest
	(*NewPluginProviderReply)(nil),            // 15: loop.NewPluginProviderReply
	(*NewConfigProviderRequest)(nil),          // 16: loop.NewConfigProviderRequest
	(*NewConfigProviderReply)(nil),            // 17: loop.NewConfigProviderReply
...
var file_relayer_proto_depIdxs = []int32{
	50, // 0: loop.GetTransactionFeeReply.transation_fee:type_name -> loop.BigInt
	...
	22, // 5: loop.GetChainStatusReply.chain:type_name -> loop.ChainStatus
	...
	10, // 21: loop.Relayer.NewContractWriter:input_type -> loop.NewContractWriterRequest
	12, // 22: loop.Relayer.NewContractReader:input_type -> loop.NewContractReaderRequest
	16, // 23: loop.Relayer.NewConfigProvider:input_type -> loop.NewConfigProviderRequest
	14, // 24: loop.Relayer.NewPluginProvider:input_type -> loop.NewPluginProviderRequest
	18, // 25: loop.Relayer.LatestHead:input_type -> loop.LatestHeadRequest
	20, // 26: loop.Relayer.GetChainStatus:input_type -> loop.GetChainStatusRequest
	23, // 27: loop.Relayer.ListNodeStatuses:input_type -> loop.ListNodeStatusesRequest
	27, // 28: loop.Relayer.Transact:input_type -> loop.TransactionRequest
	26, // 29: loop.Relayer.Replay:input_type -> loop.ReplayRequest
	...
	11, // 46: loop.Relayer.NewContractWriter:output_type -> loop.NewContractWriterReply
	13, // 47: loop.Relayer.NewContractReader:output_type -> loop.NewContractReaderReply
	17, // 48: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	15, // 49: loop.Relayer.NewPluginProvider:output_type -> loop.NewPluginProviderReply
