...
// FinalizedHead provides a mock function with given fields: _a0
func (_m *Relayer) FinalizedHead(_a0 context.Context) (types.Head, error) {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *Relayer_Expecter) FinalizedHead(_a0 interface{}) *Relayer_FinalizedHead_Call {
	return &Relayer_FinalizedHead_Call{Call: _e.mock.On("FinalizedHead", _a0)}
}

func (_c *Relayer_FinalizedHead_Call) Run(run func(_a0 context.Context)) *Relayer_FinalizedHead_Call {
	_c.Call.Run(func(args mock.Arguments) {
