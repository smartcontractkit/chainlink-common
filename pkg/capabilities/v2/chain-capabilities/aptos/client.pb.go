...
type WriteReportReply struct {
	...
	TxTimestamp                     *uint64                          `protobuf:"varint,6,opt,name=tx_timestamp,json=txTimestamp,proto3,oneof" json:"tx_timestamp,omitempty"` // transaction timestamp in microseconds
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *WriteReportReply) GetTxTimestamp() uint64 {
	if x != nil && x.TxTimestamp != nil {
...
const file_capabilities_blockchain_aptos_v1alpha_client_proto_rawDesc = "" +
	...
	"\ftx_timestamp\x18\x06 \x01(\x04H\x04R\vtxTimestamp\x88\x01\x01B\n" +
	"\n" +
	"\b_tx_hashB\x12\n" +
