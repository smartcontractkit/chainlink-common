...
var file_datasource_v4_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xf9, 0x01, 0x0a, 0x0b, 0x4f, 0x62, 0x73, 0x65,
	...
	0x65, 0x6e, 0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a,
...
var file_datasource_v4_proto_depIdxs = []int32{
	...
	5, // 2: loop.internal.pb.mercury.v4.Observation.linkPrice:type_name -> loop.BigInt
	5, // 3: loop.internal.pb.mercury.v4.Observation.nativePrice:type_name -> loop.BigInt
	2, // 4: loop.internal.pb.mercury.v4.ObserveResponse.observation:type_name -> loop.internal.pb.mercury.v4.Observation
	0, // 5: loop.internal.pb.mercury.v4.DataSource.Observe:input_type -> loop.internal.pb.mercury.v4.ObserveRequest
	3, // 6: loop.internal.pb.mercury.v4.DataSource.Observe:output_type -> loop.internal.pb.mercury.v4.ObserveResponse
