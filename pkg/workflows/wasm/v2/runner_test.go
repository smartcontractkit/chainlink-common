...
func TestRunner_Run(t *testing.T) {
	t.Run("runner gathers subscriptions", func(t *testing.T) {
		...
		dr.Run(func(_ *sdk.WorkflowContext[string]) (sdk.Workflows[string], error) {
...
func assertWcx(t *testing.T, r sdk.Runner[string]) {
	ran := false
	verifyCtx := func(wcx *sdk.WorkflowContext[string]) (sdk.Workflows[string], error) {
		ran = true
		assert.Equal(t, string(anyConfig), wcx.Config)
		assert.IsType(t, &writer{}, wcx.LogWriter)
		return sdk.Workflows[string]{}, nil
