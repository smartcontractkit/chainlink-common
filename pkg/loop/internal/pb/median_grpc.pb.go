...
type PluginMedianClient interface {
	NewMedianPluginFactory(ctx context.Context, in *NewMedianPluginFactoryRequest, opts ...grpc.CallOption) (*NewMedianPluginFactoryReply, error)
}
...
func (c *pluginMedianClient) NewMedianPluginFactory(ctx context.Context, in *NewMedianPluginFactoryRequest, opts ...grpc.CallOption) (*NewMedianPluginFactoryReply, error) {
	out := new(NewMedianPluginFactoryReply)
	err := c.cc.Invoke(ctx, "/loop.PluginMedian/NewMedianPluginFactory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PluginMedianServer interface {
	NewMedianPluginFactory(context.Context, *NewMedianPluginFactoryRequest) (*NewMedianPluginFactoryReply, error)
...
func (UnimplementedPluginMedianServer) NewMedianPluginFactory(context.Context, *NewMedianPluginFactoryRequest) (*NewMedianPluginFactoryReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewMedianPluginFactory not implemented")
}
...
func _PluginMedian_NewMedianPluginFactory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewMedianPluginFactoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PluginMedianServer).NewMedianPluginFactory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loop.PluginMedian/NewMedianPluginFactory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PluginMedianServer).NewMedianPluginFactory(ctx, req.(*NewMedianPluginFactoryRequest))
	}
...
var PluginMedian_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewMedianPluginFactory",
			Handler:    _PluginMedian_NewMedianPluginFactory_Handler,
		},
	},
