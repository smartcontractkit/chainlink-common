...
// 	protoc        v4.23.4
// source: mercury_observation_v3.proto
...
func (x *MercuryObservationProto) Reset() {
	*x = MercuryObservationProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mercury_observation_v3_proto_msgTypes[0]
...
func (*MercuryObservationProto) Descriptor() ([]byte, []int) {
	return file_mercury_observation_v3_proto_rawDescGZIP(), []int{0}
}
...
var file_mercury_observation_v3_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x5f, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x76, 0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a,
	0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x5f, 0x76, 0x33, 0x22, 0x9f, 0x03, 0x0a, 0x17, 0x4d,
	...
	0x2e, 0x3b, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x5f, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_mercury_observation_v3_proto_rawDescOnce sync.Once
	file_mercury_observation_v3_proto_rawDescData = file_mercury_observation_v3_proto_rawDesc
)

func file_mercury_observation_v3_proto_rawDescGZIP() []byte {
	file_mercury_observation_v3_proto_rawDescOnce.Do(func() {
		file_mercury_observation_v3_proto_rawDescData = protoimpl.X.CompressGZIP(file_mercury_observation_v3_proto_rawDescData)
	})
	return file_mercury_observation_v3_proto_rawDescData
}

var file_mercury_observation_v3_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mercury_observation_v3_proto_goTypes = []interface{}{
	(*MercuryObservationProto)(nil), // 0: mercury_v3.MercuryObservationProto
}
var file_mercury_observation_v3_proto_depIdxs = []int32{
...
func init() { file_mercury_observation_v3_proto_init() }
func file_mercury_observation_v3_proto_init() {
	if File_mercury_observation_v3_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mercury_observation_v3_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mercury_observation_v3_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mercury_observation_v3_proto_goTypes,
		DependencyIndexes: file_mercury_observation_v3_proto_depIdxs,
		MessageInfos:      file_mercury_observation_v3_proto_msgTypes,
	}.Build()
	File_mercury_observation_v3_proto = out.File
	file_mercury_observation_v3_proto_rawDesc = nil
	file_mercury_observation_v3_proto_goTypes = nil
	file_mercury_observation_v3_proto_depIdxs = nil
}
