...
type CapabilityClient interface {
	...
	Execute(ctx context.Context, in *CapabilityRequest, opts ...grpc.CallOption) (Capability_ExecuteClient, error)
	RegisterTrigger(ctx context.Context, in *TriggerRegistrationRequest, opts ...grpc.CallOption) (Capability_RegisterTriggerClient, error)
...
func (c *capabilityClient) Info(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*pb.CapabilityInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Capability_Info_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *capabilityClient) Execute(ctx context.Context, in *CapabilityRequest, opts ...grpc.CallOption) (Capability_ExecuteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Capability_ServiceDesc.Streams[0], Capability_Execute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &capabilityExecuteClient{stream}
...
type Capability_ExecuteClient interface {
	Recv() (*CapabilityResponse, error)
	grpc.ClientStream
}

type capabilityExecuteClient struct {
	grpc.ClientStream
}

func (x *capabilityExecuteClient) Recv() (*CapabilityResponse, error) {
...
func (c *capabilityClient) RegisterTrigger(ctx context.Context, in *TriggerRegistrationRequest, opts ...grpc.CallOption) (Capability_RegisterTriggerClient, error) {
	stream, err := c.cc.NewStream(ctx, &Capability_ServiceDesc.Streams[1], Capability_RegisterTrigger_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &capabilityRegisterTriggerClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Capability_RegisterTriggerClient interface {
	Recv() (*TriggerResponseMessage, error)
	grpc.ClientStream
}

type capabilityRegisterTriggerClient struct {
	grpc.ClientStream
}

func (x *capabilityRegisterTriggerClient) Recv() (*TriggerResponseMessage, error) {
...
func (c *capabilityClient) UnregisterTrigger(ctx context.Context, in *TriggerRegistrationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Capability_UnregisterTrigger_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CapabilityServer interface {
	...
	Execute(*CapabilityRequest, Capability_ExecuteServer) error
	RegisterTrigger(*TriggerRegistrationRequest, Capability_RegisterTriggerServer) error
...
func (UnimplementedCapabilityServer) Execute(*CapabilityRequest, Capability_ExecuteServer) error {
	return status.Errorf(codes.Unimplemented, "method Execute not implemented")
}
func (UnimplementedCapabilityServer) RegisterTrigger(*TriggerRegistrationRequest, Capability_RegisterTriggerServer) error {
...
func _Capability_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CapabilityServer).Execute(m, &capabilityExecuteServer{stream})
}

type Capability_ExecuteServer interface {
	Send(*CapabilityResponse) error
	grpc.ServerStream
}

type capabilityExecuteServer struct {
	grpc.ServerStream
}

func (x *capabilityExecuteServer) Send(m *CapabilityResponse) error {
...
func _Capability_RegisterTrigger_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CapabilityServer).RegisterTrigger(m, &capabilityRegisterTriggerServer{stream})
}

type Capability_RegisterTriggerServer interface {
	Send(*TriggerResponseMessage) error
	grpc.ServerStream
}

type capabilityRegisterTriggerServer struct {
	grpc.ServerStream
}

func (x *capabilityRegisterTriggerServer) Send(m *TriggerResponseMessage) error {
	return x.ServerStream.SendMsg(m)
}
