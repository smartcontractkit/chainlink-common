...
func createTestProtoBuf(t *testing.T) ([]string, *bytes.Buffer) {
...
func TestProtobufParse(t *testing.T) {
	...
	_, inputBuf := createTestProtoBuf(t)
		...
		t.Run(scenario.name, func(t *testing.T) {
			...
			for {
				...
				case promtextparse.EntryInvalid:
					require.Fail(t, "unexpected invalid entry")
				}
