...
func (x *NewMedianFactoryRequest) GetGasPriceDataSourceID() uint32 {
	if x != nil {
		return x.GasPriceDataSourceID
	}
	return 0
}
...
type ParsedAttributedObservation struct {
	...
	GasPrice        *BigInt `protobuf:"bytes,5,opt,name=gasPrice,proto3" json:"gasPrice,omitempty"`
}
...
func (x *ParsedAttributedObservation) GetGasPrice() *BigInt {
	if x != nil {
		return x.GasPrice
	}
	return nil
...
var file_median_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xff, 0x01, 0x0a, 0x17, 0x4e, 0x65, 0x77, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x6e, 0x46,
	...
	0x32, 0x0a, 0x14, 0x67, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x44, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x14, 0x67,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xdd, 0x01, 0x0a, 0x1b, 0x50, 0x61, 0x72, 0x73, 0x65,
	...
	0x28, 0x0d, 0x52, 0x08, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x08,
	0x67, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c,
	0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x42, 0x69, 0x67, 0x49, 0x6e, 0x74, 0x52, 0x08, 0x67, 0x61,
	0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x5b, 0x0a, 0x12, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52,
...
var file_median_proto_depIdxs = []int32{
	...
	19, // 2: loop.ParsedAttributedObservation.gasPrice:type_name -> loop.BigInt
