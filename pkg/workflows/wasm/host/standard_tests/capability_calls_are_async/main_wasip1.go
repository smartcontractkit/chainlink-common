...
func main() {
	...
	r1Id := rawsdk.MakeRequestAsync("basic-test-action@1.0.0", "PerformAction", pb.Mode_DON, input1)
	r2Id := rawsdk.MakeRequestAsync("basic-test-action@1.0.0", "PerformAction", pb.Mode_DON, input2)
