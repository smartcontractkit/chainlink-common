...
func (x *GetTransactionStatusRequest) GetLogicalTime() uint64 {
	if x != nil {
		return x.LogicalTime
	}
	return 0
...
type GetTransactionExecutionFeesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LogicalTime   uint64                 `protobuf:"varint,1,opt,name=logical_time,json=logicalTime,proto3" json:"logical_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTransactionExecutionFeesRequest) Reset() {
	*x = GetTransactionExecutionFeesRequest{}
	mi := &file_ton_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTransactionExecutionFeesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTransactionExecutionFeesRequest) ProtoMessage() {}

func (x *GetTransactionExecutionFeesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ton_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTransactionExecutionFeesRequest.ProtoReflect.Descriptor instead.
func (*GetTransactionExecutionFeesRequest) Descriptor() ([]byte, []int) {
	return file_ton_proto_rawDescGZIP(), []int{9}
}

func (x *GetTransactionExecutionFeesRequest) GetLogicalTime() uint64 {
	if x != nil {
		return x.LogicalTime
	}
	return 0
...
type GetTransactionExecutionFeesReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetTransactionExecutionFeesReply) Reset() {
	*x = GetTransactionExecutionFeesReply{}
	mi := &file_ton_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTransactionExecutionFeesReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTransactionExecutionFeesReply) ProtoMessage() {}

func (x *GetTransactionExecutionFeesReply) ProtoReflect() protoreflect.Message {
	mi := &file_ton_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTransactionExecutionFeesReply.ProtoReflect.Descriptor instead.
func (*GetTransactionExecutionFeesReply) Descriptor() ([]byte, []int) {
	return file_ton_proto_rawDescGZIP(), []int{10}
}

func (x *GetTransactionExecutionFeesReply) GetTotalFees() *pb.BigInt {
	if x != nil {
		return x.TotalFees
	}
	return nil
...
var file_ton_proto_goTypes = []any{
	...
	(*GetTransactionExecutionFeesReply)(nil),   // 11: loop.ton.GetTransactionExecutionFeesReply
