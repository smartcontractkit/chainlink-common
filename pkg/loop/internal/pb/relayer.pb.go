...
func (x *GetBalanceRequest) GetConfidence() Confidence {
	if x != nil {
		return x.Confidence
	}
...
func (x *GetBalanceReply) GetBalance() *TokenBalance {
	if x != nil {
		return x.Balance
	}
	return nil
...
const file_relayer_proto_rawDesc = "" +
	"\n" +
	"\rrelayer.proto\x12\x04loop\x1a\x1bgoogle/protobuf/empty.proto\x1a\x15contract_reader.proto\"\x7f\n" +
	...
	"\x10configProviderID\x18\x01 \x01(\rR\x10configProviderID\"_\n" +
	...
	"\abalance\x18\x01 \x01(\v2\x12.loop.TokenBalanceR\abalance\"D\n" +
	"\fTokenBalance\x12\x18\n" +
	"\abalance\x18\x01 \x01(\fR\abalance\x12\x1a\n" +
	"\bdecimals\x18\x02 \x01(\rR\bdecimals\"\x13\n" +
	...
	"\x05state\x18\x04 \x01(\tR\x05state\"\x82\x01\n" +
	...
	"\x04Sign\x12\x11.loop.SignRequest\x1a\x0f.loop.SignReply\"\x002\xbb\x05\n" +
	"\aRelayer\x12S\n" +
	...
	"\n" +
	"GetBalance\x12\x17.loop.GetBalanceRequest\x1a\x15.loop.GetBalanceReply\"\x00\x12>\n" +
	"\n" +
	...
	"\bTransact\x12\x18.loop.TransactionRequest\x1a\x16.google.protobuf.Empty\"\x002\xb6\x01\n" +
...
var file_relayer_proto_goTypes = []any{
	...
	(*GetBalanceRequest)(nil),                 // 15: loop.GetBalanceRequest
	(*GetBalanceReply)(nil),                   // 16: loop.GetBalanceReply
	(*TokenBalance)(nil),                      // 17: loop.TokenBalance
	...
	(Confidence)(0),                           // 53: loop.Confidence
...
var file_relayer_proto_depIdxs = []int32{
	...
	53, // 3: loop.GetBalanceRequest.confidence:type_name -> loop.Confidence
	17, // 4: loop.GetBalanceReply.balance:type_name -> loop.TokenBalance
	54, // 5: loop.LatestHeadReply.head:type_name -> loop.Head
	...
	7,  // 21: loop.Relayer.NewContractWriter:input_type -> loop.NewContractWriterRequest
	9,  // 22: loop.Relayer.NewContractReader:input_type -> loop.NewContractReaderRequest
	13, // 23: loop.Relayer.NewConfigProvider:input_type -> loop.NewConfigProviderRequest
	11, // 24: loop.Relayer.NewPluginProvider:input_type -> loop.NewPluginProviderRequest
	15, // 25: loop.Relayer.GetBalance:input_type -> loop.GetBalanceRequest
	18, // 26: loop.Relayer.LatestHead:input_type -> loop.LatestHeadRequest
	20, // 27: loop.Relayer.GetChainStatus:input_type -> loop.GetChainStatusRequest
	...
	28, // 30: loop.OffchainConfigDigester.ConfigDigest:input_type -> loop.ConfigDigestRequest
	30, // 31: loop.OffchainConfigDigester.ConfigDigestPrefix:input_type -> loop.ConfigDigestPrefixRequest
	32, // 32: loop.ContractConfigTracker.LatestConfigDetails:input_type -> loop.LatestConfigDetailsRequest
	34, // 33: loop.ContractConfigTracker.LatestConfig:input_type -> loop.LatestConfigRequest
	36, // 34: loop.ContractConfigTracker.LatestBlockHeight:input_type -> loop.LatestBlockHeightRequest
	41, // 35: loop.ContractTransmitter.Transmit:input_type -> loop.TransmitRequest
	43, // 36: loop.ContractTransmitter.LatestConfigDigestAndEpoch:input_type -> loop.LatestConfigDigestAndEpochRequest
	45, // 37: loop.ContractTransmitter.FromAccount:input_type -> loop.FromAccountRequest
	55, // 38: loop.Service.Name:input_type -> google.protobuf.Empty
	55, // 39: loop.Service.Close:input_type -> google.protobuf.Empty
	55, // 40: loop.Service.Ready:input_type -> google.protobuf.Empty
	55, // 41: loop.Service.HealthReport:input_type -> google.protobuf.Empty
	...
	8,  // 45: loop.Relayer.NewContractWriter:output_type -> loop.NewContractWriterReply
	10, // 46: loop.Relayer.NewContractReader:output_type -> loop.NewContractReaderReply
	14, // 47: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	12, // 48: loop.Relayer.NewPluginProvider:output_type -> loop.NewPluginProviderReply
	16, // 49: loop.Relayer.GetBalance:output_type -> loop.GetBalanceReply
	19, // 50: loop.Relayer.LatestHead:output_type -> loop.LatestHeadReply
	21, // 51: loop.Relayer.GetChainStatus:output_type -> loop.GetChainStatusReply
	...
	29, // 54: loop.OffchainConfigDigester.ConfigDigest:output_type -> loop.ConfigDigestReply
	31, // 55: loop.OffchainConfigDigester.ConfigDigestPrefix:output_type -> loop.ConfigDigestPrefixReply
	33, // 56: loop.ContractConfigTracker.LatestConfigDetails:output_type -> loop.LatestConfigDetailsReply
	35, // 57: loop.ContractConfigTracker.LatestConfig:output_type -> loop.LatestConfigReply
	37, // 58: loop.ContractConfigTracker.LatestBlockHeight:output_type -> loop.LatestBlockHeightReply
	42, // 59: loop.ContractTransmitter.Transmit:output_type -> loop.TransmitReply
	44, // 60: loop.ContractTransmitter.LatestConfigDigestAndEpoch:output_type -> loop.LatestConfigDigestAndEpochReply
	46, // 61: loop.ContractTransmitter.FromAccount:output_type -> loop.FromAccountReply
	47, // 62: loop.Service.Name:output_type -> loop.NameReply
	55, // 63: loop.Service.Close:output_type -> google.protobuf.Empty
	55, // 64: loop.Service.Ready:output_type -> google.protobuf.Empty
	48, // 65: loop.Service.HealthReport:output_type -> loop.HealthReportReply
