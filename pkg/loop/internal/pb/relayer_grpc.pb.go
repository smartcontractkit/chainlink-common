...
type KeystoreClient interface {
	Keys(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*KeysReply, error)
...
func (c *keystoreClient) Keys(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*KeysReply, error) {
	out := new(KeysReply)
...
type KeystoreServer interface {
	Keys(context.Context, *emptypb.Empty) (*KeysReply, error)
...
func (UnimplementedKeystoreServer) Keys(context.Context, *emptypb.Empty) (*KeysReply, error) {
...
func _Keystore_Keys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeystoreServer).Keys(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type DataSourceClient interface {
	Observe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ObserveReply, error)
}
...
func (c *dataSourceClient) Observe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ObserveReply, error) {
...
type DataSourceServer interface {
	Observe(context.Context, *emptypb.Empty) (*ObserveReply, error)
...
func (UnimplementedDataSourceServer) Observe(context.Context, *emptypb.Empty) (*ObserveReply, error) {
...
func _DataSource_Observe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataSourceServer).Observe(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
