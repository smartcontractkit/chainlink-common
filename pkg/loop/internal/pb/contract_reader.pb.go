...
type GetLatestValueRequest struct {
	...
	Confidence     pb.Confidence          `protobuf:"varint,2,opt,name=confidence,proto3,enum=loop.pb.Confidence" json:"confidence,omitempty"`
	Params         *pb.VersionedBytes     `protobuf:"bytes,3,opt,name=params,proto3" json:"params,omitempty"`
...
func (x *GetLatestValueRequest) GetConfidence() pb.Confidence {
	if x != nil {
		return x.Confidence
	}
...
func (x *GetLatestValueRequest) GetParams() *pb.VersionedBytes {
	if x != nil {
		return x.Params
	}
	return nil
...
type QueryKeyRequest struct {
	...
	LimitAndSort  *pb.LimitAndSort       `protobuf:"bytes,3,opt,name=limit_and_sort,json=limitAndSort,proto3" json:"limit_and_sort,omitempty"`
	AsValueType   bool                   `protobuf:"varint,4,opt,name=as_value_type,json=asValueType,proto3" json:"as_value_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *QueryKeyRequest) GetLimitAndSort() *pb.LimitAndSort {
	if x != nil {
...
func (x *QueryKeysRequest) GetLimitAndSort() *pb.LimitAndSort {
	if x != nil {
		return x.LimitAndSort
	}
	return nil
...
type GetLatestValueReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RetVal        *pb.VersionedBytes     `protobuf:"bytes,1,opt,name=ret_val,json=retVal,proto3" json:"ret_val,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetLatestValueReply) GetRetVal() *pb.VersionedBytes {
	if x != nil {
		return x.RetVal
	}
	return nil
...
func (x *GetLatestValueWithHeadDataReply) GetRetVal() *pb.VersionedBytes {
	if x != nil {
		return x.RetVal
	}
	return nil
...
type BatchRead struct {
	...
	Params        *pb.VersionedBytes     `protobuf:"bytes,2,opt,name=params,proto3" json:"params,omitempty"`
	ReturnVal     *pb.VersionedBytes     `protobuf:"bytes,3,opt,name=return_val,json=returnVal,proto3" json:"return_val,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BatchRead) GetParams() *pb.VersionedBytes {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *BatchRead) GetReturnVal() *pb.VersionedBytes {
	if x != nil {
		return x.ReturnVal
	}
	return nil
...
type QueryKeyFilter struct {
	...
	Expression    []*pb.Expression       `protobuf:"bytes,2,rep,name=expression,proto3" json:"expression,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *QueryKeyFilter) GetExpression() []*pb.Expression {
	if x != nil {
		return x.Expression
	}
	return nil
...
// These types were missing from your proto above but referenced.
...
type BatchReadResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ReadName      string                 `protobuf:"bytes,1,opt,name=read_name,json=readName,proto3" json:"read_name,omitempty"`
	ReturnVal     *pb.VersionedBytes     `protobuf:"bytes,2,opt,name=return_val,json=returnVal,proto3" json:"return_val,omitempty"`
...
func (x *BatchReadResult) GetReturnVal() *pb.VersionedBytes {
	if x != nil {
		return x.ReturnVal
	}
	return nil
...
type Sequence struct {
	...
	Data           *pb.VersionedBytes     `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Sequence) GetData() *pb.VersionedBytes {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SequenceWithKey) GetData() *pb.VersionedBytes {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_loop_internal_pb_contract_reader_proto_rawDesc = "" +
	"\n" +
	"&loop/internal/pb/contract_reader.proto\x12\x04loop\x1a\x1bgoogle/protobuf/empty.proto\x1a\x13loop/pb/types.proto\x1a\x13loop/pb/query.proto\"\xca\x01\n" +
	"\x15GetLatestValueRequest\x12'\n" +
	"\x0fread_identifier\x18\x01 \x01(\tR\x0ereadIdentifier\x123\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x0e2\x13.loop.pb.ConfidenceR\n" +
	"confidence\x12/\n" +
	"\x06params\x18\x03 \x01(\v2\x17.loop.pb.VersionedBytesR\x06params\x12\"\n" +
	"\ras_value_type\x18\x04 \x01(\bR\vasValueType\"N\n" +
	"\x1bBatchGetLatestValuesRequest\x12/\n" +
	"\brequests\x18\x01 \x03(\v2\x13.loop.ContractBatchR\brequests\"\xd1\x01\n" +
	...
	"\x0elimit_and_sort\x18\x03 \x01(\v2\x15.loop.pb.LimitAndSortR\flimitAndSort\x12\"\n" +
	"\ras_value_type\x18\x04 \x01(\bR\vasValueType\"\x82\x01\n" +
	"\x10QueryKeysRequest\x121\n" +
	"\afilters\x18\x01 \x03(\v2\x17.loop.ContractKeyFilterR\afilters\x12;\n" +
	"\x0elimit_and_sort\x18\x02 \x01(\v2\x15.loop.pb.LimitAndSortR\flimitAndSort\"\x96\x01\n" +
	"\x11ContractKeyFilter\x12/\n" +
	"\bcontract\x18\x01 \x01(\v2\x13.loop.BoundContractR\bcontract\x12,\n" +
	"\x06filter\x18\x02 \x01(\v2\x14.loop.QueryKeyFilterR\x06filter\x12\"\n" +
	"\ras_value_type\x18\x04 \x01(\bR\vasValueType\"G\n" +
	"\x13GetLatestValueReply\x120\n" +
	"\aret_val\x18\x01 \x01(\v2\x17.loop.pb.VersionedBytesR\x06retVal\"|\n" +
	"\x1fGetLatestValueWithHeadDataReply\x120\n" +
	"\aret_val\x18\x01 \x01(\v2\x17.loop.pb.VersionedBytesR\x06retVal\x12'\n" +
	...
	"\tsequences\x18\x01 \x03(\v2\x15.loop.SequenceWithKeyR\tsequences\"\x91\x01\n" +
	"\tBatchRead\x12\x1b\n" +
	"\tread_name\x18\x01 \x01(\tR\breadName\x12/\n" +
	"\x06params\x18\x02 \x01(\v2\x17.loop.pb.VersionedBytesR\x06params\x126\n" +
	"\n" +
	"return_val\x18\x03 \x01(\v2\x17.loop.pb.VersionedBytesR\treturnVal\"W\n" +
	"\x0eQueryKeyFilter\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\n" +
	"expression\x18\x02 \x03(\v2\x13.loop.pb.ExpressionR\n" +
	"expression\"=\n" +
	...
	"\rContractBatch\x12/\n" +
	"\bcontract\x18\x01 \x01(\v2\x13.loop.BoundContractR\bcontract\x12%\n" +
	"\x05reads\x18\x02 \x03(\v2\x0f.loop.BatchReadR\x05reads\"w\n" +
	"\x13ContractBatchResult\x12/\n" +
	"\bcontract\x18\x01 \x01(\v2\x13.loop.BoundContractR\bcontract\x12/\n" +
	"\aresults\x18\x02 \x03(\v2\x15.loop.BatchReadResultR\aresults\"|\n" +
	"\x0fBatchReadResult\x12\x1b\n" +
	"\tread_name\x18\x01 \x01(\tR\breadName\x126\n" +
	"\n" +
	"return_val\x18\x02 \x01(\v2\x17.loop.pb.VersionedBytesR\treturnVal\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"P\n" +
	"\x04Head\x12\x16\n" +
	"\x06height\x18\x01 \x01(\tR\x06height\x12\x12\n" +
	"\x04hash\x18\x02 \x01(\fR\x04hash\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x04R\ttimestamp\"\x80\x01\n" +
	"\bSequence\x12'\n" +
	"\x0fsequence_cursor\x18\x01 \x01(\tR\x0esequenceCursor\x12\x1e\n" +
	"\x04head\x18\x02 \x01(\v2\n" +
	".loop.HeadR\x04head\x12+\n" +
	"\x04data\x18\x03 \x01(\v2\x17.loop.pb.VersionedBytesR\x04data\"\x99\x01\n" +
	"\x0fSequenceWithKey\x12'\n" +
	"\x0fsequence_cursor\x18\x01 \x01(\tR\x0esequenceCursor\x12\x1e\n" +
	"\x04head\x18\x02 \x01(\v2\n" +
	".loop.HeadR\x04head\x12+\n" +
	"\x04data\x18\x03 \x01(\v2\x17.loop.pb.VersionedBytesR\x04data\x12\x10\n" +
	"\x03key\x18\x04 \x01(\tR\x03key\">\n" +
	"\vBindRequest\x12/\n" +
	"\bbindings\x18\x01 \x03(\v2\x13.loop.BoundContractR\bbindings\"@\n" +
	"\rUnbindRequest\x12/\n" +
	"\bbindings\x18\x01 \x03(\v2\x13.loop.BoundContractR\bbindings2\x83\x04\n" +
...
var file_loop_internal_pb_contract_reader_proto_goTypes = []any{
	...
	(*GetLatestValueWithHeadDataReply)(nil), // 6: loop.GetLatestValueWithHeadDataReply
	(*BatchGetLatestValuesReply)(nil),       // 7: loop.BatchGetLatestValuesReply
	(*QueryKeyReply)(nil),                   // 8: loop.QueryKeyReply
	(*QueryKeysReply)(nil),                  // 9: loop.QueryKeysReply
	(*BatchRead)(nil),                       // 10: loop.BatchRead
	(*QueryKeyFilter)(nil),                  // 11: loop.QueryKeyFilter
	...
	(*BindRequest)(nil),                     // 19: loop.BindRequest
	(*UnbindRequest)(nil),                   // 20: loop.UnbindRequest
	(pb.Confidence)(0),                      // 21: loop.pb.Confidence
	(*pb.VersionedBytes)(nil),               // 22: loop.pb.VersionedBytes
	(*pb.LimitAndSort)(nil),                 // 23: loop.pb.LimitAndSort
	(*pb.Expression)(nil),                   // 24: loop.pb.Expression
	(*emptypb.Empty)(nil),                   // 25: google.protobuf.Empty
}
var file_loop_internal_pb_contract_reader_proto_depIdxs = []int32{
	21, // 0: loop.GetLatestValueRequest.confidence:type_name -> loop.pb.Confidence
	22, // 1: loop.GetLatestValueRequest.params:type_name -> loop.pb.VersionedBytes
	13, // 2: loop.BatchGetLatestValuesRequest.requests:type_name -> loop.ContractBatch
	12, // 3: loop.QueryKeyRequest.contract:type_name -> loop.BoundContract
	11, // 4: loop.QueryKeyRequest.filter:type_name -> loop.QueryKeyFilter
	23, // 5: loop.QueryKeyRequest.limit_and_sort:type_name -> loop.pb.LimitAndSort
	4,  // 6: loop.QueryKeysRequest.filters:type_name -> loop.ContractKeyFilter
	23, // 7: loop.QueryKeysRequest.limit_and_sort:type_name -> loop.pb.LimitAndSort
	12, // 8: loop.ContractKeyFilter.contract:type_name -> loop.BoundContract
	11, // 9: loop.ContractKeyFilter.filter:type_name -> loop.QueryKeyFilter
	22, // 10: loop.GetLatestValueReply.ret_val:type_name -> loop.pb.VersionedBytes
	22, // 11: loop.GetLatestValueWithHeadDataReply.ret_val:type_name -> loop.pb.VersionedBytes
	16, // 12: loop.GetLatestValueWithHeadDataReply.head_data:type_name -> loop.Head
	14, // 13: loop.BatchGetLatestValuesReply.results:type_name -> loop.ContractBatchResult
	17, // 14: loop.QueryKeyReply.sequences:type_name -> loop.Sequence
	18, // 15: loop.QueryKeysReply.sequences:type_name -> loop.SequenceWithKey
	22, // 16: loop.BatchRead.params:type_name -> loop.pb.VersionedBytes
	22, // 17: loop.BatchRead.return_val:type_name -> loop.pb.VersionedBytes
	24, // 18: loop.QueryKeyFilter.expression:type_name -> loop.pb.Expression
	12, // 19: loop.ContractBatch.contract:type_name -> loop.BoundContract
	10, // 20: loop.ContractBatch.reads:type_name -> loop.BatchRead
	12, // 21: loop.ContractBatchResult.contract:type_name -> loop.BoundContract
	15, // 22: loop.ContractBatchResult.results:type_name -> loop.BatchReadResult
	22, // 23: loop.BatchReadResult.return_val:type_name -> loop.pb.VersionedBytes
	16, // 24: loop.Sequence.head:type_name -> loop.Head
	22, // 25: loop.Sequence.data:type_name -> loop.pb.VersionedBytes
	16, // 26: loop.SequenceWithKey.head:type_name -> loop.Head
	22, // 27: loop.SequenceWithKey.data:type_name -> loop.pb.VersionedBytes
	12, // 28: loop.BindRequest.bindings:type_name -> loop.BoundContract
	12, // 29: loop.UnbindRequest.bindings:type_name -> loop.BoundContract
	...
	19, // 35: loop.ContractReader.Bind:input_type -> loop.BindRequest
	20, // 36: loop.ContractReader.Unbind:input_type -> loop.UnbindRequest
	5,  // 37: loop.ContractReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	6,  // 38: loop.ContractReader.GetLatestValueWithHeadData:output_type -> loop.GetLatestValueWithHeadDataReply
	7,  // 39: loop.ContractReader.BatchGetLatestValues:output_type -> loop.BatchGetLatestValuesReply
	8,  // 40: loop.ContractReader.QueryKey:output_type -> loop.QueryKeyReply
	9,  // 41: loop.ContractReader.QueryKeys:output_type -> loop.QueryKeysReply
