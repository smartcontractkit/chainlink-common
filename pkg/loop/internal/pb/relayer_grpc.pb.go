...
const (
	Relayer_NewEVMChainService_FullMethodName = "/loop.Relayer/NewEVMChainService"
...
type RelayerClient interface {
	NewEVMChainService(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NewEVMChainServiceReply, error)
...
func (c *relayerClient) NewEVMChainService(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NewEVMChainServiceReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewEVMChainServiceReply)
	err := c.cc.Invoke(ctx, Relayer_NewEVMChainService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelayerServer interface {
	NewEVMChainService(context.Context, *emptypb.Empty) (*NewEVMChainServiceReply, error)
...
func (UnimplementedRelayerServer) NewEVMChainService(context.Context, *emptypb.Empty) (*NewEVMChainServiceReply, error) {
...
func _Relayer_NewEVMChainService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayerServer).NewEVMChainService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Relayer_NewEVMChainService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayerServer).NewEVMChainService(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Relayer_NewEVMChainService_Handler,
		},
		{
