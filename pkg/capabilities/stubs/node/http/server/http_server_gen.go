...
type ClientCapability interface {
	Fetch(ctx context.Context, metadata capabilities.RequestMetadata, input *http.HttpFetchRequest) (*http.HttpFetchResponse, error)
...
func (c *clientCapability) Info(ctx context.Context) (capabilities.CapabilityInfo, error) {
	...
	return capabilities.NewCapabilityInfo("http@1.0.0", capabilities.CapabilityTypeCombined, c.ClientCapability.Description())
}
...
func (c *clientCapability) Execute(ctx context.Context, request capabilities.CapabilityRequest) (capabilities.CapabilityResponse, error) {
	...
	case "Fetch":
		...
		wrapped := func(ctx context.Context, metadata capabilities.RequestMetadata, input *http.HttpFetchRequest, _ *emptypb.Empty) (*http.HttpFetchResponse, error) {
			return c.ClientCapability.Fetch(ctx, metadata, input)
		}
