...
// NewEVMChainService provides a mock function with given fields: ctx
func (_m *Relayer) NewEVMChainService(ctx context.Context) (types.EVMChainService, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for NewEVMChainService")
	}

	var r0 types.EVMChainService
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (types.EVMChainService, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) types.EVMChainService); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.EVMChainService)
		}
	}
...
// Relayer_NewEVMChainService_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewEVMChainService'
type Relayer_NewEVMChainService_Call struct {
	*mock.Call
}

// NewEVMChainService is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Relayer_Expecter) NewEVMChainService(ctx interface{}) *Relayer_NewEVMChainService_Call {
	return &Relayer_NewEVMChainService_Call{Call: _e.mock.On("NewEVMChainService", ctx)}
}

func (_c *Relayer_NewEVMChainService_Call) Run(run func(ctx context.Context)) *Relayer_NewEVMChainService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *Relayer_NewEVMChainService_Call) Return(_a0 types.EVMChainService, _a1 error) *Relayer_NewEVMChainService_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Relayer_NewEVMChainService_Call) RunAndReturn(run func(context.Context) (types.EVMChainService, error)) *Relayer_NewEVMChainService_Call {
	_c.Call.Return(run)
	return _c
}
