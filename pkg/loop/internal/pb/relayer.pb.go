...
var file_loop_internal_pb_relayer_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_loop_internal_pb_relayer_proto_goTypes = []any{
	...
	(*NewContractWriterRequest)(nil),          // 4: loop.NewContractWriterRequest
	(*NewContractWriterReply)(nil),            // 5: loop.NewContractWriterReply
	(*NewContractReaderRequest)(nil),          // 6: loop.NewContractReaderRequest
	(*NewContractReaderReply)(nil),            // 7: loop.NewContractReaderReply
	(*NewPluginProviderRequest)(nil),          // 8: loop.NewPluginProviderRequest
	(*NewPluginProviderReply)(nil),            // 9: loop.NewPluginProviderReply
	(*NewConfigProviderRequest)(nil),          // 10: loop.NewConfigProviderRequest
	(*NewConfigProviderReply)(nil),            // 11: loop.NewConfigProviderReply
	(*NewCCIPProviderRequest)(nil),            // 12: loop.NewCCIPProviderRequest
	(*NewCCIPProviderReply)(nil),              // 13: loop.NewCCIPProviderReply
	(*LatestHeadRequest)(nil),                 // 14: loop.LatestHeadRequest
	(*LatestHeadReply)(nil),                   // 15: loop.LatestHeadReply
	(*GetChainStatusRequest)(nil),             // 16: loop.GetChainStatusRequest
	(*GetChainStatusReply)(nil),               // 17: loop.GetChainStatusReply
	(*GetChainInfoRequest)(nil),               // 18: loop.GetChainInfoRequest
	(*GetChainInfoReply)(nil),                 // 19: loop.GetChainInfoReply
	(*ChainStatus)(nil),                       // 20: loop.ChainStatus
	(*ChainInfo)(nil),                         // 21: loop.ChainInfo
...
var file_loop_internal_pb_relayer_proto_depIdxs = []int32{
	...
	2,  // 3: loop.NewCCIPProviderRequest.relayArgs:type_name -> loop.RelayArgs
	53, // 4: loop.LatestHeadReply.head:type_name -> loop.Head
	20, // 5: loop.GetChainStatusReply.chain:type_name -> loop.ChainStatus
	21, // 6: loop.GetChainInfoReply.chain_info:type_name -> loop.ChainInfo
	24, // 7: loop.ListNodeStatusesReply.nodes:type_name -> loop.NodeStatus
	54, // 8: loop.ReplayRequest.args:type_name -> google.protobuf.Struct
	49, // 9: loop.TransactionRequest.amount:type_name -> loop.BigInt
	27, // 10: loop.ConfigDigestRequest.contractConfig:type_name -> loop.ContractConfig
	27, // 11: loop.LatestConfigReply.contractConfig:type_name -> loop.ContractConfig
	38, // 12: loop.ReportContext.reportTimestamp:type_name -> loop.ReportTimestamp
	39, // 13: loop.TransmitRequest.reportContext:type_name -> loop.ReportContext
	40, // 14: loop.TransmitRequest.attributedOnchainSignatures:type_name -> loop.AttributedOnchainSignature
	52, // 15: loop.HealthReportReply.healthReport:type_name -> loop.HealthReportReply.HealthReportEntry
	49, // 16: loop.StarknetSignature.x:type_name -> loop.BigInt
	49, // 17: loop.StarknetSignature.y:type_name -> loop.BigInt
	49, // 18: loop.StarknetMessageHash.hash:type_name -> loop.BigInt
	0,  // 19: loop.PluginRelayer.NewRelayer:input_type -> loop.NewRelayerRequest
	4,  // 20: loop.Relayer.NewContractWriter:input_type -> loop.NewContractWriterRequest
	6,  // 21: loop.Relayer.NewContractReader:input_type -> loop.NewContractReaderRequest
	10, // 22: loop.Relayer.NewConfigProvider:input_type -> loop.NewConfigProviderRequest
	8,  // 23: loop.Relayer.NewPluginProvider:input_type -> loop.NewPluginProviderRequest
	12, // 24: loop.Relayer.NewCCIPProvider:input_type -> loop.NewCCIPProviderRequest
	14, // 25: loop.Relayer.LatestHead:input_type -> loop.LatestHeadRequest
	16, // 26: loop.Relayer.GetChainStatus:input_type -> loop.GetChainStatusRequest
	18, // 27: loop.Relayer.GetChainInfo:input_type -> loop.GetChainInfoRequest
	22, // 28: loop.Relayer.ListNodeStatuses:input_type -> loop.ListNodeStatusesRequest
	26, // 29: loop.Relayer.Transact:input_type -> loop.TransactionRequest
	25, // 30: loop.Relayer.Replay:input_type -> loop.ReplayRequest
	...
	5,  // 44: loop.Relayer.NewContractWriter:output_type -> loop.NewContractWriterReply
	7,  // 45: loop.Relayer.NewContractReader:output_type -> loop.NewContractReaderReply
	11, // 46: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	9,  // 47: loop.Relayer.NewPluginProvider:output_type -> loop.NewPluginProviderReply
	13, // 48: loop.Relayer.NewCCIPProvider:output_type -> loop.NewCCIPProviderReply
	15, // 49: loop.Relayer.LatestHead:output_type -> loop.LatestHeadReply
	17, // 50: loop.Relayer.GetChainStatus:output_type -> loop.GetChainStatusReply
	19, // 51: loop.Relayer.GetChainInfo:output_type -> loop.GetChainInfoReply
	...
	29, // 55: loop.OffchainConfigDigester.ConfigDigest:output_type -> loop.ConfigDigestReply
	31, // 56: loop.OffchainConfigDigester.ConfigDigestPrefix:output_type -> loop.ConfigDigestPrefixReply
	33, // 57: loop.ContractConfigTracker.LatestConfigDetails:output_type -> loop.LatestConfigDetailsReply
	35, // 58: loop.ContractConfigTracker.LatestConfig:output_type -> loop.LatestConfigReply
	37, // 59: loop.ContractConfigTracker.LatestBlockHeight:output_type -> loop.LatestBlockHeightReply
	42, // 60: loop.ContractTransmitter.Transmit:output_type -> loop.TransmitReply
	44, // 61: loop.ContractTransmitter.LatestConfigDigestAndEpoch:output_type -> loop.LatestConfigDigestAndEpochReply
	46, // 62: loop.ContractTransmitter.FromAccount:output_type -> loop.FromAccountReply
	47, // 63: loop.Service.Name:output_type -> loop.NameReply
	55, // 64: loop.Service.Close:output_type -> google.protobuf.Empty
	55, // 65: loop.Service.Ready:output_type -> google.protobuf.Empty
	48, // 66: loop.Service.HealthReport:output_type -> loop.HealthReportReply
