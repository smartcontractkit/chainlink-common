...
func (UnimplementedStellarServer) GetLatestLedger(context.Context, *emptypb.Empty) (*GetLatestLedgerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLatestLedger not implemented")
}
func (UnimplementedStellarServer) ReadContract(context.Context, *ReadContractRequest) (*ReadContractResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadContract not implemented")
}
...
func RegisterStellarServer(s grpc.ServiceRegistrar, srv StellarServer) {
	// If the following call panics, it indicates UnimplementedStellarServer was
