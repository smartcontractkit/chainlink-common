...
func (_m *GatewayConnector) SendToGateway(ctx context.Context, gatewayID string, resp *jsonrpc.Response) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *jsonrpc.Response) error); ok {
...
func (_c *GatewayConnector_SendToGateway_Call) Run(run func(ctx context.Context, gatewayID string, resp *jsonrpc.Response)) *GatewayConnector_SendToGateway_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*jsonrpc.Response))
	})
	return _c
}
...
func (_c *GatewayConnector_SendToGateway_Call) RunAndReturn(run func(context.Context, string, *jsonrpc.Response) error) *GatewayConnector_SendToGateway_Call {
	_c.Call.Return(run)
	return _c
}
