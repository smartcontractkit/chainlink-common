// NOTE: this is a copy of standard container/list implementation with added generics support
...
func checkListLen(t *testing.T, l *List[any], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers(t *testing.T, l *List[any], es []*Element[any]) {
	root := &l.root
