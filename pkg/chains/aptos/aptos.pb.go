...
func (x *ViewReply) GetResult() []*anypb.Any {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ViewPayload) GetArgs() []*anypb.Any {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *SubmitTransactionReply) Reset() {
	*x = SubmitTransactionReply{}
	mi := &file_pkg_chains_aptos_aptos_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubmitTransactionReply) Descriptor() ([]byte, []int) {
	return file_pkg_chains_aptos_aptos_proto_rawDescGZIP(), []int{18}
}
...
func (x *GasConfig) Reset() {
	*x = GasConfig{}
	mi := &file_pkg_chains_aptos_aptos_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GasConfig) Descriptor() ([]byte, []int) {
	return file_pkg_chains_aptos_aptos_proto_rawDescGZIP(), []int{19}
}
...
func (x *PendingTransaction) Reset() {
	*x = PendingTransaction{}
	mi := &file_pkg_chains_aptos_aptos_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PendingTransaction) Descriptor() ([]byte, []int) {
	return file_pkg_chains_aptos_aptos_proto_rawDescGZIP(), []int{20}
}
...
const file_pkg_chains_aptos_aptos_proto_rawDesc = "" +
	...
	"loop.aptos\x1a\x19google/protobuf/any.proto\"4\n" +
	"\x18AccountAPTBalanceRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\fR\aaddress\".\n" +
	"\x16AccountAPTBalanceReply\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\"@\n" +
	"\vViewRequest\x121\n" +
	"\apayload\x18\x01 \x01(\v2\x17.loop.aptos.ViewPayloadR\apayload\"9\n" +
	"\tViewReply\x12,\n" +
	"\x06result\x18\x01 \x03(\v2\x14.google.protobuf.AnyR\x06result\"\xb3\x01\n" +
	"\vViewPayload\x12,\n" +
	"\x06module\x18\x01 \x01(\v2\x14.loop.aptos.ModuleIDR\x06module\x12\x1a\n" +
	"\bfunction\x18\x02 \x01(\tR\bfunction\x120\n" +
	"\targ_types\x18\x03 \x03(\v2\x13.loop.aptos.TypeTagR\bargTypes\x12(\n" +
	"\x04args\x18\x04 \x03(\v2\x14.google.protobuf.AnyR\x04args\"8\n" +
	"\bModuleID\x12\x18\n" +
...
var file_pkg_chains_aptos_aptos_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_chains_aptos_aptos_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_pkg_chains_aptos_aptos_proto_goTypes = []any{
	...
	(*ViewRequest)(nil),              // 4: loop.aptos.ViewRequest
	(*ViewReply)(nil),                // 5: loop.aptos.ViewReply
	(*ViewPayload)(nil),              // 6: loop.aptos.ViewPayload
	(*ModuleID)(nil),                 // 7: loop.aptos.ModuleID
	(*TypeTag)(nil),                  // 8: loop.aptos.TypeTag
	(*VectorTag)(nil),                // 9: loop.aptos.VectorTag
	(*StructTag)(nil),                // 10: loop.aptos.StructTag
	(*GenericTag)(nil),               // 11: loop.aptos.GenericTag
	(*EventsByHandleRequest)(nil),    // 12: loop.aptos.EventsByHandleRequest
	(*EventsByHandleReply)(nil),      // 13: loop.aptos.EventsByHandleReply
	(*Event)(nil),                    // 14: loop.aptos.Event
	(*GUID)(nil),                     // 15: loop.aptos.GUID
	(*TransactionByHashRequest)(nil), // 16: loop.aptos.TransactionByHashRequest
	(*TransactionByHashReply)(nil),   // 17: loop.aptos.TransactionByHashReply
	(*Transaction)(nil),              // 18: loop.aptos.Transaction
	(*SubmitTransactionRequest)(nil), // 19: loop.aptos.SubmitTransactionRequest
	(*SubmitTransactionReply)(nil),   // 20: loop.aptos.SubmitTransactionReply
	(*GasConfig)(nil),                // 21: loop.aptos.GasConfig
	(*PendingTransaction)(nil),       // 22: loop.aptos.PendingTransaction
	(*anypb.Any)(nil),                // 23: google.protobuf.Any
}
var file_pkg_chains_aptos_aptos_proto_depIdxs = []int32{
	6,  // 0: loop.aptos.ViewRequest.payload:type_name -> loop.aptos.ViewPayload
	23, // 1: loop.aptos.ViewReply.result:type_name -> google.protobuf.Any
	7,  // 2: loop.aptos.ViewPayload.module:type_name -> loop.aptos.ModuleID
	8,  // 3: loop.aptos.ViewPayload.arg_types:type_name -> loop.aptos.TypeTag
	23, // 4: loop.aptos.ViewPayload.args:type_name -> google.protobuf.Any
	0,  // 5: loop.aptos.TypeTag.type:type_name -> loop.aptos.TypeTagType
	9,  // 6: loop.aptos.TypeTag.vector:type_name -> loop.aptos.VectorTag
	10, // 7: loop.aptos.TypeTag.struct:type_name -> loop.aptos.StructTag
	11, // 8: loop.aptos.TypeTag.generic:type_name -> loop.aptos.GenericTag
	8,  // 9: loop.aptos.VectorTag.element_type:type_name -> loop.aptos.TypeTag
	8,  // 10: loop.aptos.StructTag.type_params:type_name -> loop.aptos.TypeTag
	14, // 11: loop.aptos.EventsByHandleReply.events:type_name -> loop.aptos.Event
	15, // 12: loop.aptos.Event.guid:type_name -> loop.aptos.GUID
	18, // 13: loop.aptos.TransactionByHashReply.transaction:type_name -> loop.aptos.Transaction
	1,  // 14: loop.aptos.Transaction.type:type_name -> loop.aptos.TransactionVariant
	7,  // 15: loop.aptos.SubmitTransactionRequest.receiver_module_id:type_name -> loop.aptos.ModuleID
	21, // 16: loop.aptos.SubmitTransactionRequest.gas_config:type_name -> loop.aptos.GasConfig
	22, // 17: loop.aptos.SubmitTransactionReply.pending_transaction:type_name -> loop.aptos.PendingTransaction
	2,  // 18: loop.aptos.Aptos.AccountAPTBalance:input_type -> loop.aptos.AccountAPTBalanceRequest
	4,  // 19: loop.aptos.Aptos.View:input_type -> loop.aptos.ViewRequest
	12, // 20: loop.aptos.Aptos.EventsByHandle:input_type -> loop.aptos.EventsByHandleRequest
	16, // 21: loop.aptos.Aptos.TransactionByHash:input_type -> loop.aptos.TransactionByHashRequest
	19, // 22: loop.aptos.Aptos.SubmitTransaction:input_type -> loop.aptos.SubmitTransactionRequest
	3,  // 23: loop.aptos.Aptos.AccountAPTBalance:output_type -> loop.aptos.AccountAPTBalanceReply
	5,  // 24: loop.aptos.Aptos.View:output_type -> loop.aptos.ViewReply
	13, // 25: loop.aptos.Aptos.EventsByHandle:output_type -> loop.aptos.EventsByHandleReply
	17, // 26: loop.aptos.Aptos.TransactionByHash:output_type -> loop.aptos.TransactionByHashReply
	20, // 27: loop.aptos.Aptos.SubmitTransaction:output_type -> loop.aptos.SubmitTransactionReply
...
func file_pkg_chains_aptos_aptos_proto_init() {
	...
	file_pkg_chains_aptos_aptos_proto_msgTypes[10].OneofWrappers = []any{}
	...
	file_pkg_chains_aptos_aptos_proto_msgTypes[16].OneofWrappers = []any{}
	file_pkg_chains_aptos_aptos_proto_msgTypes[17].OneofWrappers = []any{}
	file_pkg_chains_aptos_aptos_proto_msgTypes[18].OneofWrappers = []any{}
	file_pkg_chains_aptos_aptos_proto_msgTypes[20].OneofWrappers = []any{}
	type x struct{}
