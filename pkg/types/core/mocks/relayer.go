...
// NewEVMChainService provides a mock function with given fields: _a0
func (_m *Relayer) NewEVMChainService(_a0 context.Context) (types.EVMChainService, error) {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *Relayer_Expecter) NewEVMChainService(_a0 interface{}) *Relayer_NewEVMChainService_Call {
	return &Relayer_NewEVMChainService_Call{Call: _e.mock.On("NewEVMChainService", _a0)}
}

func (_c *Relayer_NewEVMChainService_Call) Run(run func(_a0 context.Context)) *Relayer_NewEVMChainService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
