...
type ChainAccessorClient interface {
	...
	GetAllConfigLegacySnapshot(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ChainConfigSnapshot, error)
	GetChainFeeComponents(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ChainFeeComponents, error)
	...
	NextSeqNum(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SeqNumMap, error)
	Nonces(ctx context.Context, in *AddressMap, opts ...grpc.CallOption) (*NoncesResponse, error)
	GetChainFeePriceUpdate(ctx context.Context, in *ChainFeePriceUpdateRequest, opts ...grpc.CallOption) (*ChainFeePriceUpdateResponse, error)
	...
	LatestMessageTo(ctx context.Context, in *ChainSelectorRequest, opts ...grpc.CallOption) (*SeqNumResponse, error)
	GetExpectedNextSequenceNumber(ctx context.Context, in *ChainSelectorRequest, opts ...grpc.CallOption) (*SeqNumResponse, error)
	GetTokenPriceUSD(ctx context.Context, in *GetTokenPriceUSDRequest, opts ...grpc.CallOption) (*GetTokenPriceUSDResponse, error)
	GetFeeQuoterDestChainConfig(ctx context.Context, in *GetFeeQuoterDestChainConfigRequest, opts ...grpc.CallOption) (*FeeQuoterDestChainConfig, error)
	// RMNAccessor
	GetRMNCurseInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CurseInfo, error)
}
...
func (c *chainAccessorClient) GetAllConfigLegacySnapshot(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ChainConfigSnapshot, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChainConfigSnapshot)
...
func (c *chainAccessorClient) GetChainFeeComponents(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ChainFeeComponents, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChainFeeComponents)
...
func (c *chainAccessorClient) NextSeqNum(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SeqNumMap, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SeqNumMap)
...
func (c *chainAccessorClient) Nonces(ctx context.Context, in *AddressMap, opts ...grpc.CallOption) (*NoncesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *chainAccessorClient) GetChainFeePriceUpdate(ctx context.Context, in *ChainFeePriceUpdateRequest, opts ...grpc.CallOption) (*ChainFeePriceUpdateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChainFeePriceUpdateResponse)
...
func (c *chainAccessorClient) LatestMessageTo(ctx context.Context, in *ChainSelectorRequest, opts ...grpc.CallOption) (*SeqNumResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SeqNumResponse)
...
func (c *chainAccessorClient) GetExpectedNextSequenceNumber(ctx context.Context, in *ChainSelectorRequest, opts ...grpc.CallOption) (*SeqNumResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SeqNumResponse)
...
func (c *chainAccessorClient) GetFeeQuoterDestChainConfig(ctx context.Context, in *GetFeeQuoterDestChainConfigRequest, opts ...grpc.CallOption) (*FeeQuoterDestChainConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeeQuoterDestChainConfig)
...
func (c *chainAccessorClient) GetRMNCurseInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CurseInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CurseInfo)
...
type ChainAccessorServer interface {
	...
	GetAllConfigLegacySnapshot(context.Context, *emptypb.Empty) (*ChainConfigSnapshot, error)
	GetChainFeeComponents(context.Context, *emptypb.Empty) (*ChainFeeComponents, error)
	...
	NextSeqNum(context.Context, *emptypb.Empty) (*SeqNumMap, error)
	Nonces(context.Context, *AddressMap) (*NoncesResponse, error)
	GetChainFeePriceUpdate(context.Context, *ChainFeePriceUpdateRequest) (*ChainFeePriceUpdateResponse, error)
	...
	LatestMessageTo(context.Context, *ChainSelectorRequest) (*SeqNumResponse, error)
	GetExpectedNextSequenceNumber(context.Context, *ChainSelectorRequest) (*SeqNumResponse, error)
	GetTokenPriceUSD(context.Context, *GetTokenPriceUSDRequest) (*GetTokenPriceUSDResponse, error)
	GetFeeQuoterDestChainConfig(context.Context, *GetFeeQuoterDestChainConfigRequest) (*FeeQuoterDestChainConfig, error)
	// RMNAccessor
	GetRMNCurseInfo(context.Context, *emptypb.Empty) (*CurseInfo, error)
...
func (UnimplementedChainAccessorServer) GetAllConfigLegacySnapshot(context.Context, *emptypb.Empty) (*ChainConfigSnapshot, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllConfigLegacySnapshot not implemented")
}
func (UnimplementedChainAccessorServer) GetChainFeeComponents(context.Context, *emptypb.Empty) (*ChainFeeComponents, error) {
...
func (UnimplementedChainAccessorServer) NextSeqNum(context.Context, *emptypb.Empty) (*SeqNumMap, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NextSeqNum not implemented")
}
func (UnimplementedChainAccessorServer) Nonces(context.Context, *AddressMap) (*NoncesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Nonces not implemented")
}
func (UnimplementedChainAccessorServer) GetChainFeePriceUpdate(context.Context, *ChainFeePriceUpdateRequest) (*ChainFeePriceUpdateResponse, error) {
...
func (UnimplementedChainAccessorServer) LatestMessageTo(context.Context, *ChainSelectorRequest) (*SeqNumResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LatestMessageTo not implemented")
}
func (UnimplementedChainAccessorServer) GetExpectedNextSequenceNumber(context.Context, *ChainSelectorRequest) (*SeqNumResponse, error) {
...
func (UnimplementedChainAccessorServer) GetFeeQuoterDestChainConfig(context.Context, *GetFeeQuoterDestChainConfigRequest) (*FeeQuoterDestChainConfig, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFeeQuoterDestChainConfig not implemented")
}
func (UnimplementedChainAccessorServer) GetRMNCurseInfo(context.Context, *emptypb.Empty) (*CurseInfo, error) {
...
func _ChainAccessor_GetAllConfigLegacySnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).GetAllConfigLegacySnapshot(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChainAccessor_NextSeqNum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).NextSeqNum(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChainAccessor_Nonces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).Nonces(ctx, req.(*AddressMap))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChainAccessor_GetChainFeePriceUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChainFeePriceUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).GetChainFeePriceUpdate(ctx, req.(*ChainFeePriceUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChainAccessor_LatestMessageTo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).LatestMessageTo(ctx, req.(*ChainSelectorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChainAccessor_GetExpectedNextSequenceNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainAccessorServer).GetExpectedNextSequenceNumber(ctx, req.(*ChainSelectorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
