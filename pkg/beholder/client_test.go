...
func TestClient(t *testing.T) {
	defaultCustomAttributes := func() map[string]any {
		return map[string]any{
			...
			"nil_key_1":                        nil,
			beholder.AttrKeyBeholderDomain:     "TestDomain",        // Required field
			beholder.AttrKeyBeholderEntity:     "TestEntity",        // Required field
			beholder.AttrKeyBeholderDataSchema: "/schemas/ids/1001", // Required field, URI
		}
	}
