...
var file_capabilities_v2_chain_capabilities_evm_capability_proto_goTypes = []any{
	...
	(*evm.WriteReportRequest)(nil),           // 12: loop.evm.WriteReportRequest
...
var file_capabilities_v2_chain_capabilities_evm_capability_proto_depIdxs = []int32{
	...
	12, // 11: cre.sdk.v2.evm.Client.WriteReport:input_type -> loop.evm.WriteReportRequest
	1,  // 12: cre.sdk.v2.evm.Client.LogTrigger:input_type -> cre.sdk.v2.evm.FilterLogTriggerRequest
	...
	8,  // 21: cre.sdk.v2.evm.Client.RegisterLogTracking:output_type -> google.protobuf.Empty
	8,  // 22: cre.sdk.v2.evm.Client.UnregisterLogTracking:output_type -> google.protobuf.Empty
	21, // 23: cre.sdk.v2.evm.Client.WriteReport:output_type -> loop.evm.WriteReportReply
	22, // 24: cre.sdk.v2.evm.Client.LogTrigger:output_type -> loop.evm.Log
