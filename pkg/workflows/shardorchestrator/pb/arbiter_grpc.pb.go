...
func (UnimplementedArbiterServer) GetDesiredReplicas(context.Context, *ShardStatus) (*ArbiterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDesiredReplicas not implemented")
}
...
func RegisterArbiterServer(s grpc.ServiceRegistrar, srv ArbiterServer) {
	// If the following call panics, it indicates UnimplementedArbiterServer was
...
func (UnimplementedArbiterScalerServer) ConsensusWantShards(context.Context, *ConsensusWantShardsRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ConsensusWantShards not implemented")
}
...
func RegisterArbiterScalerServer(s grpc.ServiceRegistrar, srv ArbiterScalerServer) {
	// If the following call panics, it indicates UnimplementedArbiterScalerServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
