...
const file_pkg_chains_aptos_aptos_proto_rawDesc = "" +
	...
	"\x11TX_STATUS_SUCCESS\x10\x022\xb2\x03\n" +
	"\x05Aptos\x12]\n" +
...
var file_pkg_chains_aptos_aptos_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_pkg_chains_aptos_aptos_proto_goTypes = []any{
	...
	(*EventsByHandleRequest)(nil),    // 13: loop.aptos.EventsByHandleRequest
	(*EventsByHandleReply)(nil),      // 14: loop.aptos.EventsByHandleReply
	(*Event)(nil),                    // 15: loop.aptos.Event
	(*GUID)(nil),                     // 16: loop.aptos.GUID
	(*TransactionByHashRequest)(nil), // 17: loop.aptos.TransactionByHashRequest
	(*TransactionByHashReply)(nil),   // 18: loop.aptos.TransactionByHashReply
	(*Transaction)(nil),              // 19: loop.aptos.Transaction
	(*SubmitTransactionRequest)(nil), // 20: loop.aptos.SubmitTransactionRequest
	(*SubmitTransactionReply)(nil),   // 21: loop.aptos.SubmitTransactionReply
	(*GasConfig)(nil),                // 22: loop.aptos.GasConfig
}
var file_pkg_chains_aptos_aptos_proto_depIdxs = []int32{
	...
	15, // 9: loop.aptos.EventsByHandleReply.events:type_name -> loop.aptos.Event
	16, // 10: loop.aptos.Event.guid:type_name -> loop.aptos.GUID
	19, // 11: loop.aptos.TransactionByHashReply.transaction:type_name -> loop.aptos.Transaction
	1,  // 12: loop.aptos.Transaction.type:type_name -> loop.aptos.TransactionVariant
	8,  // 13: loop.aptos.SubmitTransactionRequest.receiver_module_id:type_name -> loop.aptos.ModuleID
	22, // 14: loop.aptos.SubmitTransactionRequest.gas_config:type_name -> loop.aptos.GasConfig
	2,  // 15: loop.aptos.SubmitTransactionReply.tx_status:type_name -> loop.aptos.TxStatus
	3,  // 16: loop.aptos.Aptos.AccountAPTBalance:input_type -> loop.aptos.AccountAPTBalanceRequest
	5,  // 17: loop.aptos.Aptos.View:input_type -> loop.aptos.ViewRequest
	13, // 18: loop.aptos.Aptos.EventsByHandle:input_type -> loop.aptos.EventsByHandleRequest
	17, // 19: loop.aptos.Aptos.TransactionByHash:input_type -> loop.aptos.TransactionByHashRequest
	20, // 20: loop.aptos.Aptos.SubmitTransaction:input_type -> loop.aptos.SubmitTransactionRequest
	4,  // 21: loop.aptos.Aptos.AccountAPTBalance:output_type -> loop.aptos.AccountAPTBalanceReply
	6,  // 22: loop.aptos.Aptos.View:output_type -> loop.aptos.ViewReply
	14, // 23: loop.aptos.Aptos.EventsByHandle:output_type -> loop.aptos.EventsByHandleReply
	18, // 24: loop.aptos.Aptos.TransactionByHash:output_type -> loop.aptos.TransactionByHashReply
	21, // 25: loop.aptos.Aptos.SubmitTransaction:output_type -> loop.aptos.SubmitTransactionReply
