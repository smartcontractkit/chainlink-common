...
func (_m *GatewayConnectorHandler) HandleGatewayMessage(ctx context.Context, gatewayID string, req *jsonrpc2.Request[jsontext.Value]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *jsonrpc2.Request[jsontext.Value]) error); ok {
...
//   - ctx context.Context
//   - gatewayID string
//   - req *jsonrpc2.Request[jsontext.Value]
...
func (_c *GatewayConnectorHandler_HandleGatewayMessage_Call) Run(run func(ctx context.Context, gatewayID string, req *jsonrpc2.Request[jsontext.Value])) *GatewayConnectorHandler_HandleGatewayMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*jsonrpc2.Request[jsontext.Value]))
	})
	return _c
}
...
func (_c *GatewayConnectorHandler_HandleGatewayMessage_Call) RunAndReturn(run func(context.Context, string, *jsonrpc2.Request[jsontext.Value]) error) *GatewayConnectorHandler_HandleGatewayMessage_Call {
	_c.Call.Return(run)
	return _c
}
