...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_capabilities_v2_actions_http_client_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_capabilities_v2_actions_http_client_proto_rawDescGZIP(), []int{2}
}
...
const file_capabilities_v2_actions_http_client_proto_rawDesc = "" +
	"\n" +
	")capabilities/v2/actions/http/client.proto\x1a0capabilities/v2/protoc/pkg/pb/cre_metadata.proto\"@\n" +
...
var file_capabilities_v2_actions_http_client_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
