...
// CalculateTransactionFee provides a mock function with given fields: ctx, receipt
func (_m *EVMService) CalculateTransactionFee(ctx context.Context, receipt evm.Receipt) (*evm.TransactionFee, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, evm.Receipt) (*evm.TransactionFee, error)); ok {
		return rf(ctx, receipt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, evm.Receipt) *evm.TransactionFee); ok {
		r0 = rf(ctx, receipt)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, evm.Receipt) error); ok {
		r1 = rf(ctx, receipt)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - receipt evm.Receipt
func (_e *EVMService_Expecter) CalculateTransactionFee(ctx interface{}, receipt interface{}) *EVMService_CalculateTransactionFee_Call {
	return &EVMService_CalculateTransactionFee_Call{Call: _e.mock.On("CalculateTransactionFee", ctx, receipt)}
}

func (_c *EVMService_CalculateTransactionFee_Call) Run(run func(ctx context.Context, receipt evm.Receipt)) *EVMService_CalculateTransactionFee_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(evm.Receipt))
	})
	return _c
}
...
func (_c *EVMService_CalculateTransactionFee_Call) RunAndReturn(run func(context.Context, evm.Receipt) (*evm.TransactionFee, error)) *EVMService_CalculateTransactionFee_Call {
	_c.Call.Return(run)
	return _c
}
...
// IsTxFinalized provides a mock function with given fields: ctx, txHash, maxWaitTime
func (_m *EVMService) IsTxFinalized(ctx context.Context, txHash [32]byte, maxWaitTime time.Duration) (bool, error) {
	ret := _m.Called(ctx, txHash, maxWaitTime)
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, [32]byte, time.Duration) (bool, error)); ok {
		return rf(ctx, txHash, maxWaitTime)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [32]byte, time.Duration) bool); ok {
		r0 = rf(ctx, txHash, maxWaitTime)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, [32]byte, time.Duration) error); ok {
		r1 = rf(ctx, txHash, maxWaitTime)
	} else {
		r1 = ret.Error(1)
	}
...
// EVMService_IsTxFinalized_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsTxFinalized'
type EVMService_IsTxFinalized_Call struct {
	*mock.Call
}
...
func (_e *EVMService_Expecter) IsTxFinalized(ctx interface{}, txHash interface{}, maxWaitTime interface{}) *EVMService_IsTxFinalized_Call {
	return &EVMService_IsTxFinalized_Call{Call: _e.mock.On("IsTxFinalized", ctx, txHash, maxWaitTime)}
}

func (_c *EVMService_IsTxFinalized_Call) Run(run func(ctx context.Context, txHash [32]byte, maxWaitTime time.Duration)) *EVMService_IsTxFinalized_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([32]byte), args[2].(time.Duration))
	})
	return _c
}

func (_c *EVMService_IsTxFinalized_Call) Return(_a0 bool, _a1 error) *EVMService_IsTxFinalized_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EVMService_IsTxFinalized_Call) RunAndReturn(run func(context.Context, [32]byte, time.Duration) (bool, error)) *EVMService_IsTxFinalized_Call {
	_c.Call.Return(run)
	return _c
}
