...
func (p *pluginRelayer) Start(ctx context.Context) error { return nil }
...
func (r *relayer) NewContractWriter(ctx context.Context, contractWriterConfig []byte) (types.ContractWriter, error) {
