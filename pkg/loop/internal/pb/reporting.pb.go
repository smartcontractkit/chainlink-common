...
func file_reporting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_reporting_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_reporting_proto_msgTypes[15].Exporter = func(v any, i int) any {
