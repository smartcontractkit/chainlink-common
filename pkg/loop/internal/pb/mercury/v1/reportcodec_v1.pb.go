...
func (x *ReportFields) Reset() {
	*x = ReportFields{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[0]
...
func (*ReportFields) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{0}
}
...
func (x *BuildReportRequest) Reset() {
	*x = BuildReportRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildReportRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuildReportReply) Reset() {
	*x = BuildReportReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildReportReply) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{2}
}
...
func (x *MaxReportLengthRequest) Reset() {
	*x = MaxReportLengthRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MaxReportLengthRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{3}
}
...
func (x *MaxReportLengthReply) Reset() {
	*x = MaxReportLengthReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MaxReportLengthReply) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{4}
}
...
func (x *CurrentBlockNumFromReportRequest) Reset() {
	*x = CurrentBlockNumFromReportRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CurrentBlockNumFromReportRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{5}
}
...
func (x *CurrentBlockNumFromReportResponse) Reset() {
	*x = CurrentBlockNumFromReportResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CurrentBlockNumFromReportResponse) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP(), []int{6}
}
...
var File_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto protoreflect.FileDescriptor

var file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDesc = []byte{
	0x0a, 0x34, 0x70, 0x6b, 0x67, 0x2f, 0x6c, 0x6f, 0x6f, 0x70, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72,
	...
	0x2e, 0x76, 0x31, 0x1a, 0x22, 0x70, 0x6b, 0x67, 0x2f, 0x6c, 0x6f, 0x6f, 0x70, 0x2f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x02, 0x0a, 0x0c, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x63, 0x0a, 0x12, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52,
	...
	0x67, 0x74, 0x68, 0x22, 0x3a, 0x0a, 0x20, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c,
	...
	0x4d, 0x0a, 0x21, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e,
	0x75, 0x6d, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x32, 0x9a,
	0x03, 0x0a, 0x0b, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x12, 0x6f,
	...
	0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4c,
	0x65, 0x6e, 0x67, 0x74, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x9c, 0x01, 0x0a,
	0x19, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d,
	0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x3d, 0x2e, 0x6c, 0x6f, 0x6f,
	...
	0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3e, 0x2e, 0x6c, 0x6f, 0x6f, 0x70,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x5a, 0x5a, 0x58, 0x67,
	...
	0x2f, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x6d, 0x65, 0x72, 0x63,
	0x75, 0x72, 0x79, 0x76, 0x31, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescOnce sync.Once
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescData = file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDesc
)

func file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescGZIP() []byte {
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescOnce.Do(func() {
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescData)
	})
	return file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDescData
}

var file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_goTypes = []interface{}{
...
var file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_depIdxs = []int32{
...
func init() { file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_init() }
func file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_init() {
	if File_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_goTypes,
		DependencyIndexes: file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_depIdxs,
		MessageInfos:      file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_msgTypes,
	}.Build()
	File_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto = out.File
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_rawDesc = nil
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_goTypes = nil
	file_pkg_loop_internal_pb_mercury_v1_reportcodec_v1_proto_depIdxs = nil
}
