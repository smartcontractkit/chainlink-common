...
type EVM2AnyRampMessage struct {
	...
	Sender [][]byte `protobuf:"bytes,1,rep,name=sender,proto3" json:"sender,omitempty"`
	...
	Receiver [][]byte `protobuf:"bytes,3,rep,name=receiver,proto3" json:"receiver,omitempty"`
	// ExtraArgs is destination-chain specific extra args, such as the gasLimit for EVM chains
	ExtraArgs [][]byte `protobuf:"bytes,4,rep,name=extra_args,json=extraArgs,proto3" json:"extra_args,omitempty"`
	// FeeToken is the fee token address. len(FeeToken) == 20 (i.e, is not abi-encoded)
	FeeToken [][]byte `protobuf:"bytes,5,rep,name=fee_token,json=feeToken,proto3" json:"fee_token,omitempty"`
	// FeeTokenAmount is the amount of fee tokens paid.
	FeeTokenAmount *BigInt `protobuf:"bytes,6,opt,name=fee_token_amount,json=feeTokenAmount,proto3" json:"fee_token_amount,omitempty"`
	// TokenAmounts is the array of tokens and amounts to transfer.
	TokenAmounts []*RampTokenAmount `protobuf:"bytes,7,rep,name=token_amounts,json=tokenAmounts,proto3" json:"token_amounts,omitempty"`
}

func (x *EVM2AnyRampMessage) Reset() {
	*x = EVM2AnyRampMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *EVM2AnyRampMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EVM2AnyRampMessage) ProtoMessage() {}

func (x *EVM2AnyRampMessage) ProtoReflect() protoreflect.Message {
	mi := &file_models_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EVM2AnyRampMessage.ProtoReflect.Descriptor instead.
func (*EVM2AnyRampMessage) Descriptor() ([]byte, []int) {
	return file_models_proto_rawDescGZIP(), []int{2}
}

func (x *EVM2AnyRampMessage) GetSender() [][]byte {
	if x != nil {
		return x.Sender
	}
	return nil
...
func (x *EVM2AnyRampMessage) GetData() [][]byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *EVM2AnyRampMessage) GetReceiver() [][]byte {
	if x != nil {
		return x.Receiver
	}
	return nil
...
func (x *EVM2AnyRampMessage) GetExtraArgs() [][]byte {
	if x != nil {
		return x.ExtraArgs
	}
	return nil
...
func (x *EVM2AnyRampMessage) GetFeeToken() [][]byte {
	if x != nil {
		return x.FeeToken
	}
	return nil
...
func (x *EVM2AnyRampMessage) GetFeeTokenAmount() *BigInt {
	if x != nil {
...
func (x *EVM2AnyRampMessage) GetTokenAmounts() []*RampTokenAmount {
	if x != nil {
...
type Message struct {
	...
	// Types that are assignable to RampMessage:
	//
	//	*Message_Evm_2AnyRampMessage
	RampMessage isMessage_RampMessage `protobuf_oneof:"ramp_message"`
}
...
func (m *Message) GetRampMessage() isMessage_RampMessage {
	if m != nil {
		return m.RampMessage
	}
	return nil
}

func (x *Message) GetEvm_2AnyRampMessage() *EVM2AnyRampMessage {
	if x, ok := x.GetRampMessage().(*Message_Evm_2AnyRampMessage); ok {
		return x.Evm_2AnyRampMessage
	}
	return nil
}

type isMessage_RampMessage interface {
	isMessage_RampMessage()
}

type Message_Evm_2AnyRampMessage struct {
	// EVM2AnyRampMessage is populated if the CCIP message originated from an EVM chain.
	Evm_2AnyRampMessage *EVM2AnyRampMessage `protobuf:"bytes,2,opt,name=evm_2_any_ramp_message,json=evm2AnyRampMessage,proto3,oneof"`
}

func (*Message_Evm_2AnyRampMessage) isMessage_RampMessage() {}
...
var file_models_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x63, 0x69, 0x70, 0x6f, 0x63, 0x72, 0x33, 0x22, 0xf8, 0x01, 0x0a, 0x11, 0x52, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x4a, 0x0a, 0x0d, 0x73, 0x65, 0x71, 0x5f, 0x6e, 0x75, 0x6d, 0x5f, 0x72, 0x61, 0x6e, 0x67,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x63, 0x63, 0x69, 0x70, 0x6f,
	0x63, 0x72, 0x33, 0x2e, 0x53, 0x65, 0x71, 0x4e, 0x75, 0x6d, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52,
	0x0b, 0x73, 0x65, 0x71, 0x4e, 0x75, 0x6d, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x35, 0x0a, 0x0b,
	0x53, 0x65, 0x71, 0x4e, 0x75, 0x6d, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x73,
	...
	0x65, 0x6e, 0x64, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x63, 0x63, 0x69, 0x70, 0x6f, 0x63, 0x72,
	0x33, 0x3b, 0x63, 0x63, 0x69, 0x70, 0x6f, 0x63, 0x72, 0x33, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_models_proto_goTypes = []interface{}{
	...
	(*EVM2AnyRampMessage)(nil), // 2: loop.internal.pb.ccipocr3.EVM2AnyRampMessage
	(*Message)(nil),            // 3: loop.internal.pb.ccipocr3.Message
	(*BigInt)(nil),             // 4: loop.internal.pb.ccipocr3.BigInt
	(*TokenAmount)(nil),        // 5: loop.internal.pb.ccipocr3.TokenAmount
	(*CommitPluginReport)(nil), // 6: loop.internal.pb.ccipocr3.CommitPluginReport
	(*PriceUpdates)(nil),       // 7: loop.internal.pb.ccipocr3.PriceUpdates
	(*GasPriceChain)(nil),      // 8: loop.internal.pb.ccipocr3.GasPriceChain
	(*MerkleRootChain)(nil),    // 9: loop.internal.pb.ccipocr3.MerkleRootChain
	(*SeqNumRange)(nil),        // 10: loop.internal.pb.ccipocr3.SeqNumRange
}
var file_models_proto_depIdxs = []int32{
	4,  // 0: loop.internal.pb.ccipocr3.RampTokenAmount.amount:type_name -> loop.internal.pb.ccipocr3.BigInt
	4,  // 1: loop.internal.pb.ccipocr3.EVM2AnyRampMessage.fee_token_amount:type_name -> loop.internal.pb.ccipocr3.BigInt
	1,  // 2: loop.internal.pb.ccipocr3.EVM2AnyRampMessage.token_amounts:type_name -> loop.internal.pb.ccipocr3.RampTokenAmount
	0,  // 3: loop.internal.pb.ccipocr3.Message.header:type_name -> loop.internal.pb.ccipocr3.RampMessageHeader
	2,  // 4: loop.internal.pb.ccipocr3.Message.evm_2_any_ramp_message:type_name -> loop.internal.pb.ccipocr3.EVM2AnyRampMessage
	4,  // 5: loop.internal.pb.ccipocr3.TokenAmount.amount:type_name -> loop.internal.pb.ccipocr3.BigInt
	7,  // 6: loop.internal.pb.ccipocr3.CommitPluginReport.price_updates:type_name -> loop.internal.pb.ccipocr3.PriceUpdates
	9,  // 7: loop.internal.pb.ccipocr3.CommitPluginReport.merkle_roots:type_name -> loop.internal.pb.ccipocr3.MerkleRootChain
	5,  // 8: loop.internal.pb.ccipocr3.PriceUpdates.token_price_updates:type_name -> loop.internal.pb.ccipocr3.TokenAmount
	8,  // 9: loop.internal.pb.ccipocr3.PriceUpdates.gas_price_updates:type_name -> loop.internal.pb.ccipocr3.GasPriceChain
	4,  // 10: loop.internal.pb.ccipocr3.GasPriceChain.price:type_name -> loop.internal.pb.ccipocr3.BigInt
	10, // 11: loop.internal.pb.ccipocr3.MerkleRootChain.seq_num_range:type_name -> loop.internal.pb.ccipocr3.SeqNumRange
...
func file_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_models_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EVM2AnyRampMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_models_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Message_Evm_2AnyRampMessage)(nil),
	}
	type x struct{}
