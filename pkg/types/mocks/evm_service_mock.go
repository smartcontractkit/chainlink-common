...
func (_m *EVMService) BalanceAt(ctx context.Context, account string, blockNumber *big.Int) (*big.Int, error) {
	...
	var r0 *big.Int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *big.Int) (*big.Int, error)); ok {
		return rf(ctx, account, blockNumber)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *big.Int) *big.Int); ok {
...
func (_c *EVMService_BalanceAt_Call) Run(run func(ctx context.Context, account string, blockNumber *big.Int)) *EVMService_BalanceAt_Call {
...
func (_c *EVMService_BalanceAt_Call) RunAndReturn(run func(context.Context, string, *big.Int) (*big.Int, error)) *EVMService_BalanceAt_Call {
	_c.Call.Return(run)
	return _c
}

// CallContract provides a mock function with given fields: ctx, msg, confidence
func (_m *EVMService) CallContract(ctx context.Context, msg *evm.CallMsg, confidence primitives.ConfidenceLevel) ([]byte, error) {
	ret := _m.Called(ctx, msg, confidence)
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.CallMsg, primitives.ConfidenceLevel) ([]byte, error)); ok {
		return rf(ctx, msg, confidence)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *evm.CallMsg, primitives.ConfidenceLevel) []byte); ok {
		r0 = rf(ctx, msg, confidence)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *evm.CallMsg, primitives.ConfidenceLevel) error); ok {
		r1 = rf(ctx, msg, confidence)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *EVMService_Expecter) CallContract(ctx interface{}, msg interface{}, confidence interface{}) *EVMService_CallContract_Call {
	return &EVMService_CallContract_Call{Call: _e.mock.On("CallContract", ctx, msg, confidence)}
}

func (_c *EVMService_CallContract_Call) Run(run func(ctx context.Context, msg *evm.CallMsg, confidence primitives.ConfidenceLevel)) *EVMService_CallContract_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*evm.CallMsg), args[2].(primitives.ConfidenceLevel))
	})
	return _c
}
...
func (_c *EVMService_CallContract_Call) RunAndReturn(run func(context.Context, *evm.CallMsg, primitives.ConfidenceLevel) ([]byte, error)) *EVMService_CallContract_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetLogs provides a mock function with given fields: ctx, filterQuery
func (_m *EVMService) GetLogs(ctx context.Context, filterQuery evm.FilterQuery) ([]*evm.Log, error) {
...
// EVMService_GetLogs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLogs'
type EVMService_GetLogs_Call struct {
	*mock.Call
}
...
func (_e *EVMService_Expecter) GetLogs(ctx interface{}, filterQuery interface{}) *EVMService_GetLogs_Call {
	return &EVMService_GetLogs_Call{Call: _e.mock.On("GetLogs", ctx, filterQuery)}
}

func (_c *EVMService_GetLogs_Call) Run(run func(ctx context.Context, filterQuery evm.FilterQuery)) *EVMService_GetLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EVMService_GetLogs_Call) Return(_a0 []*evm.Log, _a1 error) *EVMService_GetLogs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EVMService_GetLogs_Call) RunAndReturn(run func(context.Context, evm.FilterQuery) ([]*evm.Log, error)) *EVMService_GetLogs_Call {
	_c.Call.Return(run)
	return _c
}

// GetTransactionFee provides a mock function with given fields: ctx, transactionID
func (_m *EVMService) GetTransactionFee(ctx context.Context, transactionID string) (*types.TransactionFee, error) {
...
func (_c *EVMService_GetTransactionFee_Call) Return(_a0 *types.TransactionFee, _a1 error) *EVMService_GetTransactionFee_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EVMService_GetTransactionFee_Call) RunAndReturn(run func(context.Context, string) (*types.TransactionFee, error)) *EVMService_GetTransactionFee_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EVMService) LatestAndFinalizedHead(ctx context.Context) (types.Head, types.Head, error) {
	ret := _m.Called(ctx)
...
func (_c *EVMService_LatestAndFinalizedHead_Call) Return(latest types.Head, finalized types.Head, err error) *EVMService_LatestAndFinalizedHead_Call {
	_c.Call.Return(latest, finalized, err)
	return _c
}

func (_c *EVMService_LatestAndFinalizedHead_Call) RunAndReturn(run func(context.Context) (types.Head, types.Head, error)) *EVMService_LatestAndFinalizedHead_Call {
	_c.Call.Return(run)
	return _c
}

// QueryLogsFromCache provides a mock function with given fields: ctx, filterQuery, limitAndSort, confidenceLevel
func (_m *EVMService) QueryLogsFromCache(ctx context.Context, filterQuery []query.Expression, limitAndSort query.LimitAndSort, confidenceLevel primitives.ConfidenceLevel) ([]*evm.Log, error) {
...
// EVMService_QueryLogsFromCache_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryLogsFromCache'
type EVMService_QueryLogsFromCache_Call struct {
	*mock.Call
}
...
func (_e *EVMService_Expecter) QueryLogsFromCache(ctx interface{}, filterQuery interface{}, limitAndSort interface{}, confidenceLevel interface{}) *EVMService_QueryLogsFromCache_Call {
	return &EVMService_QueryLogsFromCache_Call{Call: _e.mock.On("QueryLogsFromCache", ctx, filterQuery, limitAndSort, confidenceLevel)}
}

func (_c *EVMService_QueryLogsFromCache_Call) Run(run func(ctx context.Context, filterQuery []query.Expression, limitAndSort query.LimitAndSort, confidenceLevel primitives.ConfidenceLevel)) *EVMService_QueryLogsFromCache_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EVMService_QueryLogsFromCache_Call) Return(_a0 []*evm.Log, _a1 error) *EVMService_QueryLogsFromCache_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EVMService_QueryLogsFromCache_Call) RunAndReturn(run func(context.Context, []query.Expression, query.LimitAndSort, primitives.ConfidenceLevel) ([]*evm.Log, error)) *EVMService_QueryLogsFromCache_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EVMService) TransactionByHash(ctx context.Context, hash string) (*evm.Transaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*evm.Transaction, error)); ok {
		return rf(ctx, hash)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *evm.Transaction); ok {
		r0 = rf(ctx, hash)
	} else {
		if ret.Get(0) != nil {
...
func (_c *EVMService_TransactionByHash_Call) Run(run func(ctx context.Context, hash string)) *EVMService_TransactionByHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *EVMService_TransactionByHash_Call) RunAndReturn(run func(context.Context, string) (*evm.Transaction, error)) *EVMService_TransactionByHash_Call {
	_c.Call.Return(run)
	return _c
}

// TransactionReceipt provides a mock function with given fields: ctx, txHash
func (_m *EVMService) TransactionReceipt(ctx context.Context, txHash string) (*evm.Receipt, error) {
	...
	var r0 *evm.Receipt
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*evm.Receipt, error)); ok {
		return rf(ctx, txHash)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *evm.Receipt); ok {
		r0 = rf(ctx, txHash)
	} else {
		if ret.Get(0) != nil {
...
func (_c *EVMService_TransactionReceipt_Call) Run(run func(ctx context.Context, txHash string)) *EVMService_TransactionReceipt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *EVMService_TransactionReceipt_Call) RunAndReturn(run func(context.Context, string) (*evm.Receipt, error)) *EVMService_TransactionReceipt_Call {
	_c.Call.Return(run)
	return _c
}
