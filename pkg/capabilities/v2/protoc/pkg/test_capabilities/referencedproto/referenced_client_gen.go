...
func (c *BasicAction) PerformAction(runtime sdk.DonRuntime, input *basicaction.Inputs) sdk.Promise[*basicaction.Outputs] {
	wrapped, err := anypb.New(input)
	if err != nil {
		return sdk.PromiseFromResult[*basicaction.Outputs](nil, err)
	}
	return sdk.Then(runtime.CallCapability(&pb.CapabilityRequest{
		Id:      "basic-test-action@1.0.0",
		Payload: wrapped,
		Method:  "PerformAction",
	}), func(i *pb.CapabilityResponse) (*basicaction.Outputs, error) {
