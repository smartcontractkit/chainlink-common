...
type EncoderConfigCap interface {
	sdk.CapDefinition[EncoderConfig]
	Abi() sdk.CapDefinition[string]
	private()
}

// EncoderConfigCapFromStep should only be called from generated code to assure type safety
func EncoderConfigCapFromStep(w *sdk.WorkflowSpecFactory, step sdk.Step[EncoderConfig]) EncoderConfigCap {
	raw := step.AddTo(w)
...
func (c *encoderConfig) Abi() sdk.CapDefinition[string] {
...
func NewEncoderConfigFromFields(
	...
	return &simpleEncoderConfig{
		CapDefinition: sdk.ComponentCapDefinition[EncoderConfig]{
			"abi": abi.Ref(),
		},
		abi: abi,
	}
...
func (c *simpleEncoderConfig) Abi() sdk.CapDefinition[string] {
	return c.abi
}
