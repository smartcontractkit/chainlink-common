...
func (cr *capabilitiesRegistryClient) Get(ctx context.Context, ID string) (capabilities.BaseCapability, error) {
	...
	if err != nil {
		return nil, network.ErrConnDial{Name: "Capability", ID: res.CapabilityID, Err: err}
	}
...
func (cr *capabilitiesRegistryClient) GetTrigger(ctx context.Context, ID string) (capabilities.TriggerCapability, error) {
	...
	conn, err := cr.Dial(res.CapabilityID)
	if err != nil {
		return nil, network.ErrConnDial{Name: "GetTrigger", ID: res.CapabilityID, Err: err}
	}
...
func (cr *capabilitiesRegistryClient) GetAction(ctx context.Context, ID string) (capabilities.ActionCapability, error) {
	...
	conn, err := cr.Dial(res.CapabilityID)
	if err != nil {
		return nil, network.ErrConnDial{Name: "GetAction", ID: res.CapabilityID, Err: err}
	}
...
func (cr *capabilitiesRegistryClient) GetConsensus(ctx context.Context, ID string) (capabilities.ConsensusCapability, error) {
	...
	conn, err := cr.Dial(res.CapabilityID)
	if err != nil {
		return nil, network.ErrConnDial{Name: "GetConsensus", ID: res.CapabilityID, Err: err}
	}
...
func (cr *capabilitiesRegistryClient) GetTarget(ctx context.Context, ID string) (capabilities.TargetCapability, error) {
	...
	conn, err := cr.Dial(res.CapabilityID)
	if err != nil {
		return nil, network.ErrConnDial{Name: "GetTarget", ID: res.CapabilityID, Err: err}
	}
...
func (cr *capabilitiesRegistryClient) List(ctx context.Context) ([]capabilities.BaseCapability, error) {
	...
	for _, id := range res.CapabilityID {
		conn, err := cr.Dial(id)
		if err != nil {
			return nil, network.ErrConnDial{Name: "List", ID: id, Err: err}
		}
		client := newBaseCapabilityClient(cr.BrokerExt, conn)
...
func NewCapabilitiesRegistryClient(cc grpc.ClientConnInterface, b *network.BrokerExt) *capabilitiesRegistryClient {
...
func (c *capabilitiesRegistryServer) List(ctx context.Context, _ *emptypb.Empty) (*pb.ListReply, error) {
	...
	var resources []network.Resource
...
func (c *capabilitiesRegistryServer) Add(ctx context.Context, request *pb.AddRequest) (*emptypb.Empty, error) {
	...
	if err != nil {
		return &emptypb.Empty{}, network.ErrConnDial{Name: "Add", ID: request.CapabilityID, Err: err}
	}
...
func NewCapabilitiesRegistryServer(b *network.BrokerExt, i types.CapabilitiesRegistry) *capabilitiesRegistryServer {
...
func pbRegisterCapability(s *grpc.Server, b *network.BrokerExt, impl capabilities.BaseCapability, t capabilities.CapabilityType) {
	switch t {
	case capabilities.CapabilityTypeTrigger:
