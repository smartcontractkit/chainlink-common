...
const file_billing_pb_billing_service_proto_rawDesc = "" +
	"\n" +
	" billing/pb/billing_service.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\"capabilities/pb/capabilities.proto\x1a\x1ametering/pb/metering.proto\"\x0e\n" +
	"\fEmptyRequest\")\n" +
	...
	"\acredits\x18\x02 \x03(\v2\x17.pb.AccountCreditsInputR\acredits\"3\n" +
	...
	"\acredits\x18\x02 \x03(\v2\x12.pb.AccountCreditsR\acredits\"D\n" +
	"!BatchGetCreditsForAccountsRequest\x12\x1f\n" +
	"\vaccount_ids\x18\x01 \x03(\tR\n" +
	"accountIds\"X\n" +
	"\"BatchGetCreditsForAccountsResponse\x122\n" +
	"\baccounts\x18\x01 \x03(\v2\x16.pb.AccountWithCreditsR\baccounts\"\xec\x01\n" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12,\n" +
	"\acredits\x18\x02 \x03(\v2\x12.pb.AccountCreditsR\acredits\"\xbe\x01\n" +
	"\x15ReserveCreditsRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12\x1f\n" +
	"\vworkflow_id\x18\x02 \x01(\tR\n" +
	"workflowId\x122\n" +
	"\x15workflow_execution_id\x18\x03 \x01(\tR\x13workflowExecutionId\x121\n" +
	"\acredits\x18\x04 \x03(\v2\x17.pb.AccountCreditsInputR\acredits\"2\n" +
	...
	"\vworkflow_id\x18\x02 \x01(\tR\n" +
	"workflowId\x121\n" +
	"\acredits\x18\x03 \x03(\v2\x17.pb.AccountCreditsInputR\acredits\"2\n" +
	...
	"\x11GetAccountCredits\x12\x1c.pb.GetAccountCreditsRequest\x1a\x1d.pb.GetAccountCreditsResponse\x12J\n" +
	"\x0fAllocateCredits\x12\x1a.pb.AllocateCreditsRequest\x1a\x1b.pb.AllocateCreditsResponse\x12>\n" +
	"\vBillAccount\x12\x16.pb.BillAccountRequest\x1a\x17.pb.BillAccountResponse2\xe4\x04\n" +
	"\x0fWorkflowService\x12P\n" +
	"\x11GetAccountCredits\x12\x1c.pb.GetAccountCreditsRequest\x1a\x1d.pb.GetAccountCreditsResponse\x12k\n" +
	"\x1aBatchGetCreditsForAccounts\x12%.pb.BatchGetCreditsForAccountsRequest\x1a&.pb.BatchGetCreditsForAccountsResponse\x12G\n" +
	"\x0eReserveCredits\x12\x19.pb.ReserveCreditsRequest\x1a\x1a.pb.ReserveCreditsResponse\x12S\n" +
	"\x12ReleaseReservation\x12\x1d.pb.ReleaseReservationRequest\x1a\x1e.pb.ReleaseReservationResponse\x12G\n" +
	"\x0eConsumeCredits\x12\x19.pb.ConsumeCreditsRequest\x1a\x1a.pb.ConsumeCreditsResponse\x12S\n" +
	"\x12ConsumeReservation\x12\x1d.pb.ConsumeReservationRequest\x1a\x1e.pb.ConsumeReservationResponse\x12V\n" +
	"\x0fWorkflowReceipt\x12 .pb.SubmitWorkflowReceiptRequest\x1a!.pb.SubmitWorkflowReceiptResponseB\x06Z\x04./pbb\x06proto3"
...
var file_billing_pb_billing_service_proto_goTypes = []any{
	...
	(*AccountCreditsInput)(nil),                // 2: pb.AccountCreditsInput
	(*AllocateCreditsRequest)(nil),             // 3: pb.AllocateCreditsRequest
	(*AllocateCreditsResponse)(nil),            // 4: pb.AllocateCreditsResponse
	(*BillAccountRequest)(nil),                 // 5: pb.BillAccountRequest
	(*BillAccountResponse)(nil),                // 6: pb.BillAccountResponse
	(*GetAccountCreditsRequest)(nil),           // 7: pb.GetAccountCreditsRequest
	(*GetAccountCreditsResponse)(nil),          // 8: pb.GetAccountCreditsResponse
	(*BatchGetCreditsForAccountsRequest)(nil),  // 9: pb.BatchGetCreditsForAccountsRequest
	(*BatchGetCreditsForAccountsResponse)(nil), // 10: pb.BatchGetCreditsForAccountsResponse
	(*AccountCredits)(nil),                     // 11: pb.AccountCredits
	(*AccountWithCredits)(nil),                 // 12: pb.AccountWithCredits
	(*ReserveCreditsRequest)(nil),              // 13: pb.ReserveCreditsRequest
	(*ReserveCreditsResponse)(nil),             // 14: pb.ReserveCreditsResponse
	(*ReleaseReservationRequest)(nil),          // 15: pb.ReleaseReservationRequest
	(*ReleaseReservationResponse)(nil),         // 16: pb.ReleaseReservationResponse
	(*ConsumeCreditsRequest)(nil),              // 17: pb.ConsumeCreditsRequest
	(*ConsumeCreditsResponse)(nil),             // 18: pb.ConsumeCreditsResponse
	(*ConsumeReservationRequest)(nil),          // 19: pb.ConsumeReservationRequest
	(*ConsumeReservationResponse)(nil),         // 20: pb.ConsumeReservationResponse
	(*SubmitWorkflowReceiptRequest)(nil),       // 21: pb.SubmitWorkflowReceiptRequest
	(*SubmitWorkflowReceiptResponse)(nil),      // 22: pb.SubmitWorkflowReceiptResponse
	(*timestamppb.Timestamp)(nil),              // 23: google.protobuf.Timestamp
	(*pb.MeteringReport)(nil),                  // 24: metering.MeteringReport
}
var file_billing_pb_billing_service_proto_depIdxs = []int32{
	2,  // 0: pb.AllocateCreditsRequest.credits:type_name -> pb.AccountCreditsInput
	11, // 1: pb.GetAccountCreditsResponse.credits:type_name -> pb.AccountCredits
	12, // 2: pb.BatchGetCreditsForAccountsResponse.accounts:type_name -> pb.AccountWithCredits
	23, // 3: pb.AccountCredits.created_at:type_name -> google.protobuf.Timestamp
	23, // 4: pb.AccountCredits.updated_at:type_name -> google.protobuf.Timestamp
	11, // 5: pb.AccountWithCredits.credits:type_name -> pb.AccountCredits
	2,  // 6: pb.ReserveCreditsRequest.credits:type_name -> pb.AccountCreditsInput
	2,  // 7: pb.ConsumeCreditsRequest.credits:type_name -> pb.AccountCreditsInput
	24, // 8: pb.SubmitWorkflowReceiptRequest.metering:type_name -> metering.MeteringReport
	7,  // 9: pb.SubscriptionService.GetAccountCredits:input_type -> pb.GetAccountCreditsRequest
	3,  // 10: pb.SubscriptionService.AllocateCredits:input_type -> pb.AllocateCreditsRequest
	5,  // 11: pb.SubscriptionService.BillAccount:input_type -> pb.BillAccountRequest
	7,  // 12: pb.WorkflowService.GetAccountCredits:input_type -> pb.GetAccountCreditsRequest
	9,  // 13: pb.WorkflowService.BatchGetCreditsForAccounts:input_type -> pb.BatchGetCreditsForAccountsRequest
	13, // 14: pb.WorkflowService.ReserveCredits:input_type -> pb.ReserveCreditsRequest
	15, // 15: pb.WorkflowService.ReleaseReservation:input_type -> pb.ReleaseReservationRequest
	17, // 16: pb.WorkflowService.ConsumeCredits:input_type -> pb.ConsumeCreditsRequest
	19, // 17: pb.WorkflowService.ConsumeReservation:input_type -> pb.ConsumeReservationRequest
	21, // 18: pb.WorkflowService.WorkflowReceipt:input_type -> pb.SubmitWorkflowReceiptRequest
	8,  // 19: pb.SubscriptionService.GetAccountCredits:output_type -> pb.GetAccountCreditsResponse
	4,  // 20: pb.SubscriptionService.AllocateCredits:output_type -> pb.AllocateCreditsResponse
	6,  // 21: pb.SubscriptionService.BillAccount:output_type -> pb.BillAccountResponse
	8,  // 22: pb.WorkflowService.GetAccountCredits:output_type -> pb.GetAccountCreditsResponse
	10, // 23: pb.WorkflowService.BatchGetCreditsForAccounts:output_type -> pb.BatchGetCreditsForAccountsResponse
	14, // 24: pb.WorkflowService.ReserveCredits:output_type -> pb.ReserveCreditsResponse
	16, // 25: pb.WorkflowService.ReleaseReservation:output_type -> pb.ReleaseReservationResponse
	18, // 26: pb.WorkflowService.ConsumeCredits:output_type -> pb.ConsumeCreditsResponse
	20, // 27: pb.WorkflowService.ConsumeReservation:output_type -> pb.ConsumeReservationResponse
	22, // 28: pb.WorkflowService.WorkflowReceipt:output_type -> pb.SubmitWorkflowReceiptResponse
