...
func (_m *GatewayConnector) SendToGateway(ctx context.Context, gatewayID string, resp *jsonrpc2.Response[jsontext.Value]) error {
...
func (_c *GatewayConnector_SendToGateway_Call) Run(run func(ctx context.Context, gatewayID string, resp *jsonrpc2.Response[jsontext.Value])) *GatewayConnector_SendToGateway_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GatewayConnector_SendToGateway_Call) RunAndReturn(run func(context.Context, string, *jsonrpc2.Response[jsontext.Value]) error) *GatewayConnector_SendToGateway_Call {
	_c.Call.Return(run)
	return _c
}
