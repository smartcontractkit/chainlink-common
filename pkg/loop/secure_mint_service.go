...
type PluginSecureMintService struct {
	goplugin.PluginService[*GRPCPluginSecureMint, core.ReportingPluginFactory[sm.ChainSelector]]
}

var _ ocr3types.ReportingPluginFactory[sm.ChainSelector] = (*PluginSecureMintService)(nil)
...
func NewPluginSecureMintService(lggr logger.Logger, grpcOpts GRPCOpts, cmd func() *exec.Cmd, externalAdapter sm.ExternalAdapter) *PluginSecureMintService {
	newService := func(ctx context.Context, instance any) (core.ReportingPluginFactory[sm.ChainSelector], services.HealthReporter, error) {
...
func (m *PluginSecureMintService) NewReportingPlugin(ctx context.Context, config ocr3types.ReportingPluginConfig) (ocr3types.ReportingPlugin[sm.ChainSelector], ocr3types.ReportingPluginInfo, error) {
