...
func file_datasource_v3_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datasource_v3_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_datasource_v3_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
		...
		file_datasource_v3_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_datasource_v3_proto_msgTypes[3].Exporter = func(v any, i int) any {
