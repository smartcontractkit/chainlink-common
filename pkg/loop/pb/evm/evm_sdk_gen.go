...
func (c *EVM) GetTransactionStatus(runtime sdk.DonRuntime, input *GetTransactionStatusRequest) sdk.Promise[*GetTransactionStatusReply] {
	wrapped, err := anypb.New(input)
	if err != nil {
		return sdk.PromiseFromResult[*GetTransactionStatusReply](nil, err)
	}
	return sdk.Then(runtime.CallCapability(&pb.CapabilityRequest{
		Id:      "mainnet-evm@1.0.0",
		Payload: wrapped,
		Method:  "GetTransactionStatus",
	}), func(i *pb.CapabilityResponse) (*GetTransactionStatusReply, error) {
		switch payload := i.Response.(type) {
		case *pb.CapabilityResponse_Error:
			return nil, errors.New(payload.Error)
		case *pb.CapabilityResponse_Payload:
			output := &GetTransactionStatusReply{}
			err = payload.Payload.UnmarshalTo(output)
			return output, err
		default:
			return nil, errors.New("unexpected response type")
