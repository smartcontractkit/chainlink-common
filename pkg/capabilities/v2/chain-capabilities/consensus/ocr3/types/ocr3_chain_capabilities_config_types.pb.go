...
type ReportingPluginConfig struct {
	...
	// when turned on, chain cap consensus rounds will include outcomes
	// for missingRequestIds missed by leader and agreed upon by rest of the DON
	EnableMissingRequestRecovery bool `protobuf:"varint,8,opt,name=enableMissingRequestRecovery,proto3" json:"enableMissingRequestRecovery,omitempty"`
...
func (x *ReportingPluginConfig) GetEnableMissingRequestRecovery() bool {
	if x != nil {
...
const file_ocr3_chain_capabilities_config_types_proto_rawDesc = "" +
	"\n" +
	"*ocr3_chain_capabilities_config_types.proto\x12$chain_capabilities_ocr3_config_types\"\xbb\x03\n" +
	...
	"\x17minResponsesToAggregate\x18\a \x01(\rR\x17minResponsesToAggregate\x12B\n" +
	"\x1cenableMissingRequestRecovery\x18\b \x01(\bR\x1cenableMissingRequestRecoveryB9Z7capabilities/v2/chain-capabilities/consensus/ocr3/typesb\x06proto3"
