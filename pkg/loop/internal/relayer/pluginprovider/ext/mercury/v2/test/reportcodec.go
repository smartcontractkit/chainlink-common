...
func (s staticReportCodec) BuildReport(ctx context.Context, fields mercury_v2_types.ReportFields) (types.Report, error) {
...
func (s staticReportCodec) ObservationTimestampFromReport(context.Context, types.Report) (uint32, error) {
