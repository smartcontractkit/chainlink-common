...
func (_m *ContractReader) GetLatestValueWithHeadData(ctx context.Context, readIdentifier string, confidenceLevel primitives.ConfidenceLevel, params interface{}, returnVal interface{}) (*types.Head, error) {
	...
	var r0 *types.Head
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, primitives.ConfidenceLevel, interface{}, interface{}) (*types.Head, error)); ok {
		return rf(ctx, readIdentifier, confidenceLevel, params, returnVal)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, primitives.ConfidenceLevel, interface{}, interface{}) *types.Head); ok {
		r0 = rf(ctx, readIdentifier, confidenceLevel, params, returnVal)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, primitives.ConfidenceLevel, interface{}, interface{}) error); ok {
		r1 = rf(ctx, readIdentifier, confidenceLevel, params, returnVal)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *ContractReader_Expecter) GetLatestValueWithHeadData(ctx interface{}, readIdentifier interface{}, confidenceLevel interface{}, params interface{}, returnVal interface{}) *ContractReader_GetLatestValueWithHeadData_Call {
	return &ContractReader_GetLatestValueWithHeadData_Call{Call: _e.mock.On("GetLatestValueWithHeadData", ctx, readIdentifier, confidenceLevel, params, returnVal)}
}
...
func (_m *ContractReader) QueryKeys(ctx context.Context, filters []types.ContractKeyFilter, limitAndSort query.LimitAndSort) (iter.Seq2[string, types.Sequence], error) {
	ret := _m.Called(ctx, filters, limitAndSort)

	if len(ret) == 0 {
		panic("no return value specified for QueryKeys")
	}

	var r0 iter.Seq2[string, types.Sequence]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []types.ContractKeyFilter, query.LimitAndSort) (iter.Seq2[string, types.Sequence], error)); ok {
		return rf(ctx, filters, limitAndSort)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []types.ContractKeyFilter, query.LimitAndSort) iter.Seq2[string, types.Sequence]); ok {
		r0 = rf(ctx, filters, limitAndSort)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[string, types.Sequence])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, []types.ContractKeyFilter, query.LimitAndSort) error); ok {
		r1 = rf(ctx, filters, limitAndSort)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *ContractReader_Expecter) QueryKeys(ctx interface{}, filters interface{}, limitAndSort interface{}) *ContractReader_QueryKeys_Call {
	return &ContractReader_QueryKeys_Call{Call: _e.mock.On("QueryKeys", ctx, filters, limitAndSort)}
}
...
func (_c *ContractReader_QueryKeys_Call) Run(run func(ctx context.Context, filters []types.ContractKeyFilter, limitAndSort query.LimitAndSort)) *ContractReader_QueryKeys_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]types.ContractKeyFilter), args[2].(query.LimitAndSort))
	})
	return _c
}
...
// mustEmbedUnimplementedContractReader provides a mock function with no fields
func (_m *ContractReader) mustEmbedUnimplementedContractReader() {
	_m.Called()
}
...
// mustEmbedUnimplementedContractReader is a helper method to define mock.On call
func (_e *ContractReader_Expecter) mustEmbedUnimplementedContractReader() *ContractReader_mustEmbedUnimplementedContractReader_Call {
	return &ContractReader_mustEmbedUnimplementedContractReader_Call{Call: _e.mock.On("mustEmbedUnimplementedContractReader")}
}
