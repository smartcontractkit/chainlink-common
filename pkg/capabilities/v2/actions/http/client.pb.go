...
const file_capabilities_networking_http_v1alpha_client_proto_rawDesc = "" +
	"\n" +
	"1capabilities/networking/http/v1alpha/client.proto\x12$capabilities.networking.http.v1alpha\x1a\x1egoogle/protobuf/duration.proto\x1a)tools/generator/v1beta/cre_metadata.proto\"Y\n" +
	...
	"\x06Client\x12l\n" +
	"\vSendRequest\x12-.capabilities.networking.http.v1alpha.Request\x1a..capabilities.networking.http.v1alpha.Response\x1a \x92\xb5\x18\x1c\b\x02\x12\x18http-actions@1.0.0-alphab\x06proto3"
