...
func (_m *EVMService) GetForwarderForEOA(ctx context.Context, eoa [20]byte) ([20]byte, error) {
	...
	var r0 [20]byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, [20]byte) ([20]byte, error)); ok {
		return rf(ctx, eoa)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [20]byte) [20]byte); ok {
		r0 = rf(ctx, eoa)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, [20]byte) error); ok {
		r1 = rf(ctx, eoa)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - eoa [20]byte
func (_e *EVMService_Expecter) GetForwarderForEOA(ctx interface{}, eoa interface{}) *EVMService_GetForwarderForEOA_Call {
	return &EVMService_GetForwarderForEOA_Call{Call: _e.mock.On("GetForwarderForEOA", ctx, eoa)}
}

func (_c *EVMService_GetForwarderForEOA_Call) Run(run func(ctx context.Context, eoa [20]byte)) *EVMService_GetForwarderForEOA_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([20]byte))
	})
	return _c
}
...
func (_c *EVMService_GetForwarderForEOA_Call) RunAndReturn(run func(context.Context, [20]byte) ([20]byte, error)) *EVMService_GetForwarderForEOA_Call {
	_c.Call.Return(run)
	return _c
}

// GetForwarderForEOAOCR2Feeds provides a mock function with given fields: ctx, eoa, ocr2AggregatorID
func (_m *EVMService) GetForwarderForEOAOCR2Feeds(ctx context.Context, eoa [20]byte, ocr2AggregatorID [20]byte) ([20]byte, error) {
	...
	var r0 [20]byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, [20]byte, [20]byte) ([20]byte, error)); ok {
		return rf(ctx, eoa, ocr2AggregatorID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [20]byte, [20]byte) [20]byte); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, [20]byte, [20]byte) error); ok {
...
// EVMService_GetForwarderForEOAOCR2Feeds_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetForwarderForEOAOCR2Feeds'
type EVMService_GetForwarderForEOAOCR2Feeds_Call struct {
	*mock.Call
}
...
func (_e *EVMService_Expecter) GetForwarderForEOAOCR2Feeds(ctx interface{}, eoa interface{}, ocr2AggregatorID interface{}) *EVMService_GetForwarderForEOAOCR2Feeds_Call {
	return &EVMService_GetForwarderForEOAOCR2Feeds_Call{Call: _e.mock.On("GetForwarderForEOAOCR2Feeds", ctx, eoa, ocr2AggregatorID)}
}

func (_c *EVMService_GetForwarderForEOAOCR2Feeds_Call) Run(run func(ctx context.Context, eoa [20]byte, ocr2AggregatorID [20]byte)) *EVMService_GetForwarderForEOAOCR2Feeds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([20]byte), args[2].([20]byte))
	})
	return _c
}

func (_c *EVMService_GetForwarderForEOAOCR2Feeds_Call) Return(forwarder [20]byte, err error) *EVMService_GetForwarderForEOAOCR2Feeds_Call {
	_c.Call.Return(forwarder, err)
	return _c
}

func (_c *EVMService_GetForwarderForEOAOCR2Feeds_Call) RunAndReturn(run func(context.Context, [20]byte, [20]byte) ([20]byte, error)) *EVMService_GetForwarderForEOAOCR2Feeds_Call {
	_c.Call.Return(run)
	return _c
}
