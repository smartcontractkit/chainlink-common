...
// Keystore holds a list of keys per type.
...
type Keystore struct {
	...
	Ed25519Keys   []*Ed25519Key   `protobuf:"bytes,1,rep,name=ed25519_keys,json=ed25519Keys,proto3" json:"ed25519_keys,omitempty"`
	Secp256K1Keys []*Secp256K1Key `protobuf:"bytes,2,rep,name=secp256k1_keys,json=secp256k1Keys,proto3" json:"secp256k1_keys,omitempty"`
}
...
func (x *Keystore) GetEd25519Keys() []*Ed25519Key {
	if x != nil {
		return x.Ed25519Keys
	}
	return nil
}

func (x *Keystore) GetSecp256K1Keys() []*Secp256K1Key {
	if x != nil {
		return x.Secp256K1Keys
	}
	return nil
}
...
func (x *Ed25519Key) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Ed25519Key) GetPrivateKey() []byte {
	if x != nil {
		return x.PrivateKey
	}
	return nil
...
func (x *Ed25519Key) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *Secp256K1Key) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Secp256K1Key) ProtoMessage() {}

func (x *Secp256K1Key) ProtoReflect() protoreflect.Message {
	mi := &file_keystore_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Secp256K1Key.ProtoReflect.Descriptor instead.
func (*Secp256K1Key) Descriptor() ([]byte, []int) {
	return file_keystore_proto_rawDescGZIP(), []int{2}
}

func (x *Secp256K1Key) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Secp256K1Key) GetPrivateKey() []byte {
	if x != nil {
		return x.PrivateKey
	}
	return nil
...
func (x *Secp256K1Key) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
var file_keystore_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x62, 0x0a, 0x0c, 0x53, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x4b, 0x65, 0x79,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f,
	0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70, 0x72, 0x69, 0x76, 0x61,
	0x74, 0x65, 0x4b, 0x65, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	0x5f, 0x61, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x64, 0x41, 0x74, 0x42, 0x12, 0x5a, 0x10, 0x2e, 0x2f, 0x3b, 0x73, 0x65, 0x72, 0x69, 0x61,
...
var file_keystore_proto_goTypes = []interface{}{
	...
	(*Ed25519Key)(nil),   // 1: serialization.Ed25519Key
	(*Secp256K1Key)(nil), // 2: serialization.Secp256k1Key
}
var file_keystore_proto_depIdxs = []int32{
	1, // 0: serialization.Keystore.ed25519_keys:type_name -> serialization.Ed25519Key
	2, // 1: serialization.Keystore.secp256k1_keys:type_name -> serialization.Secp256k1Key
