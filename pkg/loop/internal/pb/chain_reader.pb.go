...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0xbc, 0x01, 0x0a, 0x1b, 0x42, 0x61,
	...
	0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x65, 0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3d, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,  0x22, 0x54, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4b,
...
var file_chain_reader_proto_depIdxs = []int32{
	...
	28, // 1: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	14, // 2: loop.QueryKeyRequest.filter:type_name -> loop.QueryKeyFilter
	27, // 3: loop.QueryKeyRequest.limit_and_sort:type_name -> loop.LimitAndSort
	13, // 4: loop.BindRequest.bindings:type_name -> loop.BoundContract
	28, // 5: loop.GetLatestValueReply.ret_val:type_name -> loop.VersionedBytes
	12, // 6: loop.QueryKeyReply.sequences:type_name -> loop.Sequence
	11, // 7: loop.Sequence.head:type_name -> loop.Head
	28, // 8: loop.Sequence.data:type_name -> loop.VersionedBytes
	15, // 9: loop.QueryKeyFilter.expression:type_name -> loop.Expression
	24, // 10: loop.Expression.primitive:type_name -> loop.Primitive
	16, // 11: loop.Expression.boolean_expression:type_name -> loop.BooleanExpression
	1,  // 12: loop.BooleanExpression.boolean_operator:type_name -> loop.BooleanOperator
	15, // 13: loop.BooleanExpression.expression:type_name -> loop.Expression
	15, // 14: loop.And.expr:type_name -> loop.Expression
	15, // 15: loop.Or.expr:type_name -> loop.Expression
	0,  // 16: loop.ValueComparator.operator:type_name -> loop.ComparisonOperator
	19, // 17: loop.Comparator.value_comparators:type_name -> loop.ValueComparator
	0,  // 18: loop.Block.operator:type_name -> loop.ComparisonOperator
	0,  // 19: loop.Timestamp.operator:type_name -> loop.ComparisonOperator
	20, // 20: loop.Primitive.comparator:type_name -> loop.Comparator
	21, // 21: loop.Primitive.block:type_name -> loop.Block
	2,  // 22: loop.Primitive.confidence:type_name -> loop.Confidence
	...
	5,  // 26: loop.SortBy.sort_type:type_name -> loop.SortType
	4,  // 27: loop.SortBy.direction:type_name -> loop.SortDirection
	26, // 28: loop.LimitAndSort.sort_by:type_name -> loop.SortBy
	25, // 29: loop.LimitAndSort.limit:type_name -> loop.Limit
	6,  // 30: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	7,  // 31: loop.ChainReader.QueryKey:input_type -> loop.QueryKeyRequest
	8,  // 32: loop.ChainReader.Bind:input_type -> loop.BindRequest
	9,  // 33: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	10, // 34: loop.ChainReader.QueryKey:output_type -> loop.QueryKeyReply
	29, // 35: loop.ChainReader.Bind:output_type -> google.protobuf.Empty
