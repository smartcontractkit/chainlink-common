...
type ChainReaderEnabledReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ChainReaderEnabledReply) Reset() {
	*x = ChainReaderEnabledReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChainReaderEnabledReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChainReaderEnabledReply) ProtoMessage() {}

func (x *ChainReaderEnabledReply) ProtoReflect() protoreflect.Message {
	mi := &file_chain_reader_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChainReaderEnabledReply.ProtoReflect.Descriptor instead.
func (*ChainReaderEnabledReply) Descriptor() ([]byte, []int) {
	return file_chain_reader_proto_rawDescGZIP(), []int{3}
}

func (x *ChainReaderEnabledReply) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x62, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x6f, 0x6f,
	0x70, 0x2e, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x52,
	0x02, 0x62, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x02, 0x20,
	...
	0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x43, 0x0a, 0x13, 0x47, 0x65, 0x74,
	0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x12, 0x2c, 0x0a, 0x06, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x14, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x65,
	0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x52, 0x06, 0x72, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x22, 0x57,
	...
	,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x43, 0x5a, 0x41,
...
var file_chain_reader_proto_goTypes = []interface{}{
	...
	(*BoundContract)(nil),           // 2: loop.BoundContract
	(*ChainReaderEnabledReply)(nil), // 3: loop.ChainReaderEnabledReply
	(*VersionedBytes)(nil),          // 4: loop.VersionedBytes
	(*emptypb.Empty)(nil),           // 5: google.protobuf.Empty
}
var file_chain_reader_proto_depIdxs = []int32{
	2, // 0: loop.GetLatestValueRequest.bc:type_name -> loop.BoundContract
	4, // 1: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	4, // 2: loop.GetLatestValueReply.retVal:type_name -> loop.VersionedBytes
	5, // 3: loop.ChainReader.Enabled:input_type -> google.protobuf.Empty
	0, // 4: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	3, // 5: loop.ChainReader.Enabled:output_type -> loop.ChainReaderEnabledReply
	1, // 6: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
...
func file_chain_reader_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chain_reader_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChainReaderEnabledReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
