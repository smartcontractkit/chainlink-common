...
type CallMsg struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	From          []byte                 `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"` // sender address, important for reads relied on msg.sender
	To            []byte                 `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`     // contract address
	Data          []byte                 `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"` // abi encoded payload
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_capabilities_v2_chain_capabilities_evm_chain_service_evm_proto_rawDesc = "" +
	...
	"\tGasConfig\x12\x1b\n" +
	"\tgas_limit\x18\x01 \x01(\x04R\bgasLimit\"\xba\x01\n" +
	"\x12WriteReportRequest\x12\x1a\n" +
	"\breceiver\x18\x01 \x01(\fR\breceiver\x12A\n" +
	"\x06report\x18\x02 \x01(\v2).loop.chain_capabilities.evm.SignedReportR\x06report\x12E\n" +
	"\n" +
	"gas_config\x18\x03 \x01(\v2&.loop.chain_capabilities.evm.GasConfigR\tgasConfig\"\xbd\x02\n" +
	"\x10WriteReportReply\x12K\n" +
	"\ttx_status\x18\x01 \x01(\x0e2..loop.chain_capabilities.evm.TransactionStatusR\btxStatus\x12\x89\x01\n" +
	"\"receiver_contract_execution_status\x18\x02 \x01(\x0e2<.loop.chain_capabilities.evm.ReceiverContractExecutionStatusR\x1freceiverContractExecutionStatus\x12\x17\n" +
	"\atx_hash\x18\x03 \x01(\fR\x06txHash\x127\n" +
	...
	"\n" +
	"ABIPayload\x12\x10\n" +
	"\x03abi\x18\x01 \x01(\fR\x03abi\"A\n" +
	"\aCallMsg\x12\x12\n" +
	...
	"\x04logs\x18\x01 \x03(\v2 .loop.chain_capabilities.evm.LogR\x04logs\"_\n" +
	...
	"\x04logs\x18\x01 \x03(\v2 .loop.chain_capabilities.evm.LogR\x04logs\"D\n" +
	...
	"\x18TRANSACTION_STATUS_FATAL\x10\x022\x85\v\n" +
	"\x03EVM\x12\x81\x01\n" +
...
var file_capabilities_v2_chain_capabilities_evm_chain_service_evm_proto_depIdxs = []int32{
	2,  // 0: loop.chain_capabilities.evm.WriteReportRequest.report:type_name -> loop.chain_capabilities.evm.SignedReport
	3,  // 1: loop.chain_capabilities.evm.WriteReportRequest.gas_config:type_name -> loop.chain_capabilities.evm.GasConfig
	1,  // 2: loop.chain_capabilities.evm.WriteReportReply.tx_status:type_name -> loop.chain_capabilities.evm.TransactionStatus
	0,  // 3: loop.chain_capabilities.evm.WriteReportReply.receiver_contract_execution_status:type_name -> loop.chain_capabilities.evm.ReceiverContractExecutionStatus
	48, // 4: loop.chain_capabilities.evm.WriteReportReply.transaction_fee:type_name -> values.BigInt
	7,  // 5: loop.chain_capabilities.evm.Topics.topic:type_name -> loop.chain_capabilities.evm.Hash
	6,  // 6: loop.chain_capabilities.evm.Log.address:type_name -> loop.chain_capabilities.evm.Address
	7,  // 7: loop.chain_capabilities.evm.Log.topics:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 8: loop.chain_capabilities.evm.Log.tx_hash:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 9: loop.chain_capabilities.evm.Log.block_hash:type_name -> loop.chain_capabilities.evm.Hash
	8,  // 10: loop.chain_capabilities.evm.Log.data:type_name -> loop.chain_capabilities.evm.ABIPayload
	7,  // 11: loop.chain_capabilities.evm.Log.eventSig:type_name -> loop.chain_capabilities.evm.Hash
	48, // 12: loop.chain_capabilities.evm.Log.block_number:type_name -> values.BigInt
	7,  // 13: loop.chain_capabilities.evm.FilterQuery.block_hash:type_name -> loop.chain_capabilities.evm.Hash
	48, // 14: loop.chain_capabilities.evm.FilterQuery.fromBlock:type_name -> values.BigInt
	48, // 15: loop.chain_capabilities.evm.FilterQuery.toBlock:type_name -> values.BigInt
	6,  // 16: loop.chain_capabilities.evm.FilterQuery.addresses:type_name -> loop.chain_capabilities.evm.Address
	10, // 17: loop.chain_capabilities.evm.FilterQuery.topics:type_name -> loop.chain_capabilities.evm.Topics
	6,  // 18: loop.chain_capabilities.evm.Transaction.to:type_name -> loop.chain_capabilities.evm.Address
	8,  // 19: loop.chain_capabilities.evm.Transaction.data:type_name -> loop.chain_capabilities.evm.ABIPayload
	7,  // 20: loop.chain_capabilities.evm.Transaction.hash:type_name -> loop.chain_capabilities.evm.Hash
	48, // 21: loop.chain_capabilities.evm.Transaction.value:type_name -> values.BigInt
	48, // 22: loop.chain_capabilities.evm.Transaction.gas_price:type_name -> values.BigInt
	7,  // 23: loop.chain_capabilities.evm.Receipt.block_hash:type_name -> loop.chain_capabilities.evm.Hash
	11, // 24: loop.chain_capabilities.evm.Receipt.logs:type_name -> loop.chain_capabilities.evm.Log
	7,  // 25: loop.chain_capabilities.evm.Receipt.tx_hash:type_name -> loop.chain_capabilities.evm.Hash
	48, // 26: loop.chain_capabilities.evm.Receipt.effective_gas_price:type_name -> values.BigInt
	48, // 27: loop.chain_capabilities.evm.Receipt.block_number:type_name -> values.BigInt
	6,  // 28: loop.chain_capabilities.evm.Receipt.contract_address:type_name -> loop.chain_capabilities.evm.Address
	6,  // 29: loop.chain_capabilities.evm.LPFilter.addresses:type_name -> loop.chain_capabilities.evm.Address
	7,  // 30: loop.chain_capabilities.evm.LPFilter.event_sigs:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 31: loop.chain_capabilities.evm.LPFilter.topic2:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 32: loop.chain_capabilities.evm.LPFilter.topic3:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 33: loop.chain_capabilities.evm.LPFilter.topic4:type_name -> loop.chain_capabilities.evm.Hash
	48, // 34: loop.chain_capabilities.evm.Head.block_number:type_name -> values.BigInt
	7,  // 35: loop.chain_capabilities.evm.Head.hash:type_name -> loop.chain_capabilities.evm.Hash
	7,  // 36: loop.chain_capabilities.evm.Head.parent_hash:type_name -> loop.chain_capabilities.evm.Hash
	26, // 37: loop.chain_capabilities.evm.Expression.primitive:type_name -> loop.chain_capabilities.evm.Primitive
	18, // 38: loop.chain_capabilities.evm.Expression.boolean_expression:type_name -> loop.chain_capabilities.evm.BooleanExpression
	49, // 39: loop.chain_capabilities.evm.BooleanExpression.boolean_operator:type_name -> loop.chain.common.BooleanOperator
	17, // 40: loop.chain_capabilities.evm.BooleanExpression.expression:type_name -> loop.chain_capabilities.evm.Expression
	17, // 41: loop.chain_capabilities.evm.And.expr:type_name -> loop.chain_capabilities.evm.Expression
	17, // 42: loop.chain_capabilities.evm.Or.expr:type_name -> loop.chain_capabilities.evm.Expression
	7,  // 43: loop.chain_capabilities.evm.HashValueComparator.values:type_name -> loop.chain_capabilities.evm.Hash
	50, // 44: loop.chain_capabilities.evm.HashValueComparator.operator:type_name -> loop.chain.common.ComparisonOperator
	6,  // 45: loop.chain_capabilities.evm.ContractAddress.address:type_name -> loop.chain_capabilities.evm.Address
	7,  // 46: loop.chain_capabilities.evm.EventSig.eventSig:type_name -> loop.chain_capabilities.evm.Hash
	21, // 47: loop.chain_capabilities.evm.EventByWord.hashed_value_comparers:type_name -> loop.chain_capabilities.evm.HashValueComparator
	21, // 48: loop.chain_capabilities.evm.EventByTopic.hashed_value_comparers:type_name -> loop.chain_capabilities.evm.HashValueComparator
	51, // 49: loop.chain_capabilities.evm.Primitive.general_primitive:type_name -> loop.chain.common.Primitive
	22, // 50: loop.chain_capabilities.evm.Primitive.contract_address:type_name -> loop.chain_capabilities.evm.ContractAddress
	23, // 51: loop.chain_capabilities.evm.Primitive.event_sig:type_name -> loop.chain_capabilities.evm.EventSig
	24, // 52: loop.chain_capabilities.evm.Primitive.event_by_word:type_name -> loop.chain_capabilities.evm.EventByWord
	25, // 53: loop.chain_capabilities.evm.Primitive.event_by_topic:type_name -> loop.chain_capabilities.evm.EventByTopic
	16, // 54: loop.chain_capabilities.evm.LatestAndFinalizedHeadReply.latest:type_name -> loop.chain_capabilities.evm.Head
	16, // 55: loop.chain_capabilities.evm.LatestAndFinalizedHeadReply.finalized:type_name -> loop.chain_capabilities.evm.Head
	9,  // 56: loop.chain_capabilities.evm.CallContractRequest.call:type_name -> loop.chain_capabilities.evm.CallMsg
	48, // 57: loop.chain_capabilities.evm.CallContractRequest.block_number:type_name -> values.BigInt
	52, // 58: loop.chain_capabilities.evm.CallContractRequest.confidence_level:type_name -> loop.chain.common.Confidence
	48, // 59: loop.chain_capabilities.evm.GetTransactionFeeReply.transation_fee:type_name -> values.BigInt
	12, // 60: loop.chain_capabilities.evm.FilterLogsRequest.filter_query:type_name -> loop.chain_capabilities.evm.FilterQuery
	11, // 61: loop.chain_capabilities.evm.FilterLogsReply.logs:type_name -> loop.chain_capabilities.evm.Log
	48, // 62: loop.chain_capabilities.evm.BalanceAtRequest.block_number:type_name -> values.BigInt
	48, // 63: loop.chain_capabilities.evm.BalanceAtReply.balance:type_name -> values.BigInt
	9,  // 64: loop.chain_capabilities.evm.EstimateGasRequest.msg:type_name -> loop.chain_capabilities.evm.CallMsg
	7,  // 65: loop.chain_capabilities.evm.GetTransactionByHashRequest.hash:type_name -> loop.chain_capabilities.evm.Hash
	13, // 66: loop.chain_capabilities.evm.GetTransactionByHashReply.transaction:type_name -> loop.chain_capabilities.evm.Transaction
	7,  // 67: loop.chain_capabilities.evm.GetTransactionReceiptRequest.hash:type_name -> loop.chain_capabilities.evm.Hash
	14, // 68: loop.chain_capabilities.evm.GetTransactionReceiptReply.receipt:type_name -> loop.chain_capabilities.evm.Receipt
	15, // 69: loop.chain_capabilities.evm.RegisterLogTrackingRequest.filter:type_name -> loop.chain_capabilities.evm.LPFilter
	17, // 70: loop.chain_capabilities.evm.QueryTrackedLogsRequest.expression:type_name -> loop.chain_capabilities.evm.Expression
	53, // 71: loop.chain_capabilities.evm.QueryTrackedLogsRequest.limit_and_sort:type_name -> loop.chain.common.LimitAndSort
	52, // 72: loop.chain_capabilities.evm.QueryTrackedLogsRequest.confidence_level:type_name -> loop.chain.common.Confidence
	11, // 73: loop.chain_capabilities.evm.QueryTrackedLogsReply.logs:type_name -> loop.chain_capabilities.evm.Log
	1,  // 74: loop.chain_capabilities.evm.GetTransactionStatusReply.transaction_status:type_name -> loop.chain_capabilities.evm.TransactionStatus
	30, // 75: loop.chain_capabilities.evm.EVM.GetTransactionFee:input_type -> loop.chain_capabilities.evm.GetTransactionFeeRequest
	28, // 76: loop.chain_capabilities.evm.EVM.CallContract:input_type -> loop.chain_capabilities.evm.CallContractRequest
	32, // 77: loop.chain_capabilities.evm.EVM.FilterLogs:input_type -> loop.chain_capabilities.evm.FilterLogsRequest
	34, // 78: loop.chain_capabilities.evm.EVM.BalanceAt:input_type -> loop.chain_capabilities.evm.BalanceAtRequest
	36, // 79: loop.chain_capabilities.evm.EVM.EstimateGas:input_type -> loop.chain_capabilities.evm.EstimateGasRequest
	38, // 80: loop.chain_capabilities.evm.EVM.GetTransactionByHash:input_type -> loop.chain_capabilities.evm.GetTransactionByHashRequest
	40, // 81: loop.chain_capabilities.evm.EVM.GetTransactionReceipt:input_type -> loop.chain_capabilities.evm.GetTransactionReceiptRequest
	54, // 82: loop.chain_capabilities.evm.EVM.LatestAndFinalizedHead:input_type -> google.protobuf.Empty
	44, // 83: loop.chain_capabilities.evm.EVM.QueryTrackedLogs:input_type -> loop.chain_capabilities.evm.QueryTrackedLogsRequest
	42, // 84: loop.chain_capabilities.evm.EVM.RegisterLogTracking:input_type -> loop.chain_capabilities.evm.RegisterLogTrackingRequest
	43, // 85: loop.chain_capabilities.evm.EVM.UnregisterLogTracking:input_type -> loop.chain_capabilities.evm.UnregisterLogTrackingRequest
	4,  // 86: loop.chain_capabilities.evm.EVM.WriteReport:input_type -> loop.chain_capabilities.evm.WriteReportRequest
	31, // 87: loop.chain_capabilities.evm.EVM.GetTransactionFee:output_type -> loop.chain_capabilities.evm.GetTransactionFeeReply
	29, // 88: loop.chain_capabilities.evm.EVM.CallContract:output_type -> loop.chain_capabilities.evm.CallContractReply
	33, // 89: loop.chain_capabilities.evm.EVM.FilterLogs:output_type -> loop.chain_capabilities.evm.FilterLogsReply
	35, // 90: loop.chain_capabilities.evm.EVM.BalanceAt:output_type -> loop.chain_capabilities.evm.BalanceAtReply
	37, // 91: loop.chain_capabilities.evm.EVM.EstimateGas:output_type -> loop.chain_capabilities.evm.EstimateGasReply
	39, // 92: loop.chain_capabilities.evm.EVM.GetTransactionByHash:output_type -> loop.chain_capabilities.evm.GetTransactionByHashReply
	41, // 93: loop.chain_capabilities.evm.EVM.GetTransactionReceipt:output_type -> loop.chain_capabilities.evm.GetTransactionReceiptReply
	27, // 94: loop.chain_capabilities.evm.EVM.LatestAndFinalizedHead:output_type -> loop.chain_capabilities.evm.LatestAndFinalizedHeadReply
	45, // 95: loop.chain_capabilities.evm.EVM.QueryTrackedLogs:output_type -> loop.chain_capabilities.evm.QueryTrackedLogsReply
	54, // 96: loop.chain_capabilities.evm.EVM.RegisterLogTracking:output_type -> google.protobuf.Empty
	54, // 97: loop.chain_capabilities.evm.EVM.UnregisterLogTracking:output_type -> google.protobuf.Empty
	5,  // 98: loop.chain_capabilities.evm.EVM.WriteReport:output_type -> loop.chain_capabilities.evm.WriteReportReply
