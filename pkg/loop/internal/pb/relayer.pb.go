...
type CCIPProviderArgs struct {
	...
	ExtraDataCodecRegistryID uint32                 `protobuf:"varint,7,opt,name=extraDataCodecRegistryID,proto3" json:"extraDataCodecRegistryID,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *CCIPProviderArgs) GetExtraDataCodecRegistryID() uint32 {
	if x != nil {
		return x.ExtraDataCodecRegistryID
	}
	return 0
}
...
const file_loop_internal_pb_relayer_proto_rawDesc = "" +
	...
	"\fpluginConfig\x18\x02 \x01(\fR\fpluginConfig\"\xba\x03\n" +
	...
	"\x18extraDataCodecRegistryID\x18\a \x01(\rR\x18extraDataCodecRegistryID\x1aB\n" +
