...
// NewWithOtel creates new Zap logger integrated with OTel logger using global LoggerProvider from beholder client
func NewWithOtel(provider otellog.LoggerProvider, name string, opts ...Option) Logger {
