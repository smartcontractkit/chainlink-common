...
func (x *ShardStatus) GetIsHealthy() bool {
	if x != nil {
		return x.IsHealthy
	}
	return false
...
const file_shared_proto_rawDesc = "" +
	...
	"\n" +
	"is_healthy\x18\x01 \x01(\bR\tisHealthyBDZBgithub.com/smartcontractkit/chainlink-common/pkg/workflows/ring/pbb\x06proto3"
