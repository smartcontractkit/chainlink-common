...
// BuildReportResponse is gRPC adapter for the return values of [pkg/types/mercury/v3/ReportCodec.BuildReport].
...
func (x *BuildReportResponse) GetReport() []byte {
	if x != nil {
		return x.Report
	}
	return nil
...
// MaxReportLengthResponse is gRPC adapter for the return values of [github.com/smartcontractkit/chainlink-data-streams/mercury/v3/ReportCodec.MaxReportLength].
type MaxReportLengthResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MaxReportLengthResponse) Reset() {
	*x = MaxReportLengthResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MaxReportLengthResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MaxReportLengthResponse) ProtoMessage() {}

func (x *MaxReportLengthResponse) ProtoReflect() protoreflect.Message {
	mi := &file_reportcodec_v3_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MaxReportLengthResponse.ProtoReflect.Descriptor instead.
func (*MaxReportLengthResponse) Descriptor() ([]byte, []int) {
	return file_reportcodec_v3_proto_rawDescGZIP(), []int{4}
}

func (x *MaxReportLengthResponse) GetMaxReportLength() uint64 {
	if x != nil {
...
// ObservationTimestampFromReportResponse is gRPC adapter for the return values of [github.com/smartcontractkit/chainlink-data-streams/mercury/v3/ReportCodec.ObservationTimestampFromReport].
type ObservationTimestampFromReportResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ObservationTimestampFromReportResponse) Reset() {
	*x = ObservationTimestampFromReportResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObservationTimestampFromReportResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObservationTimestampFromReportResponse) ProtoMessage() {}

func (x *ObservationTimestampFromReportResponse) ProtoReflect() protoreflect.Message {
	mi := &file_reportcodec_v3_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObservationTimestampFromReportResponse.ProtoReflect.Descriptor instead.
func (*ObservationTimestampFromReportResponse) Descriptor() ([]byte, []int) {
	return file_reportcodec_v3_proto_rawDescGZIP(), []int{6}
}

func (x *ObservationTimestampFromReportResponse) GetTimestamp() uint32 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_reportcodec_v3_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x2d,
	0x0a, 0x13, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73,
	...
	0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x73, 0x22, 0x43, 0x0a, 0x17, 0x4d, 0x61, 0x78, 0x52, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4c,
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x46, 0x0a,
	0x26, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0xaf, 0x03, 0x0a, 0x0b, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
	0x43, 0x6f, 0x64, 0x65, 0x63, 0x12, 0x72, 0x0a, 0x0b, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65,
	...
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79,
	0x2e, 0x76, 0x33, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52,
	...
	0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x2e, 0x76, 0x33, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0xab, 0x01, 0x0a, 0x1e, 0x4f, 0x62,
	...
	0x61, 0x6d, 0x70, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73,
	...
	0x63, 0x75, 0x72, 0x79, 0x2f, 0x76, 0x33, 0x3b, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x76,
...
var file_reportcodec_v3_proto_goTypes = []interface{}{
	...
	(*BuildReportResponse)(nil),                    // 2: loop.internal.pb.mercury.v3.BuildReportResponse
	(*MaxReportLengthRequest)(nil),                 // 3: loop.internal.pb.mercury.v3.MaxReportLengthRequest
	(*MaxReportLengthResponse)(nil),                // 4: loop.internal.pb.mercury.v3.MaxReportLengthResponse
	(*ObservationTimestampFromReportRequest)(nil),  // 5: loop.internal.pb.mercury.v3.ObservationTimestampFromReportRequest
	(*ObservationTimestampFromReportResponse)(nil), // 6: loop.internal.pb.mercury.v3.ObservationTimestampFromReportResponse
...
var file_reportcodec_v3_proto_depIdxs = []int32{
	...
	2, // 9: loop.internal.pb.mercury.v3.ReportCodec.BuildReport:output_type -> loop.internal.pb.mercury.v3.BuildReportResponse
	4, // 10: loop.internal.pb.mercury.v3.ReportCodec.MaxReportLength:output_type -> loop.internal.pb.mercury.v3.MaxReportLengthResponse
	6, // 11: loop.internal.pb.mercury.v3.ReportCodec.ObservationTimestampFromReport:output_type -> loop.internal.pb.mercury.v3.ObservationTimestampFromReportResponse
...
func file_reportcodec_v3_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_reportcodec_v3_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MaxReportLengthResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_reportcodec_v3_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObservationTimestampFromReportResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
