...
// NewChainCapabilities provides a mock function with given fields: _a0
func (_m *Relayer) NewChainCapabilities(_a0 context.Context) (types.ChainCapabilities, error) {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *Relayer_Expecter) NewChainCapabilities(_a0 interface{}) *Relayer_NewChainCapabilities_Call {
	return &Relayer_NewChainCapabilities_Call{Call: _e.mock.On("NewChainCapabilities", _a0)}
}

func (_c *Relayer_NewChainCapabilities_Call) Run(run func(_a0 context.Context)) *Relayer_NewChainCapabilities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
