...
func (_m *GatewayConnectorHandler) HandleGatewayMessage(ctx context.Context, gatewayID string, msg *gateway.Message) error {
...
func (_c *GatewayConnectorHandler_HandleGatewayMessage_Call) Run(run func(ctx context.Context, gatewayID string, msg *gateway.Message)) *GatewayConnectorHandler_HandleGatewayMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GatewayConnectorHandler_HandleGatewayMessage_Call) RunAndReturn(run func(context.Context, string, *gateway.Message) error) *GatewayConnectorHandler_HandleGatewayMessage_Call {
	_c.Call.Return(run)
	return _c
}

// ID provides a mock function with no fields
func (_m *GatewayConnectorHandler) ID() (string, error) {
	ret := _m.Called()
...
func (_e *GatewayConnectorHandler_Expecter) ID() *GatewayConnectorHandler_ID_Call {
	return &GatewayConnectorHandler_ID_Call{Call: _e.mock.On("ID")}
}

func (_c *GatewayConnectorHandler_ID_Call) Run(run func()) *GatewayConnectorHandler_ID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *GatewayConnectorHandler_ID_Call) RunAndReturn(run func() (string, error)) *GatewayConnectorHandler_ID_Call {
	_c.Call.Return(run)
	return _c
}
