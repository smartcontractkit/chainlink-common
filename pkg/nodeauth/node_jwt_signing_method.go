...
//============================================================================================================================================
// 																				@dev
// Only use Signer interface in node_jwt_generator.go if we decide to be flexible and allow nodes to use different signing mechanisms (e.g., ECDSA, Ed25519, RSA, etc.) for JWT signing.
// 										For now we should stick to Ed25519(EdDSASigningMethod) for JWT signing.
//============================================================================================================================================
