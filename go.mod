...
require (
	...
	github.com/smartcontractkit/por_mock_ocr3plugin v0.0.0-20250627193309-2ff496c274dc // indirect
...
replace (
	github.com/smartcontractkit/chainlink-common/pkg/chipingress => ./pkg/chipingress
	github.com/smartcontractkit/chainlink-common/pkg/values => ./pkg/values
	github.com/smartcontractkit/chainlink-common/pkg/workflows/sdk/v2/pb => ./pkg/workflows/sdk/v2/pb
	github.com/smartcontractkit/por_mock_ocr3plugin => /Users/ggerritsen/dev/cll/por_mock_ocr3plugin
)
