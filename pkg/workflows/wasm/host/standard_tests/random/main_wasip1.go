...
func main() {
	...
	rawsdk.MakeRequest("basic-test-node-action@1.0.0", "PerformAction", pb.Mode_MODE_NODE, input, result)
	...
	rawsdk.MakeRequest("consensus@1.0.0", "Simple", pb.Mode_MODE_DON, consensus, cresult)
