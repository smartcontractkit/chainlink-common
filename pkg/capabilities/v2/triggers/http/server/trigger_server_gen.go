...
func (c *hTTPCapability) AckEvent(ctx context.Context, triggerId string, eventId string, workflowId string) error {
	return c.HTTPCapability.AckEvent(ctx, triggerId, eventId, workflowId)
}
