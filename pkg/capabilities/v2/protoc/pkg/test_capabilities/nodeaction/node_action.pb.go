...
func (x *NodeOutputs) Reset() {
	*x = NodeOutputs{}
	mi := &file_capabilities_v2_protoc_pkg_test_capabilities_nodeaction_node_action_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeOutputs) Descriptor() ([]byte, []int) {
	return file_capabilities_v2_protoc_pkg_test_capabilities_nodeaction_node_action_proto_rawDescGZIP(), []int{2}
}
...
const file_capabilities_v2_protoc_pkg_test_capabilities_nodeaction_node_action_proto_rawDesc = "" +
	"\n" +
	"Icapabilities/v2/protoc/pkg/test_capabilities/nodeaction/node_action.proto\x12\x19basic_test_node_action.v1\x1a0capabilities/v2/protoc/pkg/pb/cre_metadata.proto\"\x96\x01\n" +
	"\x06Config\x12E\n" +
	...
	"\vBasicAction\x12^\n" +
	"\rPerformAction\x12%.basic_test_node_action.v1.NodeInputs\x1a&.basic_test_node_action.v1.NodeOutputs\x1a$\x8a\xb5\x18 \b\x01\x12\x1cbasic-test-node-action@1.0.0BfZdgithub.com/smartcontractkit/chainlink-common/pkg/capabilities/v2/protoc/test_capabilities/nodeactionb\x06proto3"
...
var file_capabilities_v2_protoc_pkg_test_capabilities_nodeaction_node_action_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
