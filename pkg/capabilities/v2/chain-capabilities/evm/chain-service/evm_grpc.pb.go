...
const (
	...
	EVM_WriteReport_FullMethodName            = "/loop.chain_capabilities.evm.EVM/WriteReport"
)
...
func (e EVMClient) FilterLogs(context context.Context, request *FilterLogsRequest) {
	panic("unimplemented")
}
