...
func (c *gatewayConnectorClient) SignAndSendToGateway(ctx context.Context, in *SignAndSendMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, GatewayConnector_SignAndSendToGateway_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGatewayConnectorServer) SignAndSendToGateway(context.Context, *SignAndSendMessageRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignAndSendToGateway not implemented")
}
...
func _GatewayConnector_SignAndSendToGateway_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignAndSendMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayConnectorServer).SignAndSendToGateway(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GatewayConnector_SignAndSendToGateway_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayConnectorServer).SignAndSendToGateway(ctx, req.(*SignAndSendMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GatewayConnector_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SignAndSendToGateway",
			Handler:    _GatewayConnector_SignAndSendToGateway_Handler,
		},
		{
