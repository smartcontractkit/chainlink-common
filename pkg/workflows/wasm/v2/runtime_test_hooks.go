...
func forceCapabilityCallError(t *testing.T) {
	lock.Lock()
	defer lock.Unlock()
...
func awaitCapabilities(awaitRequest unsafe.Pointer, awaitRequestLen int32, responseBuffer unsafe.Pointer, maxResponseLen int32) int64 {
	...
	requestpb := &pb.AwaitCapabilitiesRequest{}
	...
	responsepb := &pb.AwaitCapabilitiesResponse{Responses: map[string]*sdkpb.CapabilityResponse{}}
