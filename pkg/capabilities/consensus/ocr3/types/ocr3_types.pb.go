...
type AggregationOutcome struct {
	...
	Timestamp        uint64  `protobuf:"varint,5,opt,name=timestamp,proto3" json:"timestamp,omitempty"`   // current time of the node
}
...
func (x *AggregationOutcome) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *Observations) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
