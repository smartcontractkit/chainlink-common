...
type factory struct {
	store                   *requests.Store[*requests.ReportRequest, requests.Response]
...
func newFactory(s *requests.Store[*requests.ReportRequest, requests.Response], c *capability, lggr logger.Logger) (*factory, error) {
	return &factory{
		store:      s,
		capability: c,
