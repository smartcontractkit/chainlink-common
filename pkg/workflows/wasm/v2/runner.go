...
func (r *runner[C, T]) run(wfs []sdk.BaseWorkflow[C, T]) {
...
func (s *subscriber[C, T]) run(wfs []sdk.BaseWorkflow[C, T]) {
...
func getWorkflows[C any](config C, initFn func(wcx *sdk.WorkflowContext[C]) (sdk.Workflows[C], error)) sdk.Workflows[C] {
...
func (r runnerWrapper[C]) Run(initFn func(wcx *sdk.WorkflowContext[C]) (sdk.Workflows[C], error)) {
