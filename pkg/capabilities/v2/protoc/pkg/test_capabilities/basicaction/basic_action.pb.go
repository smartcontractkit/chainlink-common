...
func (x *Outputs) Reset() {
	*x = Outputs{}
	mi := &file_capabilities_v2_protoc_pkg_test_capabilities_basicaction_basic_action_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Outputs) Descriptor() ([]byte, []int) {
	return file_capabilities_v2_protoc_pkg_test_capabilities_basicaction_basic_action_proto_rawDescGZIP(), []int{2}
}
...
const file_capabilities_v2_protoc_pkg_test_capabilities_basicaction_basic_action_proto_rawDesc = "" +
	"\n" +
	"Kcapabilities/v2/protoc/pkg/test_capabilities/basicaction/basic_action.proto\x12\x14basic_test_action.v1\x1a0capabilities/v2/protoc/pkg/pb/cre_metadata.proto\"\x96\x01\n" +
	"\x06Config\x12E\n" +
	...
	"\vBasicAction\x12L\n" +
	"\rPerformAction\x12\x1c.basic_test_action.v1.Inputs\x1a\x1d.basic_test_action.v1.Outputs\x1a\x1d\x8a\xb5\x18\x19\x12\x17basic-test-action@1.0.0BkZigithub.com/smartcontractkit/chainlink-common/pkg/capabilities/v2/protoc/pkg/test_capabilities/basicactionb\x06proto3"
...
var file_capabilities_v2_protoc_pkg_test_capabilities_basicaction_basic_action_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
