...
var file_evm_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_evm_proto_goTypes = []any{
	...
	(*crosschain.TxResult)(nil),      // 13: don.crosschain.v1.TxResult
	(*crosschain.ByteArray)(nil),     // 14: don.crosschain.v1.ByteArray
	(*crosschain.BlockRange)(nil),    // 15: don.crosschain.v1.BlockRange
}
var file_evm_proto_depIdxs = []int32{
	...
	12, // 14: don.evm.v1.Client.OnFinalityViolation:input_type -> google.protobuf.Empty
	13, // 15: don.evm.v1.Client.GetTxResult:output_type -> don.crosschain.v1.TxResult
	14, // 16: don.evm.v1.Client.ReadMethod:output_type -> don.crosschain.v1.ByteArray
	11, // 17: don.evm.v1.Client.QueryLogs:output_type -> don.evm.v1.LogList
	...
	15, // 21: don.evm.v1.Client.OnFinalityViolation:output_type -> don.crosschain.v1.BlockRange
