...
func (_m *ContractReader) GetLatestValue(ctx context.Context, contractName string, method string, params interface{}, returnVal interface{}) error {
...
func (_m *ContractReader) QueryKey(ctx context.Context, contractName string, filter query.KeyFilter, limitAndSort query.LimitAndSort, sequenceDataType interface{}) ([]types.Sequence, error) {
