...
var file_registry_proto_depIdxs = []int32{
	...
	13, // 2: loop.RemoteTriggerConfig.eventTimeout:type_name -> google.protobuf.Duration
	13, // 3: loop.RemoteTriggerConfig.messageExpiry:type_name -> google.protobuf.Duration
	13, // 4: loop.RemoteTriggerConfig.batchCollectionPeriod:type_name -> google.protobuf.Duration
