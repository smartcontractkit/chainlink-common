...
func (x *BoundContract) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x76, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73,
	0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2f, 0x0a,
	...
	0x72, 0x61, 0x63, 0x74, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x2c,
	...
	0x79, 0x74, 0x65, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0xaa, 0x01, 0x0a,
	...
	0x6c, 0x22, 0x3d, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x70,
	...
	,
	...
	0x65, 0x10, 0x02, 0x32, 0x81, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x61,
...
var file_chain_reader_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_chain_reader_proto_goTypes = []interface{}{
	...
	(*UnbindRequest)(nil),         // 9: loop.UnbindRequest
	...
	(*QueryKeyFilter)(nil),        // 15: loop.QueryKeyFilter
	(*Expression)(nil),            // 16: loop.Expression
	(*BooleanExpression)(nil),     // 17: loop.BooleanExpression
	(*And)(nil),                   // 18: loop.And
	(*Or)(nil),                    // 19: loop.Or
	(*ValueComparator)(nil),       // 20: loop.ValueComparator
	(*Comparator)(nil),            // 21: loop.Comparator
	(*Block)(nil),                 // 22: loop.Block
	(*Timestamp)(nil),             // 23: loop.Timestamp
	(*TxHash)(nil),                // 24: loop.TxHash
	(*Primitive)(nil),             // 25: loop.Primitive
	(*Limit)(nil),                 // 26: loop.Limit
	(*SortBy)(nil),                // 27: loop.SortBy
	(*LimitAndSort)(nil),          // 28: loop.LimitAndSort
...
var file_chain_reader_proto_depIdxs = []int32{
	...
	29, // 1: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	14, // 2: loop.QueryKeyRequest.contract:type_name -> loop.BoundContract
	15, // 3: loop.QueryKeyRequest.filter:type_name -> loop.QueryKeyFilter
	28, // 4: loop.QueryKeyRequest.limit_and_sort:type_name -> loop.LimitAndSort
	14, // 5: loop.BindRequest.bindings:type_name -> loop.BoundContract
	14, // 6: loop.UnbindRequest.bindings:type_name -> loop.BoundContract
	29, // 7: loop.GetLatestValueReply.ret_val:type_name -> loop.VersionedBytes
	13, // 8: loop.QueryKeyReply.sequences:type_name -> loop.Sequence
	12, // 9: loop.Sequence.head:type_name -> loop.Head
	29, // 10: loop.Sequence.data:type_name -> loop.VersionedBytes
	16, // 11: loop.QueryKeyFilter.expression:type_name -> loop.Expression
	25, // 12: loop.Expression.primitive:type_name -> loop.Primitive
	17, // 13: loop.Expression.boolean_expression:type_name -> loop.BooleanExpression
	1,  // 14: loop.BooleanExpression.boolean_operator:type_name -> loop.BooleanOperator
	16, // 15: loop.BooleanExpression.expression:type_name -> loop.Expression
	16, // 16: loop.And.expr:type_name -> loop.Expression
	16, // 17: loop.Or.expr:type_name -> loop.Expression
	0,  // 18: loop.ValueComparator.operator:type_name -> loop.ComparisonOperator
	20, // 19: loop.Comparator.value_comparators:type_name -> loop.ValueComparator
	0,  // 20: loop.Block.operator:type_name -> loop.ComparisonOperator
	0,  // 21: loop.Timestamp.operator:type_name -> loop.ComparisonOperator
	21, // 22: loop.Primitive.comparator:type_name -> loop.Comparator
	22, // 23: loop.Primitive.block:type_name -> loop.Block
	2,  // 24: loop.Primitive.confidence:type_name -> loop.Confidence
	23, // 25: loop.Primitive.timestamp:type_name -> loop.Timestamp
	24, // 26: loop.Primitive.tx_hash:type_name -> loop.TxHash
	3,  // 27: loop.Limit.direction:type_name -> loop.CursorDirection
	5,  // 28: loop.SortBy.sort_type:type_name -> loop.SortType
	4,  // 29: loop.SortBy.direction:type_name -> loop.SortDirection
	27, // 30: loop.LimitAndSort.sort_by:type_name -> loop.SortBy
	26, // 31: loop.LimitAndSort.limit:type_name -> loop.Limit
	6,  // 32: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	7,  // 33: loop.ChainReader.QueryKey:input_type -> loop.QueryKeyRequest
	8,  // 34: loop.ChainReader.Bind:input_type -> loop.BindRequest
	9,  // 35: loop.ChainReader.Unbind:input_type -> loop.UnbindRequest
	10, // 36: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	11, // 37: loop.ChainReader.QueryKey:output_type -> loop.QueryKeyReply
	30, // 38: loop.ChainReader.Bind:output_type -> google.protobuf.Empty
	30, // 39: loop.ChainReader.Unbind:output_type -> google.protobuf.Empty
...
func file_chain_reader_proto_init() {
	...
	file_chain_reader_proto_msgTypes[10].OneofWrappers = []interface{}{
