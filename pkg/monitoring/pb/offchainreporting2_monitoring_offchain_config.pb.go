...
func file_offchainreporting2_monitoring_offchain_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_offchainreporting2_monitoring_offchain_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_offchainreporting2_monitoring_offchain_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
