...
const file_capabilities_pb_capabilities_proto_rawDesc = "" +
	...
	"\x0eworkflow_owner\x18\x03 \x01(\tR\rworkflowOwner\"\xc4\x01\n" +
	"\x19RegisterToWorkflowRequest\x12>\n" +
	"\bmetadata\x18\x01 \x01(\v2\".capabilities.RegistrationMetadataR\bmetadata\x12#\n" +
	"\x06config\x18\x02 \x01(\v2\v.values.MapR\x06config\x12*\n" +
	"\x05value\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x05value\x12\x16\n" +
	"\x06method\x18\x04 \x01(\tR\x06method\"\xc8\x01\n" +
	"\x1dUnregisterFromWorkflowRequest\x12>\n" +
	"\bmetadata\x18\x01 \x01(\v2\".capabilities.RegistrationMetadataR\bmetadata\x12#\n" +
	"\x06config\x18\x02 \x01(\v2\v.values.MapR\x06config\x12*\n" +
	"\x05value\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x05value\x12\x16\n" +
	"\x06method\x18\x05 \x01(\tR\x06method\"\xc2\x02\n" +
...
var file_capabilities_pb_capabilities_proto_depIdxs = []int32{
	...
	16, // 21: capabilities.RegisterToWorkflowRequest.value:type_name -> google.protobuf.Any
	10, // 22: capabilities.UnregisterFromWorkflowRequest.metadata:type_name -> capabilities.RegistrationMetadata
	15, // 23: capabilities.UnregisterFromWorkflowRequest.config:type_name -> values.Map
	16, // 24: capabilities.UnregisterFromWorkflowRequest.value:type_name -> google.protobuf.Any
	1,  // 25: capabilities.CapabilityInfosReply.infos:type_name -> capabilities.CapabilityInfoReply
	17, // 26: capabilities.BaseCapability.Info:input_type -> google.protobuf.Empty
	4,  // 27: capabilities.TriggerExecutable.RegisterTrigger:input_type -> capabilities.TriggerRegistrationRequest
	4,  // 28: capabilities.TriggerExecutable.UnregisterTrigger:input_type -> capabilities.TriggerRegistrationRequest
	11, // 29: capabilities.Executable.RegisterToWorkflow:input_type -> capabilities.RegisterToWorkflowRequest
	12, // 30: capabilities.Executable.UnregisterFromWorkflow:input_type -> capabilities.UnregisterFromWorkflowRequest
	3,  // 31: capabilities.Executable.Execute:input_type -> capabilities.CapabilityRequest
	13, // 32: capabilities.StandardCapabilities.Initialise:input_type -> capabilities.InitialiseRequest
	17, // 33: capabilities.StandardCapabilities.Infos:input_type -> google.protobuf.Empty
	1,  // 34: capabilities.BaseCapability.Info:output_type -> capabilities.CapabilityInfoReply
	7,  // 35: capabilities.TriggerExecutable.RegisterTrigger:output_type -> capabilities.TriggerResponseMessage
	17, // 36: capabilities.TriggerExecutable.UnregisterTrigger:output_type -> google.protobuf.Empty
	17, // 37: capabilities.Executable.RegisterToWorkflow:output_type -> google.protobuf.Empty
	17, // 38: capabilities.Executable.UnregisterFromWorkflow:output_type -> google.protobuf.Empty
	8,  // 39: capabilities.Executable.Execute:output_type -> capabilities.CapabilityResponse
	17, // 40: capabilities.StandardCapabilities.Initialise:output_type -> google.protobuf.Empty
	14, // 41: capabilities.StandardCapabilities.Infos:output_type -> capabilities.CapabilityInfosReply
