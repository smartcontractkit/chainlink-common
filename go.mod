...
require (
	...
	github.com/smartcontractkit/cre-capability-errors v0.0.0-20260505114830-b779a26f1528
...
replace github.com/smartcontractkit/cre-capability-errors => ../cre-capability-errors
