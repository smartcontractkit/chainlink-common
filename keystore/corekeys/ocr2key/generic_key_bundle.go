...
func newKeyBundleRand[K keyring](chain types.ChainType, newKeyring func(material io.Reader) (K, error)) (*keyBundle[K], error) {
	return newKeyBundleFrom(chain, newKeyring, cryptorand.Reader, cryptorand.Reader, cryptorand.Reader)
}

func mustNewKeyBundleInsecure[K keyring](chain types.ChainType, newKeyring func(material io.Reader) (K, error), reader io.Reader) *keyBundle[K] {
...
func newKeyBundleFrom[K keyring](chain types.ChainType, newKeyring func(material io.Reader) (K, error), onchainSigningKeyMaterial, onchainEncryptionKeyMaterial, offchainKeyMaterial io.Reader) (*keyBundle[K], error) {
...
func (kbraw *keyBundleRawData) Migrate(b []byte) error {
	...
	if bytes.Equal(kbraw.ID[:], new(Sha256Hash)[:]) {
