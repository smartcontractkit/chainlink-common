...
type BasicCapability interface {
	Action(ctx context.Context, metadata capabilities.RequestMetadata, input *actionandtrigger.Input /* TODO  config actionandtrigger.Input*/) (*actionandtrigger.Output, error)
	RegisterAction(ctx context.Context, metadata capabilities.RegistrationMetadata /* TODO config */) error
	UnregisterAction(ctx context.Context, metadata capabilities.RegistrationMetadata /* TODO config */) error
...
func (c *basicCapability) Info(ctx context.Context) (capabilities.CapabilityInfo, error) {
	...
	return capabilities.NewCapabilityInfo("basic-test-action-trigger@1.0.0", capabilities.CapabilityTypeAction, c.BasicCapability.Description())
}
...
var _ capabilities.ActionCapability = (*basicCapability)(nil)
...
func (c *basicCapability) Execute(ctx context.Context, request capabilities.CapabilityRequest) (capabilities.CapabilityResponse, error) {
	...
	case "Action":
		...
		// TODO config
		return capabilities.Execute(ctx, request, input, c.BasicCapability.Action)
	default:
