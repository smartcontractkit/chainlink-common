...
var file_aptos_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_aptos_proto_depIdxs = []int32{
	...
	7,  // 1: loop.aptos.ViewPayload.module:type_name -> loop.aptos.ModuleID
	8,  // 2: loop.aptos.ViewPayload.arg_types:type_name -> loop.aptos.TypeTag
	0,  // 3: loop.aptos.TypeTag.type:type_name -> loop.aptos.TypeTagType
	9,  // 4: loop.aptos.TypeTag.vector:type_name -> loop.aptos.VectorTag
	10, // 5: loop.aptos.TypeTag.struct:type_name -> loop.aptos.StructTag
	11, // 6: loop.aptos.TypeTag.generic:type_name -> loop.aptos.GenericTag
	8,  // 7: loop.aptos.VectorTag.element_type:type_name -> loop.aptos.TypeTag
	8,  // 8: loop.aptos.StructTag.type_params:type_name -> loop.aptos.TypeTag
	14, // 9: loop.aptos.EventsByHandleReply.events:type_name -> loop.aptos.Event
	15, // 10: loop.aptos.Event.guid:type_name -> loop.aptos.GUID
	18, // 11: loop.aptos.TransactionByHashReply.transaction:type_name -> loop.aptos.Transaction
	1,  // 12: loop.aptos.Transaction.type:type_name -> loop.aptos.TransactionVariant
	7,  // 13: loop.aptos.SubmitTransactionRequest.receiver_module_id:type_name -> loop.aptos.ModuleID
	21, // 14: loop.aptos.SubmitTransactionRequest.gas_config:type_name -> loop.aptos.GasConfig
	22, // 15: loop.aptos.SubmitTransactionReply.pending_transaction:type_name -> loop.aptos.PendingTransaction
	2,  // 16: loop.aptos.Aptos.AccountAPTBalance:input_type -> loop.aptos.AccountAPTBalanceRequest
	4,  // 17: loop.aptos.Aptos.View:input_type -> loop.aptos.ViewRequest
	12, // 18: loop.aptos.Aptos.EventsByHandle:input_type -> loop.aptos.EventsByHandleRequest
	16, // 19: loop.aptos.Aptos.TransactionByHash:input_type -> loop.aptos.TransactionByHashRequest
	19, // 20: loop.aptos.Aptos.SubmitTransaction:input_type -> loop.aptos.SubmitTransactionRequest
	3,  // 21: loop.aptos.Aptos.AccountAPTBalance:output_type -> loop.aptos.AccountAPTBalanceReply
	5,  // 22: loop.aptos.Aptos.View:output_type -> loop.aptos.ViewReply
	13, // 23: loop.aptos.Aptos.EventsByHandle:output_type -> loop.aptos.EventsByHandleReply
	17, // 24: loop.aptos.Aptos.TransactionByHash:output_type -> loop.aptos.TransactionByHashReply
	20, // 25: loop.aptos.Aptos.SubmitTransaction:output_type -> loop.aptos.SubmitTransactionReply
