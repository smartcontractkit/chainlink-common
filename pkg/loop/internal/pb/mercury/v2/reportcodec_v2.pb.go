...
// 	protoc        v4.25.1
// source: pkg/loop/internal/pb/mercury/v2/reportcodec_v2.proto
...
func (x *ReportFields) Reset() {
	*x = ReportFields{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[0]
...
func (*ReportFields) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{0}
}
...
func (x *BuildReportRequest) Reset() {
	*x = BuildReportRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildReportRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuildReportReply) Reset() {
	*x = BuildReportReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildReportReply) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{2}
}
...
func (x *MaxReportLengthRequest) Reset() {
	*x = MaxReportLengthRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MaxReportLengthRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{3}
}
...
func (x *MaxReportLengthReply) Reset() {
	*x = MaxReportLengthReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MaxReportLengthReply) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{4}
}
...
func (x *ObservationTimestampFromReportRequest) Reset() {
	*x = ObservationTimestampFromReportRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ObservationTimestampFromReportRequest) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{5}
}
...
func (x *ObservationTimestampFromReportReply) Reset() {
	*x = ObservationTimestampFromReportReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ObservationTimestampFromReportReply) Descriptor() ([]byte, []int) {
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP(), []int{6}
}
...
var File_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto protoreflect.FileDescriptor

var file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDesc = []byte{
	...
	0x32, 0x2f, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x5f, 0x76, 0x32,
	...
	0x2e, 0x76, 0x32, 0x1a, 0x22, 0x70, 0x6b, 0x67, 0x2f, 0x6c, 0x6f, 0x6f, 0x70, 0x2f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x02, 0x0a, 0x0c, 0x52, 0x65, 0x70, 0x6f,
	...
	0x62, 0x65, 0x6e, 0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x63,
	...
	0x72, 0x63, 0x75, 0x72, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x46,
	...
	0x2e, 0x70, 0x62, 0x2e, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x42,
	...
	0x70, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x6d, 0x65,
	0x72, 0x63, 0x75, 0x72, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x70, 0x6f,
	...
	0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x2f, 0x76, 0x32, 0x3b, 0x6d, 0x65, 0x72, 0x63, 0x75,
	0x72, 0x79, 0x76, 0x32, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescOnce sync.Once
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescData = file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDesc
)

func file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescGZIP() []byte {
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescOnce.Do(func() {
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescData)
	})
	return file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDescData
}

var file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_goTypes = []interface{}{
...
var file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_depIdxs = []int32{
...
func init() { file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_init() }
func file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_init() {
	if File_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_goTypes,
		DependencyIndexes: file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_depIdxs,
		MessageInfos:      file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_msgTypes,
	}.Build()
	File_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto = out.File
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_rawDesc = nil
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_goTypes = nil
	file_pkg_loop_internal_pb_mercury_v2_reportcodec_v2_proto_depIdxs = nil
}
