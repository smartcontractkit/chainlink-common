...
const file_workflows_wasm_v2_pb_wasm_proto_rawDesc = "" +
	"\n" +
	"\x1fworkflows/wasm/v2/pb/wasm.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x19google/protobuf/any.proto\x1a\x16values/pb/values.proto\"\x8c\x01\n" +
	...
	"\apayload\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\apayload\"\xa1\x01\n" +
	...
	"\atrigger\x18\x04 \x01(\v2\b.TriggerH\x00R\atriggerB\t\n" +
	"\arequest\"j\n" +
	...
	"\x04NODE\x10\x01BFZDgithub.com/smartcontractkit/chainlink-common/pkg/workflows/v2/sdk/pbb\x06proto3"
...
func file_workflows_wasm_v2_pb_wasm_proto_init() {
	...
	file_workflows_wasm_v2_pb_wasm_proto_msgTypes[2].OneofWrappers = []any{
	...
	file_workflows_wasm_v2_pb_wasm_proto_msgTypes[6].OneofWrappers = []any{
		(*CapabilityResponse_Payload)(nil),
		(*CapabilityResponse_Error)(nil),
	}
	file_workflows_wasm_v2_pb_wasm_proto_msgTypes[8].OneofWrappers = []any{
