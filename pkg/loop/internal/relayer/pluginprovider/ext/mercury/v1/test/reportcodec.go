...
func (s staticReportCodec) BuildReport(ctx context.Context, fields mercury_v1_types.ReportFields) (types.Report, error) {
...
func (s staticReportCodec) CurrentBlockNumFromReport(context.Context, types.Report) (int64, error) {
