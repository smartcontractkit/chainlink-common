...
func (c *{{$contract.Type}}) RegisterLogTracking{{.Normalized.Name}}(runtime sdk.DonRuntime, options *LogTrackingOptions) {
...
func (c *{{$contract.Type}}) FilterLogs{{.Normalized.Name}}(runtime sdk.DonRuntime, options *FilterOptions) ([]bindings.ParsedLog[{{.Normalized.Name}}], error) {
	if options == nil {
