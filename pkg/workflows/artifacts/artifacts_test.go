...
func (s *ArtifactsTestSuite) TestArtifacts() {
	...
	expKeccak256Hash, err := hex.DecodeString("fe4c48e42801b1425d771e4449c2b28551f4f433f33439a54ed0786f61085cf0")
	...
	s.Len(base64EncodedBinaryData, 636848, "binary data size should match the pinned toolchain output")
	...
	s.Equal("003ae5a7807c05f244bd56f66f391fe883d739390df323e64837c2b58ed7e4ac", artifacts.GetWorkflowID())
}
