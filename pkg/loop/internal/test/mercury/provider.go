...
type MercuryProviderTester interface {
	...
	AssertEqual(t *testing.T, ctx context.Context, other types.MercuryProvider)
}
...
func (s staticMercuryProvider) AssertEqual(t *testing.T, ctx context.Context, other types.MercuryProvider) {
