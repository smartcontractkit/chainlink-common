...
var file_capabilities_pb_triggers_proto_rawDesc = []byte{
...
var (
	...
	file_capabilities_pb_triggers_proto_rawDescData = file_capabilities_pb_triggers_proto_rawDesc
)

func file_capabilities_pb_triggers_proto_rawDescGZIP() []byte {
	file_capabilities_pb_triggers_proto_rawDescOnce.Do(func() {
		file_capabilities_pb_triggers_proto_rawDescData = protoimpl.X.CompressGZIP(file_capabilities_pb_triggers_proto_rawDescData)
	})
...
var file_capabilities_pb_triggers_proto_goTypes = []interface{}{
...
func file_capabilities_pb_triggers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_capabilities_pb_triggers_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OCRTriggerEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_capabilities_pb_triggers_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OCRAttributedOnchainSignature); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_capabilities_pb_triggers_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OCRTriggerReport); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_capabilities_pb_triggers_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_capabilities_pb_triggers_proto_rawDesc = nil
