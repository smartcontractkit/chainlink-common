...
type TriggerExecutableClient interface {
	RegisterTrigger(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (TriggerExecutable_RegisterTriggerClient, error)
	UnregisterTrigger(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *triggerExecutableClient) RegisterTrigger(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (TriggerExecutable_RegisterTriggerClient, error) {
...
func (x *triggerExecutableRegisterTriggerClient) Recv() (*TriggerEvent, error) {
	m := new(TriggerEvent)
...
func (c *triggerExecutableClient) UnregisterTrigger(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type TriggerExecutableServer interface {
	RegisterTrigger(*TriggerRequest, TriggerExecutable_RegisterTriggerServer) error
	UnregisterTrigger(context.Context, *TriggerRequest) (*emptypb.Empty, error)
...
func (UnimplementedTriggerExecutableServer) RegisterTrigger(*TriggerRequest, TriggerExecutable_RegisterTriggerServer) error {
	return status.Errorf(codes.Unimplemented, "method RegisterTrigger not implemented")
}
func (UnimplementedTriggerExecutableServer) UnregisterTrigger(context.Context, *TriggerRequest) (*emptypb.Empty, error) {
...
func (x *triggerExecutableRegisterTriggerServer) Send(m *TriggerEvent) error {
...
func _TriggerExecutable_UnregisterTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TriggerExecutableServer).UnregisterTrigger(ctx, req.(*TriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
