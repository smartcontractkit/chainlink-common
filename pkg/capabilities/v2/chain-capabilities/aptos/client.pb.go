...
func (ReceiverContractExecutionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_capabilities_blockchain_aptos_v1alpha_client_proto_enumTypes[3].Descriptor()
}

func (ReceiverContractExecutionStatus) Type() protoreflect.EnumType {
	return &file_capabilities_blockchain_aptos_v1alpha_client_proto_enumTypes[3]
}
...
type ViewRequest struct {
	...
	LedgerVersion *uint64                `protobuf:"varint,2,opt,name=ledger_version,json=ledgerVersion,proto3,oneof" json:"ledger_version,omitempty"` // nil means use latest ledger version
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type WriteReportReply struct {
	state                           protoimpl.MessageState           `protogen:"open.v1"`
	TxStatus                        TxStatus                         `protobuf:"varint,1,opt,name=tx_status,json=txStatus,proto3,enum=capabilities.blockchain.aptos.v1alpha.TxStatus" json:"tx_status,omitempty"`
	ReceiverContractExecutionStatus *ReceiverContractExecutionStatus `protobuf:"varint,2,opt,name=receiver_contract_execution_status,json=receiverContractExecutionStatus,proto3,enum=capabilities.blockchain.aptos.v1alpha.ReceiverContractExecutionStatus,oneof" json:"receiver_contract_execution_status,omitempty"`
	TxHash                          *string                          `protobuf:"bytes,3,opt,name=tx_hash,json=txHash,proto3,oneof" json:"tx_hash,omitempty"`                          // transaction hash (hex string with 0x prefix)
	TransactionFee                  *uint64                          `protobuf:"varint,4,opt,name=transaction_fee,json=transactionFee,proto3,oneof" json:"transaction_fee,omitempty"` // gas used in octas
...
var file_capabilities_blockchain_aptos_v1alpha_client_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_capabilities_blockchain_aptos_v1alpha_client_proto_goTypes = []any{
	...
	(ReceiverContractExecutionStatus)(0), // 3: capabilities.blockchain.aptos.v1alpha.ReceiverContractExecutionStatus
	(*AccountAPTBalanceRequest)(nil),     // 4: capabilities.blockchain.aptos.v1alpha.AccountAPTBalanceRequest
	(*AccountAPTBalanceReply)(nil),       // 5: capabilities.blockchain.aptos.v1alpha.AccountAPTBalanceReply
	(*ViewRequest)(nil),                  // 6: capabilities.blockchain.aptos.v1alpha.ViewRequest
	(*ViewReply)(nil),                    // 7: capabilities.blockchain.aptos.v1alpha.ViewReply
	(*ViewPayload)(nil),                  // 8: capabilities.blockchain.aptos.v1alpha.ViewPayload
	(*ModuleID)(nil),                     // 9: capabilities.blockchain.aptos.v1alpha.ModuleID
	(*TypeTag)(nil),                      // 10: capabilities.blockchain.aptos.v1alpha.TypeTag
	(*VectorTag)(nil),                    // 11: capabilities.blockchain.aptos.v1alpha.VectorTag
	(*StructTag)(nil),                    // 12: capabilities.blockchain.aptos.v1alpha.StructTag
	(*GenericTag)(nil),                   // 13: capabilities.blockchain.aptos.v1alpha.GenericTag
	(*TransactionByHashRequest)(nil),     // 14: capabilities.blockchain.aptos.v1alpha.TransactionByHashRequest
	(*TransactionByHashReply)(nil),       // 15: capabilities.blockchain.aptos.v1alpha.TransactionByHashReply
	(*Transaction)(nil),                  // 16: capabilities.blockchain.aptos.v1alpha.Transaction
	(*AccountTransactionsRequest)(nil),   // 17: capabilities.blockchain.aptos.v1alpha.AccountTransactionsRequest
	(*AccountTransactionsReply)(nil),     // 18: capabilities.blockchain.aptos.v1alpha.AccountTransactionsReply
	(*SubmitTransactionRequest)(nil),     // 19: capabilities.blockchain.aptos.v1alpha.SubmitTransactionRequest
	(*SubmitTransactionReply)(nil),       // 20: capabilities.blockchain.aptos.v1alpha.SubmitTransactionReply
	(*GasConfig)(nil),                    // 21: capabilities.blockchain.aptos.v1alpha.GasConfig
	(*WriteReportRequest)(nil),           // 22: capabilities.blockchain.aptos.v1alpha.WriteReportRequest
	(*WriteReportReply)(nil),             // 23: capabilities.blockchain.aptos.v1alpha.WriteReportReply
	(*sdk.ReportResponse)(nil),           // 24: sdk.v1alpha.ReportResponse
}
var file_capabilities_blockchain_aptos_v1alpha_client_proto_depIdxs = []int32{
	8,  // 0: capabilities.blockchain.aptos.v1alpha.ViewRequest.payload:type_name -> capabilities.blockchain.aptos.v1alpha.ViewPayload
	9,  // 1: capabilities.blockchain.aptos.v1alpha.ViewPayload.module:type_name -> capabilities.blockchain.aptos.v1alpha.ModuleID
	10, // 2: capabilities.blockchain.aptos.v1alpha.ViewPayload.arg_types:type_name -> capabilities.blockchain.aptos.v1alpha.TypeTag
	1,  // 3: capabilities.blockchain.aptos.v1alpha.TypeTag.kind:type_name -> capabilities.blockchain.aptos.v1alpha.TypeTagKind
	11, // 4: capabilities.blockchain.aptos.v1alpha.TypeTag.vector:type_name -> capabilities.blockchain.aptos.v1alpha.VectorTag
	12, // 5: capabilities.blockchain.aptos.v1alpha.TypeTag.struct:type_name -> capabilities.blockchain.aptos.v1alpha.StructTag
	13, // 6: capabilities.blockchain.aptos.v1alpha.TypeTag.generic:type_name -> capabilities.blockchain.aptos.v1alpha.GenericTag
	10, // 7: capabilities.blockchain.aptos.v1alpha.VectorTag.element_type:type_name -> capabilities.blockchain.aptos.v1alpha.TypeTag
	10, // 8: capabilities.blockchain.aptos.v1alpha.StructTag.type_params:type_name -> capabilities.blockchain.aptos.v1alpha.TypeTag
	16, // 9: capabilities.blockchain.aptos.v1alpha.TransactionByHashReply.transaction:type_name -> capabilities.blockchain.aptos.v1alpha.Transaction
	...
	16, // 11: capabilities.blockchain.aptos.v1alpha.AccountTransactionsReply.transactions:type_name -> capabilities.blockchain.aptos.v1alpha.Transaction
	9,  // 12: capabilities.blockchain.aptos.v1alpha.SubmitTransactionRequest.receiver_module_id:type_name -> capabilities.blockchain.aptos.v1alpha.ModuleID
	21, // 13: capabilities.blockchain.aptos.v1alpha.SubmitTransactionRequest.gas_config:type_name -> capabilities.blockchain.aptos.v1alpha.GasConfig
	...
	21, // 15: capabilities.blockchain.aptos.v1alpha.WriteReportRequest.gas_config:type_name -> capabilities.blockchain.aptos.v1alpha.GasConfig
	24, // 16: capabilities.blockchain.aptos.v1alpha.WriteReportRequest.report:type_name -> sdk.v1alpha.ReportResponse
	...
	3,  // 18: capabilities.blockchain.aptos.v1alpha.WriteReportReply.receiver_contract_execution_status:type_name -> capabilities.blockchain.aptos.v1alpha.ReceiverContractExecutionStatus
	4,  // 19: capabilities.blockchain.aptos.v1alpha.Client.AccountAPTBalance:input_type -> capabilities.blockchain.aptos.v1alpha.AccountAPTBalanceRequest
	6,  // 20: capabilities.blockchain.aptos.v1alpha.Client.View:input_type -> capabilities.blockchain.aptos.v1alpha.ViewRequest
	14, // 21: capabilities.blockchain.aptos.v1alpha.Client.TransactionByHash:input_type -> capabilities.blockchain.aptos.v1alpha.TransactionByHashRequest
	17, // 22: capabilities.blockchain.aptos.v1alpha.Client.AccountTransactions:input_type -> capabilities.blockchain.aptos.v1alpha.AccountTransactionsRequest
	22, // 23: capabilities.blockchain.aptos.v1alpha.Client.WriteReport:input_type -> capabilities.blockchain.aptos.v1alpha.WriteReportRequest
	5,  // 24: capabilities.blockchain.aptos.v1alpha.Client.AccountAPTBalance:output_type -> capabilities.blockchain.aptos.v1alpha.AccountAPTBalanceReply
	7,  // 25: capabilities.blockchain.aptos.v1alpha.Client.View:output_type -> capabilities.blockchain.aptos.v1alpha.ViewReply
	15, // 26: capabilities.blockchain.aptos.v1alpha.Client.TransactionByHash:output_type -> capabilities.blockchain.aptos.v1alpha.TransactionByHashReply
	18, // 27: capabilities.blockchain.aptos.v1alpha.Client.AccountTransactions:output_type -> capabilities.blockchain.aptos.v1alpha.AccountTransactionsReply
	23, // 28: capabilities.blockchain.aptos.v1alpha.Client.WriteReport:output_type -> capabilities.blockchain.aptos.v1alpha.WriteReportReply
