...
func (s medianFactoryServer) ConnToProvider(conn grpc.ClientConnInterface, broker network.Broker, brokerConfig network.BrokerConfig) types.MedianProvider {
...
func (s agnosticPluginFactoryServer) ConnToProvider(conn grpc.ClientConnInterface, broker network.Broker, brokerConfig network.BrokerConfig) types.PluginProvider {
	return s.provider
}
