...
//   - Each field must include a trailing comment of either FieldDefault or FieldExample.
...
//   - The markdown will begin with the header, followed by the example
...
func isGeneratedPreamble(desc lines) bool {
	// Matching the generator marker rather than any mention of "generated" keeps
	// ordinary notes such as "This value is generated by the node".
	return len(desc) > 0 && strings.HasPrefix(strings.ToLower(strings.TrimSpace(desc[0])), "code generated by")
}
