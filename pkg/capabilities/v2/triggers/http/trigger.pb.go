...
const file_capabilities_networking_http_v1alpha_trigger_proto_rawDesc = "" +
	"\n" +
	"2capabilities/networking/http/v1alpha/trigger.proto\x12$capabilities.networking.http.v1alpha\x1a)tools/generator/v1beta/cre_metadata.proto\"f\n" +
	"\x06Config\x12\\\n" +
	...
	"\x04HTTP\x12h\n" +
	"\aTrigger\x12,.capabilities.networking.http.v1alpha.Config\x1a-.capabilities.networking.http.v1alpha.Payload0\x01\x1a \x92\xb5\x18\x1c\b\x01\x12\x18http-trigger@1.0.0-alphab\x06proto3"
